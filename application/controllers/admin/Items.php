...
class Items extends MY_Controller {
	...
	public function add()
	{
		if($this->session->userdata('admin_id')==1541){ die('You are not allowd to add items! Please contact PEC IT Team!!! [reason: virus attack!]');}
		if($this->session->userdata('role_id')==3)
		{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    **************************************************************************/
	...
	public function add_combine()
	{
		...
		{
			//die('------------Submit------------');
			/* duplication commented by ms zobia */
			/*
            if($this->input->post('item_grade_id') !='' && $this->input->post('item_subject_id') !='' && $this->input->post('item_stem_en') !=''){
               
				if($this->find_duplication($this->input->post('item_grade_id'),$this->input->post('item_subject_id'),$this->input->post('item_stem_en')) > 90){
                    $data = array(
						'errors' => 'Duplicate item stem found'
					);
					$this->session->set_flashdata('errors', $data['errors']);
					redirect(base_url('admin/items/add_combine'),'refresh');
                    //exit('duplicate found');
                }                
            }
			*/
            //exit();
			...
			if($item_type=='ERQ')
			{
				...
				$this->form_validation->set_rules('item_subcstand_id', 'Sub Content Stand', 'trim|required');
				$this->form_validation->set_rules('item_slo_id', 'SLO', 'trim|required');	
				$this->form_validation->set_rules('item_total_marks', 'Item Marks', 'trim|required');			
				$this->form_validation->set_rules('item_cognitive_bloom', 'Bloom', 'trim|required');
				$this->form_validation->set_rules('item_curriculum', 'Curriculum', 'trim|required');
				$this->form_validation->set_rules('item_relation', 'Relation', 'trim|required');				
				...
				$data = array(
					...
					'item_subcstand_id' => $this->input->post('item_subcstand_id'),
					'item_slo_id' => $this->input->post('item_slo_id'),
					'item_total_marks' => $this->input->post('item_total_marks'),
					'item_curriculum' => $this->input->post('item_curriculum'),
					'item_pctb_chapter' => $this->input->post('item_pctb_chapter'),
					'item_pctb_page' => $this->input->post('item_pctb_page'),
					'item_other_title' => $this->input->post('item_other_title'),
			...
			elseif($item_type=='MC')
			{
				...
				else
				{
					...
					if($this->input->post('item_mc_ans_key_1')!=""){$item_mc_ans_key = '1'.$this->input->post('item_mc_ans_key_1');}
					if($this->input->post('item_mc_ans_key_2')!=""){$item_mc_ans_key .= '_'.'2'.$this->input->post('item_mc_ans_key_2');}			
					if($this->input->post('item_mc_ans_key_3')!=""){$item_mc_ans_key .= '_'.'3'.$this->input->post('item_mc_ans_key_3');}					
					if($this->input->post('item_mc_ans_key_4')!=""){$item_mc_ans_key .= '_'.'4'.$this->input->post('item_mc_ans_key_4');}
					if($this->input->post('item_mc_ans_key_5')!=""){$item_mc_ans_key .= '_'.'5'.$this->input->post('item_mc_ans_key_5');}					
					if($this->input->post('item_mc_ans_key_6')!=""){$item_mc_ans_key .= '_'.'6'.$this->input->post('item_mc_ans_key_6');}
					if($this->input->post('item_mc_ans_key_7')!=""){$item_mc_ans_key .= '_'.'7'.$this->input->post('item_mc_ans_key_7');}
					if($this->input->post('item_mc_ans_key_8')!=""){$item_mc_ans_key .= '_'.'8'.$this->input->post('item_mc_ans_key_8');}
					if($this->input->post('item_mc_ans_key_9')!=""){$item_mc_ans_key .= '_'.'9'.$this->input->post('item_mc_ans_key_9');}
					if($this->input->post('item_mc_ans_key_10')!=""){$item_mc_ans_key .= '_'.'10'.$this->input->post('item_mc_ans_key_10');}
	...
	public function edit_combine($id=0)
	{
		if($this->input->post('submit'))
		{
			...
			elseif($item_type=='MC')
			{
				...
				else
				{
					...
					/*if($this->input->post('item_en_mc1_1')!="" || $this->input->post('item_ur_mc1_1')!="" || $this->input->post('item_pic_mc1_1')!="")
						{$item_mc_ans_key = '1'.$this->input->post('item_mc_ans_key_1');}

					if($this->input->post('item_en_mc1_2')!="" || $this->input->post('item_ur_mc1_2')!="" || $this->input->post('item_pic_mc1_2')!="")
						{$item_mc_ans_key .= '_'.'2'.$this->input->post('item_mc_ans_key_2');}
						
					if($this->input->post('item_en_mc1_3')!="" || $this->input->post('item_ur_mc1_3')!="" || $this->input->post('item_pic_mc1_3')!="")
						{$item_mc_ans_key .= '_'.'3'.$this->input->post('item_mc_ans_key_3');}
						
					if($this->input->post('item_en_mc1_4')!="" || $this->input->post('item_ur_mc1_4')!="" || $this->input->post('item_pic_mc1_4')!="")
						{$item_mc_ans_key .= '_'.'4'.$this->input->post('item_mc_ans_key_4');}
						
					if($this->input->post('item_en_mc1_5')!="" || $this->input->post('item_ur_mc1_5')!="" || $this->input->post('item_pic_mc1_5')!="")
						{$item_mc_ans_key .= '_'.'5'.$this->input->post('item_mc_ans_key_5');}
						
					if($this->input->post('item_en_mc1_6')!="" || $this->input->post('item_ur_mc1_6')!="" || $this->input->post('item_pic_mc1_6')!="")
						{$item_mc_ans_key .= '_'.'6'.$this->input->post('item_mc_ans_key_6');}
						
					if($this->input->post('item_en_mc1_7')!="" || $this->input->post('item_ur_mc1_7')!="" || $this->input->post('item_pic_mc1_7')!="")
						{$item_mc_ans_key .= '_'.'7'.$this->input->post('item_mc_ans_key_7');}
						
					if($this->input->post('item_en_mc1_8')!="" || $this->input->post('item_ur_mc1_8')!="" || $this->input->post('item_pic_mc1_8')!="")
						{$item_mc_ans_key .= '_'.'8'.$this->input->post('item_mc_ans_key_8');}
						
					if($this->input->post('item_en_mc1_9')!="" || $this->input->post('item_ur_mc1_9')!="" || $this->input->post('item_pic_mc1_9')!="")
						{$item_mc_ans_key .= '_'.'9'.$this->input->post('item_mc_ans_key_9');}
						
					if($this->input->post('item_en_mc1_10')!="" || $this->input->post('item_ur_mc1_10')!="" || $this->input->post('item_pic_mc1_10')!="")
						{$item_mc_ans_key .= '_'.'10'.$this->input->post('item_mc_ans_key_10');}*/
		...
		else
		{
			$data['title'] = 'Edit Item';
			$data['item'] = $this->Items_model->get_items_by_id($id);
			if($data['item']['item_status']==4 && $data['item']['item_status_ss']==1 && $data['item']['item_status_ae']==2)
			{
				$data['item'] = $this->Items_model->change_rej_status_ae($id);
			}
			$data['grades'] = $this->Items_model->get_all_grades();
			$subjectList = $this->session->userdata('subjects_ids');						
			$data['subjects'] = $this->Items_model->get_ae_subjects_grade($subjectList,$data['item']['item_grade_id']);
