...
/**
 * Smith Water man library to compare strings
 *
 * @package CodeIgniter
 * @author  Bo-Yi Wu <appleboy.tw@gmail.com>
 * @link    hhttps://stackoverflow.com/questions/16925150/php-string-comparison-and-similarity-index/38236357#38236357
  @link     https://stackoverflow.com/questions/4898705/smith-waterman-for-string-in-php
 */
class SmithWaterman
{
    private $gapValue;
    ...
    private function SmithWaterman($s, $t) 
    {   
        $v0 = [];
        $v1 = [];
        $t_len = mb_strlen($t);
