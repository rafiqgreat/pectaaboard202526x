  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0 text-dark">Dashboard for SS Writing Statistics Batch 2</h1>
          </div><!-- /.col -->
          <div class="col-sm-2">
              ...
              <div class="info-box-content" style="text-align: left;">   
				  ...
				  <tbody>
					<tr>
					  ...
					  <?php 
					  $totalitems=$Draft_Items=$Submitted_Items=$SS_Accepted=$AE_Accepted=0;
					  foreach($all_data['math'] as $eng)
						{
						  ...
						  <tr>
							  ...
							  <td><?php echo $eng['totalitems'];$totalitems+= $eng['totalitems'];?></td>	  
							  <td><?php echo $eng['Draft_Items']; $Draft_Items+= $eng['Draft_Items'];?></td>
							  <td><?php echo $eng['Submitted_Items']; $Submitted_Items+= $eng['Submitted_Items'];?></td>
