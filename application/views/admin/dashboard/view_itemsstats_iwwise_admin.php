       ...
       <div class="col-12 col-sm-12 col-md-12">
            <div class="info-box mb-12">
              ...
              <div class="info-box-content" style="clear: both;">
                <span class="info-box-text" style="font-size: 22px; font-weight: bold; line-height: 30px;">Total Items Submission Details ItemWriter Wise</span> <br />				 
						  ...
						  <tbody>
							 ...
							 if(isset($items_stats_admin)){
                              ...
                              <td><?php echo $ro['subject_name_en']; ?></td>
										...
										<td><?php echo $ro['Submitted_Items']; $totalSubmitted_Items += $ro['Submitted_Items']?></td>
