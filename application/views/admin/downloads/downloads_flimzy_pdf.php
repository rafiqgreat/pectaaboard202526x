		   ...
		   ?>
			...
			<table width="100%" border="1" bordercolor="#000000" style="font-size:11px;border-collapse: collapse; text-align: center; margin-top: 5px;" cellpadding="7px">
				...
				<tr>
					...
					<td>
						<?php if($item['item_approved'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_approved']));}?>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td>
						<?php if($item['item_reviewed'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_reviewed']));}?>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td>
						<?php if($item['item_date_psy'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_date_psy']));}?>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td>
						<?php if($item['item_rev_date_acc'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_rev_date_acc']));}?>
					</td>
				</tr>
				<?php }?>
				...
				<tr>
					...
					<td>
						<?php if($item['item_rev_ss_date_acc'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_rev_ss_date_acc']));}?>
					</td>
				</tr>
				<?php }?>
				<?php if(isset($item['item_rev_ae_comment']) && $item['item_rev_ae_comment']!=""){?>
					<tr>
						...
						<td>
							<?php if($item['item_rev_ae_date_acc'] != ''){echo date("d-M-Y (h:i a)",strtotime($item['item_rev_ae_date_acc']));}?>
						</td>
					</tr>
                <?php }?>		
				</tbody>
