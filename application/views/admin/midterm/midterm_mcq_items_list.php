...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
    <div class="card-header">
            <?php echo form_open(base_url('admin/midterm/pilot_ss_items_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  //pilot_ss_items_search?>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
	<?php if($param1!=0 || $param2!=0 || $param3!=0 || $param4!=0 || $param5!=0) {?>
	"ajax": "<?=base_url('admin/midterm/datatable_json_mcq_midterm_search/'.$param1.'/'.$param2.'/'.$param3.'/'.$param4.'/'.$param5);?>",
	<?php }
	else
	{?>	"ajax": "<?=base_url('admin/midterm/datatable_json_mcq_midterm')?>", <?php }?>
  ...
  //  "order": [[1,'desc']],
    "columnDefs": [
    	...
    	{ "targets": 4, "name": "item_stem_ur", 'searchable':true, 'orderable':true},
