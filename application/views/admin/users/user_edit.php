      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/users/edit/'.$user['admin_id']), 'class="form-horizontal" enctype="multipart/form-data" onsubmit="return checkRoles()"' )?> 
            ...
            <div class="row">                
              ...
              <div class="form-group" id="div_departments">
               ...
               <select name="admin_department" class="form-control form-group" id="admin_department" placeholder="">
                  <option value="SED" <?= ($user['admin_department'] == 'SED')?'selected': '' ?>>SED</option>
                  <option value="FEDERAL" <?= ($user['admin_department'] == 'FEDERAL')?'selected': '' ?>>FEDERAL</option>                       
                  <option value="PEF" <?= ($user['admin_department'] == 'PEF')?'selected': '' ?>>PEF</option>
                  <option value="WORKERSWELFARE" <?= ($user['admin_department'] == 'WORKERSWELFARE')?'selected': '' ?>>WORKERSWELFARE</option>
                  <option value="COMMUNITY" <?= ($user['admin_department'] == 'COMMUNITY')?'selected': '' ?>>COMMUNITY</option>
                  <option value="LITERACY" <?= ($user['admin_department'] == 'LITERACY')?'selected': '' ?>>LITERACY</option>
                  <option value="PSSP" <?= ($user['admin_department'] == 'PSSP')?'selected': '' ?>>PSSP</option>
                  <option value="DANISH" <?= ($user['admin_department'] == 'DANISH')?'selected': '' ?>>DANISH</option>
                  <option value="INSAFAFTERNOON" <?= ($user['admin_department'] == 'INSAFAFTERNOON')?'selected': '' ?>>INSAFAFTERNOON</option>
                  <option value="OTHER" <?= ($user['admin_department'] == 'OTHER')?'selected': '' ?>>OTHER</option>
               </select>
				</div>
...
'		<label for="subject" class="col-sm-12 control-label">Subject</label>'+
		'<select name="subject" class="form-control" id="subject" placeholder="" required="required">'+
			...
			'<option value="Mathematics" <?=( $user[ 'ci_ir_subject']=="Mathematics" )? 'selected': '' ?>>Mathematics-ریاضی</option>'+
...
'			<option value="">---Select Qualification---</option><?php foreach($qualifications as $qualification){$selectedText = '';if ( $qualification[ 'q_degree_name' ] == $user[ 'ci_ir_qualification' ] ){$selectedText = ' selected="selected" ';} echo '<option value="'.$qualification['q_degree_name'].'"'.$selectedText.'>'.$qualification['q_degree_name'].'</option>'; }?>'+
'		</select>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
...
'		<?php if ($user['ci_ir_latestdegree'] != ""){?><a href="<?php echo base_url().$user['ci_ir_latestdegree'];?>" target="_blank"><img src="<?php echo base_url().$user['ci_ir_latestdegree'];?>" style="max-height:100px; max-width:100px;"/></a>'+
'		<?php }?>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="experienceschool" class="col-sm-12 control-label">Experience School (No. of years)</label>'+
'		<input type="number" name="experienceschool" class="form-control form-group" id="experienceschool" value="<?= $user['ci_ir_experienceschool']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
...
'		<?php if ($user['ci_ir_experienceletter'] != ""){?><a href="<?php echo base_url().$user['ci_ir_experienceletter'];?>" target="_blank"><img src="<?php echo base_url().$user['ci_ir_experienceletter'];?>" style="max-height:100px; max-width:100px;"/></a>'+
'		<?php }?>'+
'	</div>'+
'</div>'+
'<div class="row">'+
...
'			<option value="">---Select Bank---</option><?php foreach($banks as $bank){ $selectedText = '';	if ( $bank[ 'b_bank_name' ] == $user[ 'ci_ir_bankname' ] ){$selectedText = ' selected="selected" ';} echo '<option value="'.$bank['b_bank_name'].'"'.$selectedText.'>'.$bank['b_bank_name'].'</option>'; }?>'+
'		</select>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="branchcode" class="col-sm-12 control-label">Branch Code</label>'+
'		<input type="text" name="branchcode" class="form-control form-group" id="branchcode" value="<?= $user['ci_ir_branchcode']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="accounttitle" class="col-sm-12 control-label">Account Title</label>'+
'		<input type="text" name="accounttitle" class="form-control form-group" id="accounttitle" value="<?= $user['ci_ir_accounttitle']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="accountnumber" class="col-sm-12 control-label">Account Number</label>'+
'		<input type="text" name="accountnumber" class="form-control form-group" id="accountnumber" value="<?= $user['ci_ir_accountnumber']; ?>" placeholder="" required="required">'+
'	</div>'+
'</div>'+
'<div class="row">'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="iban" class="col-sm-12 control-label">IBAN</label>'+
'		<input type="text" name="iban" class="form-control form-group" id="iban" value="<?= $user['ci_ir_iban']; ?>" placeholder="">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
...
'		<label for="subject" class="col-sm-12 control-label">Subject</label>'+
		'<select name="subject" class="form-control" id="subject" placeholder="" required="required">'+
			...
			'<option value="Mathematics" <?=( $user[ 'ci_iw_subject']=="Mathematics" )? 'selected': '' ?>>Mathematics-ریاضی</option>'+
			...
			'<option value="Computer Science" <?=( $user[ 'ci_iw_subject']=="Computer Science" )? 'selected': '' ?>>Computer Science-کمپیوٹر سائنس</option>'+
			'<option value="TARJUMA-TUL-QURAN-UL MAJEED" <?=( $user[ 'ci_iw_subject']=="TARJUMA-TUL-QURAN-UL MAJEED" )? 'selected': '' ?>>TARJUMA-TUL-QURAN-UL MAJEED-تدریس قرآن</option>'+
		'</select>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="department" class="col-sm-12 control-label">Department</label>'+
...
'	<label for="qualification" class="col-sm-12 control-label">Qualification</label>'+
'		<select name="qualification" class="form-control form-group" id="qualification" placeholder="" required="required">'+
'			<option value="">---Select Qualification---</option><?php foreach($qualifications as $qualification){$selectedText = '';if ( $qualification[ 'q_degree_name' ] == $user[ 'ci_iw_qualification' ] ){$selectedText = ' selected="selected" ';} echo '<option value="'.$qualification['q_degree_name'].'"'.$selectedText.'>'.$qualification['q_degree_name'].'</option>'; }?>'+
'		</select>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="latestdegree" class="col-sm-12 control-label">Latest Degree</label>'+
'		<input type="file" name="latestdegree" class="form-control form-group" id="latestdegree" placeholder="" >'+
'		<?php if ($user['ci_iw_latestdegree'] != ""){?><a href="<?php echo base_url().$user['ci_iw_latestdegree'];?>" target="_blank"><img src="<?php echo base_url().$user['ci_iw_latestdegree'];?>" style="max-height:100px; max-width:100px;"/></a>'+
'		<?php }?>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="experienceschool" class="col-sm-12 control-label">Experience School (No. of years)</label>'+
'		<input type="number" name="experienceschool" class="form-control form-group" id="experienceschool" value="<?= $user['ci_iw_experienceschool']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="experienceletter" class="col-sm-12 control-label">Experience Letter</label>'+
'		<input type="file" name="experienceletter" class="form-control form-group" id="experienceletter" placeholder="" >'+
'		<?php if ($user['ci_iw_experienceletter'] != ""){?><a href="<?php echo base_url().$user['ci_iw_experienceletter'];?>" target="_blank"><img src="<?php echo base_url().$user['ci_iw_experienceletter'];?>" style="max-height:100px; max-width:100px;"/></a>'+
'		<?php }?>'+
'	</div>'+
'</div>'+
'<div class="row">'+
...
'	<label for="bankname" class="col-sm-12 control-label">Bank Name</label>'+
'		<select name="bankname" class="form-control form-group" id="bankname" placeholder="" required="required">'+
'			<option value="">---Select Bank---</option><?php foreach($banks as $bank){ $selectedText = '';	if ( $bank[ 'b_bank_name' ] == $user[ 'ci_iw_bankname' ] ){$selectedText = ' selected="selected" ';} echo '<option value="'.$bank['b_bank_name'].'"'.$selectedText.'>'.$bank['b_bank_name'].'</option>'; }?>'+
'		</select>'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="branchcode" class="col-sm-12 control-label">Branch Code</label>'+
'		<input type="text" name="branchcode" class="form-control form-group" id="branchcode" value="<?= $user['ci_iw_branchcode']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="accounttitle" class="col-sm-12 control-label">Account Title</label>'+
'		<input type="text" name="accounttitle" class="form-control form-group" id="accounttitle" value="<?= $user['ci_iw_accounttitle']; ?>" placeholder="" required="required">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="accountnumber" class="col-sm-12 control-label">Account Number</label>'+
'		<input type="text" name="accountnumber" class="form-control form-group" id="accountnumber" value="<?= $user['ci_iw_accountnumber']; ?>" placeholder="" required="required">'+
'	</div>'+
'</div>'+
'<div class="row">'+
'	<div class="col-lg-3 col-sm-12">'+
'		<label for="iban" class="col-sm-12 control-label">IBAN</label>'+
'		<input type="text" name="iban" class="form-control form-group" id="iban" value="<?= $user['ci_iw_iban']; ?>" placeholder="">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
'	</div>'+
'	<div class="col-lg-3 col-sm-12">'+
