      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/pilot_itemspara'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Paragraph List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            <?php $this->load->view('admin/includes/_messages.php') ?>
            <?php echo form_open(base_url('admin/pilot_itemspara/edit/'.$paragraph->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
			
			<div class="row">
              	<div class="col-lg-3 col-sm-12">  
					<label for="para_grade_id" class="control-label">Grade *</label>
					<select name="para_grade_id" class="form-control form-group" id="para_grade_id"  required readonly style="pointer-events: none;">
                ...
                <select name="para_subject_id" class="form-control form-group" id="para_subject_id"  required readonly style="pointer-events: none;">
            ...
            <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_21" class="form-control form-group" id="para_item_21" required onChange="checkUnique('para_item_21')">
							...
							foreach($paraitems as $paraitem)
                              {
                                  ...
                                  echo '<option value="'.$paraitem['item_id'].'" '.$selected.' >'.$paraitem['item_id'].' - '.$paraitem['item_id'].' - '.$paraitem['item_code'].'</option>';
                              }
						?>
                        </select>
                    </div>	
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_22" class="form-control form-group" id="para_item_22"  required onChange="checkUnique('para_item_22')">
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_23" class="form-control form-group" id="para_item_23" onChange="checkUnique('para_item_23')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                                  ...
                                  echo '<option value="'.$paraitem['item_id'].'" '.$selected.' >'.$paraitem['item_id'].' - '.$paraitem['item_code'].'</option>';
                              }
						?>
                        </select>
                    </div>
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_24" class="form-control form-group" id="para_item_24" onChange="checkUnique('para_item_24')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
             ...
             <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_25" class="form-control form-group" id="para_item_25" onChange="checkUnique('para_item_25')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_26" class="form-control form-group" id="para_item_26" onChange="checkUnique('para_item_26')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_27" class="form-control form-group" id="para_item_27" onChange="checkUnique('para_item_27')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_28" class="form-control form-group" id="para_item_28" onChange="checkUnique('para_item_28')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
             ...
             <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_29" class="form-control form-group" id="para_item_29" onChange="checkUnique('para_item_29')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="para_item_30" class="form-control form-group" id="para_item_30" onChange="checkUnique('para_item_30')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($paraitems as $paraitem)
                              {
      ...
      for (var i=0, l=elements.length; i < l; i++) {
        if (document.getElementById(elementID).value === elements[i].value && document.getElementById(elementID) != elements[i]) {
          console.log('not unique');
            alert('Paragraph item already selected!');
