      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
			...
			{echo form_open(base_url('admin/Pilot_Itemspara/edit_para_text/'.$paragraph->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');}
			?>
            ...
            <div class="row">              
				<div class="col-lg-6 col-sm-12">                         
                	...
                	<input type="text" name="para_title_en" id="para_title_en" class="form-control form-group" value="<?php echo $paragraph->para_title_en; ?>" readonly="readonly">
                </div>
                <div class="col-lg-6 col-sm-12">                         
                    <label for="para_title_ur" class="control-label urdufont-right" style="float:right; line-height:40px">پیرا گراف ہدایات *</label>
                	<input type="text" name="para_title_ur" id="para_title_ur" class="form-control form-group" dir="rtl" value="<?php echo $paragraph->para_title_ur; ?>" readonly="readonly">
                </div>					
            </div>
            <div class="row">             
                <div class="col-lg-6 col-sm-12">                         
