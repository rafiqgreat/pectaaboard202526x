      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
			...
			{
				if(isset($ver_id)&&$ver_id!="")
				{
					echo form_open(base_url('admin/Pilot_Itemspara/pilot_itemms_para_edit/'.$paragraph->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');
				}
				elseif(isset($ib_id)&&$ib_id!="")
				{
					echo form_open(base_url('admin/Pilot_Itemspara/itemsbank_para_edit/'.$paragraph->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');
				}
			}
			?>
            <?php /*?><input type="hidden" name="para_subject_id" id="para_subject_id" class="form-control form-group" value="<?php echo $paragraph->para_subject_id; ?>" ><?php */?>
            <input type="hidden" name="para_subject_id" id="para_subject_id" class="form-control form-group" value="<?php echo $paragraph->para_subject_id; ?>" >
            <input type="hidden" name="sub_id" id="sub_id" class="form-control form-group" value="<?php echo $sub_id; ?>" >
            <input type="hidden" name="phase" id="phase" class="form-control form-group" value="<?php echo $phase; ?>" >
            <?php if(isset($ver_id)&&$ver_id!=""){?>
            <input type="hidden" name="ver_id" id="ver_id" class="form-control form-group" value="<?php echo $ver_id; ?>" >
            <?php }?>
            <?php if(isset($ib_id)&&$ib_id!=""){?>
            <input type="hidden" name="ib_id" id="ib_id" class="form-control form-group" value="<?php echo $ib_id; ?>" >
            <?php }?>
            <input type="hidden" name="para_id" id="para_id" class="form-control form-group" value="<?php echo $paragraph->para_id; ?>" >
            <div class="row">              
            ...
            <div class="row" style="padding-top:10px">             
              ...
              <div class="row">             
                ...
                <div class="col-lg-5 col-sm-12"><img src="<?php echo base_url().$paragraph->para_image;?>" style="max-height:200px; max-width:200px;"/><a class="delete btn btn-sm btn-danger" href='<?php echo base_url("admin/Pilot_Itemspara/delete_image/". $paragraph->para_id).'/'.$paragraph->para_id.'_'.$sub_id.'_'.$ver_id.'_'.$phase; ?>' title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a></div>
