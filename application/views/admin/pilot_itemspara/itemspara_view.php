...
?>
                    <tr>
                        ...
                        <?php if ($para_item_21->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_21->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>               
          ...
          <div class="row"><div class="col-lg-12 col-sm-12"><hr/ ></div></div>
            ...
            <div style="padding:15px 0px; float:right"><a href="<?= base_url('admin/pilot_itemspara/edit/'.$itemspara->para_id); ?>" class="btn btn-success">Edit Paragraph</a></div>
        </div>
      </div>
    </section> 
  </div>
