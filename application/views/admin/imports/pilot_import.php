      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block float-right">
            <div class="btn-group margin-bottom-20"> 
              <a href="<?= base_url() ?>admin/imports/sample_data" class="btn btn-secondary">Get Sample File</a>
            </div>
          </div>
        </div>
        <div class="card-header">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/imports/pilot_item_import'), 'class="form-horizontal" enctype="multipart/form-data"');  ?> 
            <div class="form-group">                         
                  <label for="Pilot Phase" class="col-sm-12 control-label">Select Subject</label>
