          ...
          <div class="d-inline-block float-right">
            <div class="btn-group margin-bottom-20"> 
              <!--<a href="<?= base_url() ?>admin/imports/sample_data.xlsx" class="btn btn-secondary">Get Sample File SLOs</a>-->
				<a href="<?= base_url() ?>downloads/sample_slos.xlsx" class="btn btn-secondary">Get Sample File SLOs</a>
            </div>
          </div>
        </div>
        <div class="card-header">
          <div class="d-inline-block">
              ...
              Imports SLOs data from Excel File </h3>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            <?php $this->load->view('admin/includes/_messages.php') ?>
            <?php echo form_open(base_url('admin/imports/import_file'), 'class="form-horizontal" enctype="multipart/form-data"');  ?> 
              ...
              <div class="form-group">
                  <input type="submit" name="submit" value="Import" class="btn btn-info pull-right">
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
        </div>
