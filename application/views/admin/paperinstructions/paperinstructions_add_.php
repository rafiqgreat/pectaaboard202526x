           ...
           <!-- For Messages -->
            ...
            <div class="row">
              	<div class="col-lg-6 col-sm-12">  					
					...
					<textarea id="pi_paper_instruction_en" name="pi_paper_instruction_en" rows="4" cols="50" class="form-control form-group" required="required"></textarea>                   
                </div>
                <div class="col-lg-6 col-sm-12">  					
					<label for="pi_paper_instruction_ur" class="control-label urdufont-right" style="float:right">پیپر ہدایات</label>
					<textarea id="pi_paper_instruction_ur" name="pi_paper_instruction_ur" rows="4" cols="50" class="form-control form-group urdufont-right" dir="rtl" required="required"></textarea>                   
                </div>
              </div>
            <div class="row">
              	<div class="col-lg-3 col-sm-12">  					
					<label for="pi_paper_marks" class="control-label">Paper Marks *</label>
					<input type="number" name="pi_paper_marks" class="form-control form-group" id="pi_paper_marks" placeholder="" required="required">                   
                </div>
                <div class="col-lg-3 col-sm-12">  					
