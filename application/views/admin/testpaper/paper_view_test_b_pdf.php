...
<html>
   ...
   <body>
   	<div>
    <table border="0" width="100%" align="center" cellspacing="0" cellpadding="5" style="padding-bottom:15px">
    ...
    <tr>	
    	<td width="25%" valign="top" align="left">
            <table border="1" width="100%" cellspacing="0" cellpadding="5">
                <tr>
                    <td align="center">
                        <img src="<?php echo base_url();?>/assets/img/45a56ad0609f539d4a2901b9df88e956.jpg" style="max-height:70px;"/>
                    </td>
                </tr>
            </table>
        </td>
        <td align="center" width="50%" style="font-size:14px; ">
            <b>PUNJAB EDUCATION, CURRICULUM, <br>TRAINING & ASSESSMENT AUTHORITY</b><br>
            <b>EXAMINATION 2026, GRADE- 5</b><br>
            <b>ENGLISH PART – A (Objective Type)</b>
        </td>
        <td width="25%" valign="top" align="right">
            <table border="1" width="100%" height="80" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
                <tr>
                    <td align="center">
                        Model Paper<br>
    ...
    <tr>
        <td colspan="3" align="center">
            Part-A: <b>40 Marks</b>, Part-B: <b>60 Marks</b>, Total: <b>100 Marks</b>
        </td>
    </tr>

    <tr>
        <td colspan="3" bgcolor="#000000" height="1" style="padding-top:1px;"></td>
    </tr>
    
    <tr>
        <td colspan="2" valign="top">
            <table border="1" width="100%" cellspacing="0" cellpadding="5" style="margin-top:10px; font-size:10px; text-align:left">
                <tr>
                    <td width="35%" bgcolor="#CCCCCC" valign="top">
                        <b>Student Name</b><br>
                        (In Capital Letters)
                    </td>
                    <td width="65%">&nbsp;</td>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-top:15px; font-size:10px; text-align:left">
                <tr>
                    <td width="35%" bgcolor="#CCCCCC" border="1" valign="top" style="border:1px solid #000000;">
                        <b>Roll Number</b><br>
                        (In Figures)
                    </td>
                    <td width="6.5%" border="1" align="center" style="border:1px solid #000000;">&nbsp;</td>
                    <td width="6.5%" border="1" align="center" style="border:1px solid #000000;">&nbsp;</td>
                    <td width="6.5%" border="1" align="center" style="border:1px solid #000000;">&nbsp;</td>
            ...
            <p style="margin-top:35px; font-size:10px; text-align:left"> 
                <b>Signature of Dy. Superintendent(CNIC)</b>----------------------------------------------------------------
            </p>

        </td>
        
        <td width="250" valign="top" align="right">
            <table border="1" width="100%" cellspacing="0" cellpadding="5" style="font-size:10px; text-align:center">
                <tr>
                ...
                <tr>
                    <td width="50%" ><b>Total Marks</b></td>
                    <td width="50%">&nbsp;</td>
                </tr>
                <tr>
                    <td><b>MCQs</b></td>
                ...
                <tr>
                    <td height="40">
                        <b>Signature of Head Examiner</b>
                    </td>
                    <td height="40">
                    </td>
                </tr>
    ...
    <tr>
	  ...
	  /*if($items[0]->item_grade_id=="7")
	  {
		  ...
		  {
			  $header = '<img src="' . base_url('assets/header/5EA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="MTH")
		  {
			  $header = '<img src="' . base_url('assets/header/5MA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="SCI")
		  {
			  $header = '<img src="' . base_url('assets/header/5SA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="URD")
		  {
			  $header = '<img src="' . base_url('assets/header/5UA.jpg') . '" style="max-height:400px;"/>';
		  }
	  ...
	  if($items[0]->item_grade_id=="10")
	  {
		  if($items[0]->subject_code=="ENG")
		  {
			  $header = '<img src="' . base_url('assets/header/8EA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="MTH")
		  {
			  $header = '<img src="' . base_url('assets/header/8MA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="SCI")
		  {
			  $header = '<img src="' . base_url('assets/header/8SA.jpg') . '" style="max-height:400px;"/>';
		  }
		  if($items[0]->subject_code=="URD")
		  {
			  $header = '<img src="' . base_url('assets/header/8UA.jpg') . '" style="max-height:400px;"/>';
		  }
            ...
            <div>
               ...
               {?> 
                ...
                <?php if($items[0]->subject_code=="GKN" || $items[0]->subject_code=="MTH" || $items[0]->subject_code=="SCI"){?>
                     ...
                     <tr>
                        <td style="text-align:left">Instruction: Attempts any 10 questions. Each question carry 3 Marks</td>
                     </tr>
                     <tr>
                         <td colspan="2" class="urdufont-right" style="text-align:right; ; font-size:14px">کسی بھی 10 سوالات کے جواب دیں۔ ہر سوال کے 3 نمبر ہیں۔</td>
                     </tr>
                   </table>
               ...
               <?php			
                  ...
                  foreach($items as $paper_mcq){
                     $i++;
                     if($paper_mcq->item_total_marks == '2'){
                        ?>
               ...
               if($items[0]->subject_code=="ENG" || $items[0]->subject_code=="GKN" || $items[0]->subject_code=="MTH" || $items[0]->subject_code=="SCI")
               { ?> 
               <table width="100%" class="papyertype" style="padding-top:10px">
                  <tr>
               ...
               {?> 
                  ...
                  <?php if($items[0]->subject_code=="GKN" || $items[0]->subject_code=="MTH" || $items[0]->subject_code=="SCI"){?>
                  	<table width="100%" class="papyertype" style="">
                     <tr>
                        <td style="text-align:left">Instruction: Attempts any 3 questions. Each question carry 10 Marks</td>
                     </tr>
                     <tr>
                         <td colspan="2" class="urdufont-right" style="text-align:right; ; font-size:14px">کسی بھی 3 سوالات کے جواب دیں۔ ہر سوال کے 10 نمبر ہیں۔</td>
                     </tr>
                   </table>
                  <?php } elseif($items[0]->subject_code=="ENG") {?>  
                  	<table width="100%" class="papyertype" style="">
