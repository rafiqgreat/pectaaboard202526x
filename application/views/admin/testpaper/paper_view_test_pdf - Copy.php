   ...
   <body>
      ...
      if($items[0]->subject_code=="ENG" || $items[0]->subject_code=="GKN" || $items[0]->subject_code=="MTH" || $items[0]->subject_code=="SCI"){?>
          <table width="100%" class="papyertype">
              <tr>
                  <td style="font-size:12px; font-weight:bold;"><?= $items[0]->subject_name_en;?></td>
              </tr>
          </table>
          <table width="100%" class="papyertype">
              <tr>
                  ...
                  <td width="25%" style="border: 1px solid #000;">Total Marks : (<?php print_r($modelpaperinfo['tp_mcq_total_marks']);?>)</td>
                  <td width="25%" style="border: 1px solid #000;">Time : <?php print_r($modelpaperinfo['tp_mcq_total_marks']);?> Minutes</td>
              </tr>
          </table>
          <table width="100%" class="papyertype">
              <tr>
                  <td width="33%" style="border: 1px solid #000;">Test # <?php print_r($modelpaperinfo['tp_mcq_total_marks']);?></td>
                  <td width="34%" style="border: 1px solid #000;"><?php print_r($modelpaperinfo['tp_mcq_heading']);?></td>
                  <?php 
            		if($modelpaperinfo['tp_mcq_total_marks']==NULL && $modelpaperinfo['tp_mcq_total_marks']!=NULL && $modelpaperinfo['tp_mcq_total_marks']!=NULL){?>
                  <td width="33%" style="border: 1px solid #000;">Domain : 
				  <?php 
				  $cs_dtl = $this->Paper_model->get_cstands_by_id($modelpaperinfo['qat_cs_id']);  //print_r($cs_dtl[0]['cs_statement_en']); 
				  if (is_array($cs_dtl) && !empty($cs_dtl)) {
							$statements = array_column($cs_dtl, 'cs_statement_en');
							echo htmlspecialchars(implode(', ', $statements));
							// echo "<strong> ڈومین :</strong> " . htmlspecialchars($cs_dtl['topics_ur']);
						}
				  ?>
					</td>
                  <?php }
            		elseif($modelpaperinfo['tp_mcq_total_marks']!=NULL && $modelpaperinfo['tp_mcq_total_marks']==NULL && $modelpaperinfo['tp_mcq_total_marks']!=NULL){?>
                  <td width="33%" style="border: 1px solid #000;"><?php 
						$cs_dtl = $this->Paper_model->get_cstands_by_id($modelpaperinfo['qat_cs_id']);  
						
						if (!empty($cs_dtl)) {
							$domains = array_column($cs_dtl, 'cs_statement_en');  // extract only the domain names
							$domains = array_filter($domains); // remove any empty values
							if (!empty($domains)) {
								echo "<strong>Domains:</strong> " . htmlspecialchars(implode(', ', $domains));
							}
						}
						?></td>
                  <?php }
            		elseif($modelpaperinfo['tp_mcq_total_marks']==NULL){?>
                  <td width="33%" style="border: 1px solid #000;">Full Syllabus</td>
                  <?php }?>
              </tr>
	      		<tr>
                  <?php /*?><td width="33%" style="border: 1px solid #000; text-align:left !important;" colspan="3">Sub Domain : <?php $units = $this->Paper_model->get_units($modelpaperinfo['qat_cs_id']);  print_r($units['topics_en']);?></td><?php */?>
              <td width="33%" style="border: 1px solid #000; text-align:left !important;" colspan="3">Units</td>
              </tr>
          </table>
          <?php } else { ?>
          <table width="100%" class="papyertype urdufont-right">
              <tr>
                  <td style="font-size:20px; font-weight:bold;"><?= $items[0]->subject_name_ur;?></td>
              </tr>
          </table>
          <table width="100%" class="papyertype urdufont-right mt-2" style="">
              <tr height="40px">
               <td width="25%" style="border: 1px solid #000; text-align:right">رول نمبر :</td>
                  ...
                  <td width="25%" style="border: 1px solid #000;">کل نمبر : <?php print_r($modelpaperinfo['qat_total_marks']);?></td>
                  <td width="25%" style="border: 1px solid #000;">کل وقت : <?php print_r($modelpaperinfo['qat_total_time']);?> منٹ</td>
              </tr>
          </table>
          <table width="100%" class="papyertype urdufont-right" style="">
              <tr height="40px">
              <td width="33%" style="border: 1px solid #000;">سبق # </td>
              <td width="33%" style="border: 1px solid #000;"> سب ڈومین # </td>
              <td width="34%" style="border: 1px solid #000;">سب ڈومین #</td>
                 <td width="33%" style="border: 1px solid #000;">ٹیسٹ # </td>
            ...
            <div>
               ...
               if(!empty($paper_mcqs)){?>
                  <table width="100%" class="papyertype" style="">
                     <tr>
                        <td style="text-align:left"><?php print_r($modelpaperinfo['qat_sec_1_statement_eng']);?></td>
                         <td>(<?php print_r($modelpaperinfo['qat_sec_1_submarks'].' = '.$modelpaperinfo['qat_sec_1_marks']);?>)</td>
                     </tr>
                     <tr>
                         <td colspan="2" class="urdufont-right" style="text-align:right; ; font-size:14px"><?php print_r($modelpaperinfo['qat_sec_1_statement_ur']);?></td>
                     </tr>
                          </table>
            	<?php 	
						$i = 0;
                  ...
                  <?php if ($paper_mcq->item_image_position=='Bottom') 
         {
            ...
            ?>
               ...
               { //die('if');?> <table width="100%" class="papyertype mt-2">
                     <tr>
                        <td width="33%"></td>
                        <td width="34%" style="border: 1px solid #000;"><?php print_r($modelpaperinfo['qat_sec_2_title_en']);?></td>
                        <td width="33%" style="text-align:right !important; font-size:12px"><?php print_r($modelpaperinfo['qat_sec_2_marks']);?> Marks</td>
                     </tr>
                          </table>
                  <table width="100%" class="papyertype" style="font-size:12px">
                          <tr>
                              <td style="text-align:left"><?php print_r($modelpaperinfo['qat_sec_2_statement_eng']);?></td>
                              <td><?php print_r($modelpaperinfo['qat_sec_2_submarks']);?></td>
                          </tr>
                      </table><?php }
               elseif($items[0]->subject_code=="SCI" || $items[0]->subject_code=="MTH")
               {?><table width="100%" class="papyertype mt-2">
                     <tr>
                        ...
                        <td width="33%" style="text-align:right !important; font-size:12px"><?php print_r($modelpaperinfo['qat_sec_2_marks']);?> Marks</td>
                          ...
                          <table width="100%" class="papyertype">
                     <tr>
                        <td style="font-size:12px; text-align:left"><?php print_r($modelpaperinfo['qat_sec_2_statement_eng']);?></td>
                                  <td></td>
                     </tr>
                              <tr>
                                  <td colspan="2" class="urdufont-right" style="text-align:right; font-size:14px"><?php print_r($modelpaperinfo['qat_sec_2_statement_ur']);?></td>
                     </tr>
                          </table><?php }
               else
               {//die('else');?> 
                      <table width="100%" class="papyertype mt-2" >
                          <tr>
                              <td width="33%"></td>
                              <td width="34%" style="border: 1px solid #000;"><?php print_r($modelpaperinfo['qat_sec_2_title_en']);?></td>
                              <td width="33%" style="text-align:right !important; font-size:12px">
                              <?php print_r($modelpaperinfo['qat_sec_2_marks'].' Marks');?>
                              </td>
                          </tr>
                      </table>
                      <table width="100%" class="papyertype">
                     <tr>
                                  <td colspan="2" class="urdufont-right" style="text-align:right; font-size:14px"><?php print_r($modelpaperinfo['qat_sec_3_statement_ur']);?></td>
                     </tr>
                          </table><?php }	
               ?>
               ...
               { //die('if');?> <table width="100%" class="papyertype mt-2">
                     <tr>
                        <td width="33%"></td>
                        <td width="34%" style="border: 1px solid #000;"><?php print_r($modelpaperinfo['qat_sec_3_title_en']);?></td>
                        <td width="33%" style="text-align:right !important; font-size:12px"><?php print_r($modelpaperinfo['qat_sec_3_marks']);?> Marks</td>
                     </tr>
                          </table>
                  <table width="100%" class="papyertype" style="font-size:12px">
                          <tr>
                              <td style="text-align:left"><?php print_r($modelpaperinfo['qat_sec_3_statement_eng']);?></td>
                              <td><?php print_r($modelpaperinfo['qat_sec_3_submarks']);?></td>
                          </tr>
                      </table><?php }
               elseif($items[0]->subject_code=="SCI" || $items[0]->subject_code=="MTH")
               {?><table width="100%" class="papyertype mt-2">
                     <tr>
                        ...
                        <td width="33%" style="text-align:right !important; font-size:12px"><?php print_r($modelpaperinfo['qat_sec_3_marks']);?> Marks</td>
                          ...
                          <table width="100%" class="papyertype">
                     <tr>
                        <td style="font-size:12px; text-align:left"><?php print_r($modelpaperinfo['qat_sec_3_statement_eng']);?></td>
                                  <td></td>
                     </tr>
                              <tr>
                                  <td colspan="2" class="urdufont-right" style="text-align:right; font-size:14px"><?php print_r($modelpaperinfo['qat_sec_3_statement_ur']);?></td>
               ...
               {//die('else');?> 
                      <table width="100%" class="papyertype mt-2" >
                          <tr>
                              ...
                              <td width="34%" style="border: 1px solid #000;"><?php print_r($modelpaperinfo['qat_sec_3_title_en']);?></td>
                              <td width="33%" style="text-align:right !important; font-size:12px">
                              <?php print_r($modelpaperinfo['qat_sec_3_marks'].' Marks');?>
                              </td>
                          </tr>
                      </table>
                      <table width="100%" class="papyertype">
                              <tr>
                                  <td colspan="2" class="urdufont-right" style="text-align:right; font-size:4px"><?php print_r($modelpaperinfo['qat_sec_3_statement_ur']);?></td>
                     </tr>
                          </table><?php }	
               ?>
