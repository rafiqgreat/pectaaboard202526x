...

			{
				...
				<tr>
                        ...
                        <?php if($this->session->userdata('role_id')==2){?>
						 ...
						 <?php /*?>Subject ID = $crp_v & item bank id is $this->uri->segment(5)<?php */?> 

                        <a href=<?php echo base_url('admin/Pilot_Itemspara/itemsbank_para_edit/'.$paper_para->para_id.'_'.$crp_v.'_'.$this->uri->segment(5)); ?> target="_blank" style="color:#09F" class="update btn btn-sm btn-light"><i class="fa fa-pencil-square-o"></i></a>
