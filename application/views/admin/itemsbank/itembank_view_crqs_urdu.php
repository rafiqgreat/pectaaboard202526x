			...
			//die();?>			
									...
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_1->item_stem_ur);?></td>									
										...
										<?php if ($group_item_1->item_type=='ERQ')
											{?>
											<?php if($group_item_1->item_stem_ur!=""){?>
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_1->item_id); ?> target="_blank"> (a </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
									...
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_2->item_stem_ur);?></td>
										...
										<?php if ($group_item_2->item_type=='ERQ')
											{?>
											<?php if($group_item_2->item_stem_ur!=""){?>
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_2->item_id); ?> target="_blank"> (b </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
									...
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_3->item_stem_ur);?></td>
										...
										<?php if ($group_item_3->item_type=='ERQ')
											{?>
											<?php if($group_item_3->item_stem_ur!=""){?>
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_3->item_id); ?> target="_blank"> (c </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
									...
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_4->item_stem_ur);?></td>
										...
										<?php if ($group_item_4->item_type=='ERQ')
											{?>
											<?php if($group_item_4->item_stem_ur!=""){?>
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_4->item_id); ?> target="_blank"> (d </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					{$group_item_5 = $this->Itemsbank_model->get_item_by_id($paper_group->group_item_5);
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_5->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_5->item_stem_ur);?></td>
										...
										<?php if ($group_item_5->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_5->item_id); ?> target="_blank"> (e </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					$group_item_6 = $group_item_6[0];
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_6->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_6->item_stem_ur);?></td>
										...
										<?php if ($group_item_6->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_6->item_id); ?> target="_blank"> (f </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					$group_item_7 = $group_item_7[0];
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_7->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_7->item_stem_ur);?></td>
										...
										<?php if ($group_item_7->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_7->item_id); ?> target="_blank"> (g </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					$group_item_8 = $group_item_8[0];
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_8->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_8->item_stem_ur);?></td>
										...
										<?php if ($group_item_8->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_8->item_id); ?> target="_blank"> (h </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					$group_item_9 = $group_item_9[0];
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_9->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_9->item_stem_ur);?></td>
										...
										<?php if ($group_item_9->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_9->item_id); ?> target="_blank"> (i </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
					...
					{$group_item_10 = $this->Itemsbank_model->get_item_by_id($paper_group->group_item_10);
						...
						?>
						  ...
						  <tr>
							<?php if($group_item_10->item_stem_ur!=""){?><td colspan="2" >
							  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tbody>
									<tr>
									  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_10->item_stem_ur);?></td>
										...
										<?php if ($group_item_10->item_type=='ERQ')
											...
											<td align="right"  style="text-align:right; width: 20px; vertical-align: top;"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$group_item_10->item_id); ?> target="_blank"> (j </a></td>
											<?php }?>
										<?php }?>
									<?php }
										else
										{?>										
										  <td align="right"  style="text-align:right; width: 20px; vertical-align: top;"> ( </td>
									<?php }?>
									</tr>
								  </tbody>
								</table>
