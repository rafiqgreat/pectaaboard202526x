            ...
            <div class="card-body table-responsive">
                ...
                ?>
                 <div class="btn-group margin-bottom-20"> 
                  <a href="<?= base_url() ?>admin/itemsbank/itemsbank_summary_export/PDF/<?php echo $paper[0]->ibm_subject_id;?>" class="btn btn-secondary">Export as PDF</a> 
                  <a href="<?= base_url() ?>admin/itemsbank/itemsbank_summary_export/CSV/<?php echo $paper[0]->ibm_subject_id;?>" class="btn btn-secondary">Export as CSV</a>
              </div>
                <?php
                }
                ?>
                 ...
                 <table id="" class="table table-bordered table-hover" width="80%">
                  <thead>
                        ...
                        <tr >
                            ...
                            <th colspan="8">Grade :  <?php echo $paper[0]->item_grade_id-2;?></th>
                        </tr>
                        <tr >
                            <th>Q. No.</th>
                             <th>Item ID</th>
