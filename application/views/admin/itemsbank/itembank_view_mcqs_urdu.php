             ...
             <?php 
				...
				if($paper_para->para_text_ur!='') {?>
                    ...
                    <tr>
                        ...
                        <?php /*?>Subject ID = $crp_v & item bank id is $this->uri->segment(5)echo base_url('admin/Pilot_Itemspara/Itemsbank_n_para_edit/<?php */?> 
					...
					if(isset($paper_para->para_item_21)&&$paper_para->para_item_21!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_21->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_21->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="direction: rtl;" >
								<tr>
					...
					if(isset($paper_para->para_item_22)&&$paper_para->para_item_22!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_22->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_22->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_22->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_23)&&$paper_para->para_item_23!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_23->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_23->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_23->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_24)&&$paper_para->para_item_24!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_24->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_24->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> : </a><?php echo html_entity_decode($para_item_24->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_25)&&$paper_para->para_item_25!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_25->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_25->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> : </a><?php echo html_entity_decode($para_item_25->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_26)&&$paper_para->para_item_26!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_26->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_26->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_26->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_27)&&$paper_para->para_item_27!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_27->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_27->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_27->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_28)&&$paper_para->para_item_28!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_28->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_28->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_28->item_stem_ur);?></td><?php }?>						  </tr>
					...
					if(isset($paper_para->para_item_29)&&$paper_para->para_item_29!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_29->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_29->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> :</a> <?php echo html_entity_decode($para_item_29->item_stem_ur);?></td><?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_30)&&$paper_para->para_item_30!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_30->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_30->item_id); ?> target="_blank">سوال نمبر <?php print ++$ctr;?> : </a><?php echo html_entity_decode($para_item_30->item_stem_ur);?></td><?php }?>
						  </tr>
