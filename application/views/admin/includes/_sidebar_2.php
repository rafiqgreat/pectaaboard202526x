  ...
  <div class="sidebar"> 
    ...
    <nav class="mt-2"> 
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview" id="notification" > <a href="#" class="nav-link"> <i class="fa fa-shopping-basket nav-icon"></i>
        ...
        <li id="specialreport" class="nav-item has-treeview"> <a href="#" class="nav-link"> <i class="nav-icon fa fa-search"></i>
          ...
          <ul class="nav nav-treeview">
            ...
            <?php /*?><li id="reports_admin" class="nav-item"> <a href="<?php echo base_url('admin/reports/reports_admin'); ?>" class="nav-link"> <i class="fa fa-circle-o nav-icon"></i>
              <p>Search Items</p>
              </a> </li><?php */?>
          </ul>
        </li>
        ...
        <li id="itemreviewcycle2"  class="nav-item has-treeview"> 
			<a href="#" class="nav-link"> <i class="nav-icon fa fa-bank"></i>
          	<p> Items Review Cycle II <i class="right fa fa-angle-left"></i> </p>
          	</a>
          	<ul class="nav nav-treeview" >
        ...
        <li id="itemreviewcycle2" class="nav-item has-treeview"> <a href="#" class="nav-link"> <i class="nav-icon fa fa-bank"></i>
          <p> Itmes Writing Cycle II <i class="right fa fa-angle-left"></i> </p>
          </a>
          <ul class="nav nav-treeview" style="margin-left:10px">
            <li class="nav-item has-treeview"> <a href="#" class="nav-link"> <i class="nav-icon fa fa-bank"></i>
              <p> Items <i class="right fa fa-angle-double-left"></i> </p>
        ...
        <li id="duplication" class="nav-item has-treeview"> <a href="#" class="nav-link"> <i class="nav-icon fa fa-download"></i>
          ...
          <ul class="nav nav-treeview" style="margin-left:10px"> 
		<li id="aplagiarism_check" class="nav-item">
        ...
        <li id="iwitems" class="nav-item has-treeview"> 
          ...
          <ul class="nav nav-treeview" style="margin-left:10px">
           ...
           <li class="nav-item"> <a href="<?= base_url('admin/items/add'); ?>" class="nav-link"> <i class="fa fa-circle-o nav-icon"></i>
              <p>Add MCQs Item</p>
              </a> </li>
            <li id="add_erq_crq" class="nav-item"> <a href="<?= base_url('admin/items/add_erq_crq'); ?>" class="nav-link"> <i class="fa fa-circle-o nav-icon"></i>
        ...
        <?php endif;  ?>
        <?php if(in_array($this->session->userdata('role_id'),array(1,2,4))):?>
        <li class="nav-item has-treeview" id="pilotpaper" > <a href="#" class="nav-link"> <i class="fa fa-shopping-basket nav-icon"></i>
          ...
          <ul class="nav nav-treeview" style="margin-left:10px">			
			  ...
			  <li id="pilot_crq_meta_import" class="nav-item"> <a href="<?= base_url('admin/imports/pilot_crq_meta_import'); ?>" class="nav-link"> <i class="nav-icon fa fa-object-group"></i>
                  <p>Pilot CRQs Meta Import/Tagging</p>
                  </a> 
            </li>
		...
		<?php }?>
        <?php if($this->session->userdata('role_id')==1||$this->session->userdata('role_id')==7||$this->session->userdata('role_id')==8){?>		  
...
if($this->uri->segment(3) != ''){
	...
	{
		?> $("#media").addClass('menu-open');$("#media > a").addClass('active'); <?php
		if($this->uri->segment(3)=='')
		{
			?>$("#medialist > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='add')
		{
			?>$("#mediaadd > a").addClass('active');<?php
		}
	}	
	
	if($this->uri->segment(2)=='profile')
	{
		?> $("#users").addClass('menu-open');$("#users > a").addClass('active'); <?php
		if($this->uri->segment(3)=='profile_edit')
		{
			?>$("#myprofileedit > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='profile_view')
		{
			?>$("#myprofileview > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='change_pwd')
		{
			?>$("#mypasswordchange > a").addClass('active');<?php
		}
	}
	if($this->uri->segment(2)=='users')
	{
		...
		if($this->uri->segment(3)=='')
		{
			?>$("#userslist > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='add')
		{
			?>$("#mediaadd > a").addClass('active');<?php
	...
	if($this->uri->segment(2)=='itemwriters')
	{
		?> $("#users").addClass('menu-open');$("#users > a").addClass('active'); <?php
			...
			?>$("#itemwriters > a").addClass('active');<?php
	...
	if($this->uri->segment(2)=='itemreviewers')
	{
		?> $("#users").addClass('menu-open');$("#users > a").addClass('active'); <?php
			...
			?>$("#itemreviewers > a").addClass('active');<?php
			
	}	
	if($this->uri->segment(2)=='notification')
	{
		?> $("#notification").addClass('menu-open');$("#notification > a").addClass('active'); <?php
		if($this->uri->segment(3)=='my_messages')
		{
			?>$("#notificationmy_messages > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='message')
		{
			?>$("#notificationmessage > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='my_notifications')
		{
			?>$("#notificationmy_notifications > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='')
		{
			?>$("#notificationindex > a").addClass('active');<?php
		}		
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='plagiarism_check')
	{
		?> $("#duplication").addClass('menu-open');$("#duplication > a").addClass('active'); <?php
		if($this->uri->segment(3)=='plagiarism_check')
		{
			?>$("#aplagiarism_check > a").addClass('active');<?php
		}					
	}	
	if($this->uri->segment(2)=='grades')
	{		
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#grades > a").addClass('active'); <?php			
	}
	if($this->uri->segment(2)=='subjects')
	{
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#subjects > a").addClass('active'); <?php		
	}
    if($this->uri->segment(2)=='contentstand')
	{
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#contentstand > a").addClass('active'); <?php		
	}
	if($this->uri->segment(2)=='subcontentstand')
	{
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#subcontentstand > a").addClass('active'); <?php		
	}
	if($this->uri->segment(2)=='slos')
	{
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#slos > a").addClass('active'); <?php		
	}
	if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='')
	{
		?> $("#content").addClass('menu-open');$("#content > a").addClass('active'); $("#importsslos > a").addClass('active'); <?php		
	}
	
	if($this->uri->segment(2)=='pilotheaders' || $this->uri->segment(2)=='pilot_items' || $this->uri->segment(2)=='pilot_itemsgroup' || $this->uri->segment(2)=='pilot_itemspara' || $this->uri->segment(2)=='paperview')
	{
		?> $("#pilotbucket").addClass('menu-open');$("#pilotbucket > a").addClass('active'); <?php
		if($this->uri->segment(2)=='pilotheaders' )
		{
			?>$("#pilotheaders > a").addClass('active');<?php
		}
		if($this->uri->segment(2)=='pilot_items' && $this->uri->segment(3)=='mcq_p1')
		{
			?>$("#pilot_itemsmcq_p1 > a").addClass('active');<?php
		}
		if($this->uri->segment(2)=='pilot_items' && $this->uri->segment(3)=='mcq_p1')
		{
			?>$("#pilot_itemserq_p1 > a").addClass('active');<?php
		}
		if($this->uri->segment(2)=='pilot_itemsgroup' && $this->uri->segment(3)=='group_p1')
		{
			?>$("#group_p1 > a").addClass('active');<?php
		}
		if($this->uri->segment(2)=='pilot_itemspara' && $this->uri->segment(3)=='para_p1')
		{
			?>$("#para_p1 > a").addClass('active');<?php
		}
		if($this->uri->segment(2)=='paperview')
		{
			?>$("#paperview > a").addClass('active');<?php
		}
	}	
	
	if($this->uri->segment(2)=='pilotpaper')
	{
		?> $("#pilotpaper").addClass('menu-open');$("#pilotpaper > a").addClass('active'); <?php
		if($this->uri->segment(3)=='')
		{
			?>$("#pilot1index > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='index2')
		{
			?>$("#pilot2index > a").addClass('active');<?php
		}			
	}
	if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='pilot_meta_import')
	{
		...
		{
			?>$("#pilot_meta_import > a").addClass('active');<?php
		}					
	}
   if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='pilot_crq_meta_import')
	{
		...
		{
			?>$("#pilot_crq_meta_import > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='pilot_import_marks')
	{
		...
		{
			?>$("#pilot_import_marks > a").addClass('active');<?php
		}					
	}
    if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='pilot_result_summary')
	{
		...
		{
			?>$("#pilot_result_summary > a").addClass('active');<?php
		}					
	}	
    if($this->uri->segment(2)=='imports' && $this->uri->segment(3)=='pilot_crq_result_summary')
	{
		...
		if($this->uri->segment(3)=='pilot_result_summary')
		{
			?>$("#pilot_crq_result_summary > a").addClass('active');<?php
		}					
	}										 
	if($this->uri->segment(2)=='district')
	{
		?> $("#location").addClass('menu-open');$("#location > a").addClass('active'); <?php
		
			?>$("#district > a").addClass('active');<?php
	...
	if($this->uri->segment(2)=='reports' && ($this->uri->segment(3)=='reports_admin' || $this->uri->segment(3)=='admin_ceo_search') )
	{
		...
		{
			?>$("#reports_admin > a").addClass('active');<?php
		}					
	}											 
	if($this->uri->segment(2)=='itemwriter' && $this->uri->segment(3)=='rep_item_writer_profile'  )
	{
		?> $("#reportsall").addClass('menu-open');$("#reportsall > a").addClass('active'); <?php
		if($this->uri->segment(3)=='rep_item_writer_profile')
		{
			?>$("#rep_item_writer_profile > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_item_reviewer_profile'  )
	{
		...
		{
			?>$("#rep_item_reviewer_profile > a").addClass('active');<?php
		}					
	}
	...
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_iw_ir_advance_summary'  )
	{
		...
		{
			?>$("#rep_iw_ir_advance_summary > a").addClass('active');<?php
		}					
	}
	
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_advance_search'  )
	{
		?> $("#rep_advance_search").addClass('menu-open');$("#rep_advance_search > a").addClass('active'); <?php
		if($this->uri->segment(3)=='')

		{
			?>$("#rep_advance_search > a").addClass('active');<?php
		}					
	}									
											 
	if($this->uri->segment(2)=='school' )
	{
		?> $("#schoolmanagement").addClass('menu-open');$("#schoolmanagement > a").addClass('active'); <?php
		if($this->uri->segment(3)=='' || $this->uri->segment(3)=='school_view' || $this->uri->segment(3)=='edit')
		{
			?>$("#schoollist > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='add')
		{
			?>$("#schoollistadd > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='papers')
		{
			?>$("#schoolpapers > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='stats')
		{
			?>$("#schoolstats > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='schools_report')
		{
			?>$("#schools_report > a").addClass('active');<?php
		}
		
	}
	if($this->uri->segment(2)=='export' && $this->uri->segment(3)==''  )
	{
		?> $("#backups").addClass('menu-open');$("#backups > a").addClass('active'); <?php
		if($this->uri->segment(3)=='')
		{
			?>$("#export > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='downloads' && $this->uri->segment(3)=='' )
	{
		?> $("#downloads").addClass('menu-open');$("#downloads > a").addClass('active'); <?php
		if($this->uri->segment(3)=='')
		{
			?>$("#flimsydownload > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_cstrands' )
	{
		...
		{
			?>$("#rep_cstrands > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_cognitive_level_sumry' )
	{
		...
		{
			?>$("#rep_cognitive_level_sumry > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_item_sumry' )
	{
		...
		{
			?>$("#rep_item_sumry > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='rep_item_review_summary' )
	{
		...
		{
			?>$("#rep_item_review_summary > a").addClass('active');<?php
		}					
	}
	...
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='missing_items' )
	{
		...
		{
			?>$("#missing_items > a").addClass('active');<?php
		}					
	}
	if($this->uri->segment(2)=='itemsbank')
	{
		?> $("#itemsbank").addClass('menu-open');$("#itemsbank > a").addClass('active'); <?php
		if($this->uri->segment(3)=='' || $this->uri->segment(3)=='add')
		{
			?>$("#itemsbankmcq > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='itembank_crqs')
		{
			?>$("#itemsbankcrq > a").addClass('active');<?php
		}
	}
	...
	{		
		...
		{
			?>$("#ss_pindex > a").addClass('active');<?php
		}		
	}
	...
	if(($this->uri->segment(2)=='Itemsgroup'||$this->uri->segment(2)=='itemsgroup') && ($this->uri->segment(3)=='rev_ss_pitemsgroup'|| $this->uri->segment(3)=='rev_ss_aitemsgroup'))
	{
		...
		{
			?>$("#rev_ss_pitemsgroup > a").addClass('active');<?php
		}
	}
	...
	{		
		...
		{
			?>$("#rev_ss_pitemspara > a").addClass('active');<?php
		}		
	}
	...
	{
		?> $("#iritems").addClass('menu-open');$("#iritems > a").addClass('active'); <?php
		if($this->uri->segment(3)=='rev_pitems')
		{
			?>$("#rev_pitems > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='rev_eitems'||$this->uri->segment(3)=='rev_edit_combine')
		{
			?>$("#rev_eitems > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='rev_ir_revised_items')
		{
			?>$("#rev_ir_revised_items > a").addClass('active');<?php
		}
	...
	{
		?> $("#iwitems").addClass('menu-open');$("#iwitems > a").addClass('active'); <?php
		if($this->uri->segment(3)=='add_combine')
		{
			?>$("#add_combine > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='ditems'||$this->uri->segment(3)=='view_combine')
		{
			?>$("#ditems > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='sitems')
		{
			?>$("#sitems > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='ritems')
		{
			?>$("#ritems > a").addClass('active');<?php
		}
	}	
	...
	{
		?> $("#iwitemgroup").addClass('menu-open');$("#iwitemgroup > a").addClass('active'); <?php
	...
	{
		?> $("#iwitemspara").addClass('menu-open');$("#iwitemspara > a").addClass('active'); <?php			
	...
	{
		?> $("#iritemgroups").addClass('menu-open');$("#iritemgroups > a").addClass('active'); <?php	
		if($this->uri->segment(3)=='rev_pitemsgroup')
		{
			?>$("#rev_pitemsgroup > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='rev_eitemsgroup')
		{
			?>$("#rev_eitemsgroup > a").addClass('active');<?php
		}
	...
	{
		?> $("#iritemparas").addClass('menu-open');$("#iritemparas > a").addClass('active'); <?php	
		if($this->uri->segment(3)=='rev_pindex')
		{
			?>$("#rev_pindex > a").addClass('active');<?php
		}
		if($this->uri->segment(3)=='rev_eitemspara')
		{
			?>$("#rev_eitemspara > a").addClass('active');<?php
		}		
	...
	if($this->uri->segment(2)=='reports' && $this->uri->segment(3)=='items_by_itemwriters' )
	{
		...
		{
			?>$("#items_by_itemwriters > a").addClass('active');<?php
		}					
	}
	/*<li id="schoolmanagement" class="nav-item has-treeview"> <a href="#" class="nav-link"> <i class="nav-icon fa fa-map-marker"></i>
			  <p> School Management <i class="right fa fa-angle-left"></i> </p>
