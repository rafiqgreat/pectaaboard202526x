						...
						<div class="container" style="padding:5px">
							<div class="row form-group" style="border:#000 solid 4px; position: relative;">
								<div class="col-lg-12 col-sm-12" style="text-align:center; font-size:36px; font-weight:bold;">
									<span style="text-transform:uppercase"><?php if($headers['subject_name_en'] == 'Math'){print 'Mathematics';} else{ echo $headers['subject_name_en'];}?></span> PART – A (Objective Type)<!-- MCQs-->
								</div>
										...
										if($paper_mcq->item_image_en!="" && $paper_mcq->item_image_ur!="") 
										{
											?>
												<tr>
													...
													<td style="float:right"><img src="<?= base_url().$paper_mcq->item_image_ur;?>" style="max-height:400px; display: none;"/>
													</td>
												</tr>
												<?php 
										}
			...
			if($paper_para->para_text_en!='') 
			{
             ...
             <?php 
				...
				if($paper_para->para_text_ur!='') {?>
					...
					{
						$para_item_21 = $this->Paper_model->get_item_by_id($paper_para->para_item_21);
					...
					{
						$para_item_22 = $this->Paper_model->get_item_by_id($paper_para->para_item_22);
					...
					{
						$para_item_23 = $this->Paper_model->get_item_by_id($paper_para->para_item_23);
					...
					{
						$para_item_24 = $this->Paper_model->get_item_by_id($paper_para->para_item_24);
					...
					{
						$para_item_25 = $this->Paper_model->get_item_by_id($paper_para->para_item_25);
					...
					{
						$para_item_26 = $this->Paper_model->get_item_by_id($paper_para->para_item_26);
					...
					{
						$para_item_27 = $this->Paper_model->get_item_by_id($paper_para->para_item_27);
					...
					{
						$para_item_28 = $this->Paper_model->get_item_by_id($paper_para->para_item_28);
					...
					{
						$para_item_29 = $this->Paper_model->get_item_by_id($paper_para->para_item_29);
					...
					{
						$para_item_30 = $this->Paper_model->get_item_by_id($paper_para->para_item_30);
...
qrcode.makeCode("<?= base_url();?>school/qrcode/qr_code/<?= $paper_mcqs[0]->fp_paper_number;?>");
</script>
