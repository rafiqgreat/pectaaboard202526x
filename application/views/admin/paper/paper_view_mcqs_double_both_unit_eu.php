...
.urdufont-right{font-size: 24px; line-height: 20px;}
  .content-block {
				...
				<div class="container-fluid" style="margin-top:0px; clear:both;">
					<div class="row">
						...
						<?php 	$i = 0;
								...
								?>
								<table class="content-block" width="98%" style="margin:1px 1% 0 1%; font-size: 18px;">
...
?>
					...
					{?> <img src="<?= base_url().$paper_mcq->item_image_ur;?>" style="max-height:150px;"/>
										<?php }?>
										<span style="padding-left:2px;">
											<?php echo html_entity_decode($paper_mcq->item_stem_ur);?> </span> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$paper_mcq->item_id)?>"> Edit Question</a>
				...
				?>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td>
													<table border="0" cellspacing="2" cellpadding="2">
														<tr>
															<td style="font-size:18px;" ><span class="circle">a</span>
																<span>
											...
											<tr>
												<td>
													<table border="0" cellspacing="2" cellpadding="2">
														<tr>
															<td style="font-size:18px;"><span class="circle">b</span>
																<span>
											...
											<tr>
												<td>
													<table border="0" cellspacing="2" cellpadding="2">
														<tr>
															<td style="font-size:18px;"><span class="circle">c</span>
																<span>
											...
											<tr>
												<td>
													<table border="0" cellspacing="2" cellpadding="2">
														<tr>
															<td style="font-size:18px;"><span class="circle">d</span>
																<span>
								...
								if ( $paper_mcq->item_option_layout == '2' || $paper_mcq->item_option_layout=='1')
								{
            ...
            <div class="row" >
                ...
                <div style="width: 100%">                         
                  <div style="font-weight:bold; font-size:18px"><?php echo $paper_para->para_title_en; ?></div>
                </div>
                <?php }?>
			...
			//die();			
					...
					if($paper_para->para_text_en!='') 
					{
						...
						<tr>
								...
								<div style="font-size:18px"><?php echo html_entity_decode($paper_para->para_text_en);?>   </div>
							</tr>
					...
					if(isset($paper_para->para_item_21)&&$paper_para->para_item_21!=0)
					{
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_21->item_stem_en!=""){?><?php print ++$ctr;?> :<?php }?>
							  <?php }?>
							  <?php if ($para_item_21->item_type=='ERQ'){?>
							  <?php if($para_item_21->item_stem_en!=""){?><?php print ++$ctr;?> :<?php }?>
							  <?php }?>
							  <?php }?><span style="font-size:18px"><?php echo html_entity_decode($para_item_21->item_stem_en);?></span></td>
						  </tr>
						  <tr>
							<?php if($para_item_21->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php print ++$ctr;?> : <?php echo html_entity_decode($para_item_21->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$para_item_21->item_id)?>"> Edit Question</a></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td ><table border="0" cellspacing="2" cellpadding="2" >
									  <tr>
										<td><span class="circle">a</span> <span><?php echo html_entity_decode($para_item_21->item_option_a_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><?php echo html_entity_decode($para_item_21->item_option_b_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><?php echo html_entity_decode($para_item_21->item_option_c_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><?php echo html_entity_decode($para_item_21->item_option_d_en);?></span></td>
						  ...
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">a</span> <span><img src="<?= base_url().$para_item_21->item_option_a_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><img src="<?= base_url().$para_item_21->item_option_b_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><img src="<?= base_url().$para_item_21->item_option_c_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><img src="<?= base_url().$para_item_21->item_option_d_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
							  </table></td>
						...
						?>
						  <tr>
							<td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left:125px; font-size:18px">
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">a</span> <span><?php echo html_entity_decode($para_item_21->item_option_a_en);?></span></td>
					...
					if(isset($paper_para->para_item_22)&&$paper_para->para_item_22!=0)
					{
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold"> 
							  ...
							  <?php if($para_item_22->item_stem_en!=""){?><?php print ++$ctr;?> :<?php }?>
							  <?php }?>
							  <?php if ($para_item_22->item_type=='ERQ'){?>
							  <?php if($para_item_22->item_stem_en!=""){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine_erq_crq/'.$para_item_22->item_id); ?> target="_blank"><?php print ++$ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><span style="font-size:18px"><?php echo html_entity_decode($para_item_22->item_stem_en);?></span></td>
						  </tr>
						  <tr>
							<?php if($para_item_22->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php print ++$ctr;?> : <?php echo html_entity_decode($para_item_22->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$para_item_22->item_id)?>"> Edit Question</a></td><?php }?>
						  </tr>
						  ...
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td ><table border="0" cellspacing="2" cellpadding="2" >
									  <tr>
										<td><span class="circle">a</span> <span><?php echo html_entity_decode($para_item_22->item_option_a_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><?php echo html_entity_decode($para_item_22->item_option_b_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><?php echo html_entity_decode($para_item_22->item_option_c_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><?php echo html_entity_decode($para_item_22->item_option_d_en);?></span></td>
						...
						if($para_item_22->item_option_layout=='1' || $para_item_22->item_option_layout=='2')
						{
						?>
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
						  ...
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">a</span> <span><img src="<?= base_url().$para_item_22->item_option_a_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><img src="<?= base_url().$para_item_22->item_option_b_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><img src="<?= base_url().$para_item_22->item_option_c_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><img src="<?= base_url().$para_item_22->item_option_d_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
							  </table></td>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_23->item_stem_en!=""){?><?php print ++$ctr;?> :<?php }?>
							  <?php }?>
							  <?php if ($para_item_23->item_type=='ERQ'){?>
							  <?php if($para_item_23->item_stem_en!=""){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine_erq_crq/'.$para_item_23->item_id); ?> target="_blank"><?php print ++$ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><span style="font-size:18px"><?php echo html_entity_decode($para_item_23->item_stem_en);?></span></td>
						  </tr>
						  <tr>
							<?php if($para_item_23->item_stem_ur!=""){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php print ++$ctr;?> : <?php echo html_entity_decode($para_item_23->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$para_item_23->item_id)?>"> Edit Question</a></td><?php }?>
						  </tr>
						  ...
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">a</span> <span><?php echo html_entity_decode($para_item_23->item_option_a_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><?php echo html_entity_decode($para_item_23->item_option_b_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><?php echo html_entity_decode($para_item_23->item_option_c_en);?></span></td>
								...
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><?php echo html_entity_decode($para_item_23->item_option_d_en);?></span></td>
						  ...
						  <tr>
							<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:18px">
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">a</span> <span><img src="<?= base_url().$para_item_23->item_option_a_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">b</span> <span><img src="<?= base_url().$para_item_23->item_option_b_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">c</span> <span><img src="<?= base_url().$para_item_23->item_option_c_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
								<tr>
								  <td><table border="0" cellspacing="2" cellpadding="2">
									  <tr>
										<td><span class="circle">d</span> <span><img src="<?= base_url().$para_item_23->item_option_d_image;?>" style="max-height:400px;"/></span></td>
									  </tr>
									</table></td>
								</tr>
							  </table></td>
				...
				?>
				 ...
				 <?php
							...
							{
							if($subject[0]->subject_code=="ENG")
							{ //die('if');?> <table width="100%" class="papyertype mt-2">
									<tr>
										<td width="33%"></td>
										<td width="34%" style="border: 1px solid #000;"><?php print_r($paper['qat_sec_2_title_en']);?></td>
										<td width="33%" style="text-align:right !important; font-size:18px"><?php print_r($paper['qat_sec_2_marks']);?> Marks</td>
									</tr>
                                </table>
								<table width="100%" class="papyertype" style="font-size:18px">
                                <tr>
							...
							elseif($subject[0]->subject_code=="SCI" || $subject[0]->subject_code=="MTH")
							{?><table width="100%" class="papyertype mt-2">
									<tr>
										<td width="33%"></td>
										<td width="34%" style="border: 1px solid #000;"><?php print_r($paper['qat_sec_2_title_en']);?></td>
										<td width="33%" style="text-align:right !important; font-size:18px"><?php print_r($paper['qat_sec_3_marks']);?> Marks</td>
									</tr>
                                </table>
                                <table width="100%" class="papyertype">
									<tr>
										<td style="font-size:18px; text-align:left"><?php print_r($paper['qat_sec_2_statement_eng']);?></td>
                                        <td></td>
									</tr>
                                    <tr>
                                        <td colspan="2" class="urdufont-right" style="text-align:right; font-size:24px"><?php print_r($paper['qat_sec_3_statement_ur']);?></td>
									</tr>
                                </table><?php }
							else
							{//die('else');?> 
                            <table width="100%" class="papyertype mt-2" >
                                <tr>
                                    <td width="33%"></td>
                                    <td width="34%" style="border: 1px solid #000;"><?php print_r($paper['qat_sec_2_title_en']);?></td>
                                    <td width="33%" style="text-align:right !important; font-size:18px">
							...
							<?php			
								...
								foreach($paper_crqs_sec2 as $paper_mcq){
									...
									//$i++;
									if($paper_mcq->item_type_en == 'Story' || $paper_mcq->item_type_en == 'Letter' || $paper_mcq->item_type_en == 'Paragraph' || $paper_mcq->item_type_en == 'Essay' || $paper_mcq->item_type_en == 'Dialogue' || $paper_mcq->item_type_en == 'Application'){
										?>
										<table width="100%" style="margin-top:10px;" >   
										<?php if ($paper_mcq->item_stem_en!=""){?>
										<tr><td colspan="2" style="font-weight:bold; font-size:18px"><?php print ++$j;?> .
										<span style="padding-left:5px"><?php echo html_entity_decode($paper_mcq->item_stem_en);?></span>
										</td></tr>
										<?php }?>
										<?php if ($paper_mcq->item_stem_ur!=""){?>
										<tr><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">   <?php print ++$j;?> . &nbsp;									<span style="padding-left:5px:"><?php echo html_entity_decode($paper_mcq->item_stem_ur);?> </span> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$paper_mcq->item_id)?>"> Edit Question</a>
										</td></tr>
										<?php }?>
										</table>
							<?php
							...
							{ //die('if');?> <table width="100%" class="papyertype mt-2">
								...
								<table width="100%" class="papyertype" style="font-size:18px">
                                <tr>
                                    <td style="text-align:left"><?php print_r($paper['qat_sec_3_statement_eng']);?></td>
                                    <td><?php print_r($paper['qat_sec_3_submarks']);?></td>
                                </tr>
                            </table><?php }
							elseif($subject[0]->subject_code=="SCI" || $subject[0]->subject_code=="MTH")
							{?><table width="100%" class="papyertype mt-2">
                                ...
                                <table width="100%" class="papyertype">
									<tr>
										<td style="font-size:18px; text-align:left"><?php print_r($paper['qat_sec_3_statement_eng']);?></td>
                                        <td></td>
									</tr>
                                    <tr>
                                        <td colspan="2" class="urdufont-right" style="text-align:right; font-size:24px"><?php print_r($paper['qat_sec_3_statement_ur']);?></td>
                            ...
                            <table width="100%" class="papyertype mt-2" >
                                <tr>
                                    ...
                                    <td width="34%" style="border: 1px solid #000;"><?php print_r($paper['qat_sec_3_title_en']);?></td>
                                    <td width="33%" style="text-align:right !important; font-size:18px">
                                    <?php print_r($paper['qat_sec_3_marks'].' Marks');?>
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" class="papyertype">
				...
				{ 
					...
					?>
					  <tr>
						<td width="60%" valign="top" style="font-weight:bold; font-size:18px;">
							<?php if(1==1){?>                               
						...
						<?php if($group_item_1->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_1->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_1->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_2->item_stem_ur!=""){?>
						  <td width="40%" valign="top" >
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_2->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_2->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_3->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_3->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_3->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_4->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_4->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_4->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_5->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_5->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_5->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_6->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_6->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_6->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_7->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_7->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_7->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_8->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_8->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_8->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_9->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_9->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_9->item_id)?>"> Edit Question</a></td>
						...
						<?php if($group_item_10->item_stem_ur!=""){?>
						  <td width="40%" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tbody>
								<tr>
								  <td style="text-align:right; font-weight:bold" class="urdufont-right"><?php echo html_entity_decode($group_item_10->item_stem_ur);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$group_item_10->item_id)?>"> Edit Question</a></td>
