...
<!--            <a href="< ?= base_url() ?>school/paper/export_items_csv" class="btn btn-secondary">Export as CSV</a> -->
          ...
          <a href="<?= base_url('admin/paper/add_book_wise_papers_eu'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> New Paper</a>
        </div>
      </div>		
    </div>
    <div class="card">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/paper/datatable_json_book_wise_papers_list_eu')?>",
    "order": [[0,'desc']],
    "columnDefs": [
