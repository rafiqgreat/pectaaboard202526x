...
.urdufont-right{font-size: 24px; line-height: 30px;}
  .content-block {
...
?>
					...
					{?> <img src="<?= base_url().$paper_mcq->item_image_en;?>" style="max-height:150px;"/>
										...
										<span style="padding-left:2px">
											<?php echo html_entity_decode($paper_mcq->item_stem_en);?> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$paper_mcq->item_id)?>"> Edit Question</a>
										</span>
				...
				?>
							...
							{?><table width="100%" class="papyertype mt-2">
                                ...
                                <table width="100%" class="papyertype">
                                    ...
                                    <tr>
                                        <td colspan="2" class="urdufont-right" style="text-align:right; font-size:24px"><?php print_r($paper['qat_sec_2_statement_ur']);?></td>
									</tr>
                                </table><?php }
							else
							{//die('else');?> 
							...
							<?php			
								...
								foreach($paper_crqs_sec2 as $paper_mcq){
									...
									if($paper_mcq->item_type == 'ERQ'){
										...
										?>
										<?php if ($paper_mcq->item_stem_en!=""){?>
										<tr><td colspan="2" style="font-weight:bold; font-size:18px"><?php print $i;?> .
										<?php if($paper_mcq->item_image_position=='Left' && $paper_mcq->item_image_en!="")
										{?> <img src="<?= base_url().$paper_mcq->item_image_en;?>" style="max-height:400px;"/> <?php }?>
										<span style="padding-left:5px"><?php echo html_entity_decode($paper_mcq->item_stem_en);?></span> <a class="text-warning itemid" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$paper_mcq->item_id)?>"> Edit Question</a>
										<?php if($paper_mcq->item_image_position=='Right' && $paper_mcq->item_image_en!="")
