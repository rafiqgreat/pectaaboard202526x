      ...
      <div class="card">
         <div class="card-header">
            ...
            <div class="d-inline-block float-right">
               ...
               <a href="<?= base_url('admin/paper/add_model_slos'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> New Paper</a> </div>
         </div>
      </div>
      <div class="card">
         <div class="card-body">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/paper/datatable_json_model_slos_list')?>",
    "order": [[0,'desc']],
    "columnDefs": [
