                                              ...
                                              foreach ($subcstandGroups as $mpd_id => $types) {
                                                  ...
                                                  foreach ($ordered_types as $otype) {
                                                     if (!isset($types[$otype])) 
                                                      continue;
                                                     if ($otype == 'MCQ') {
                                                         print '<div style="text-align:center; margin-bottom:15px; margin-top:10px;">
                                                          ...
                                                          foreach ($types[$otype] as $slo_name => $blooms) {
                                                              foreach ($blooms as $bloom_name => $items) {
                                                                  ...
                                                                  foreach ($items as $item) {																					 
                                                                     ...
                                                                     ?>
                                                                     <table class="block" width="100%" style="">
                                                                  ...
                                                                  <?php if ($item->item_stem_en!=""){?>
                                                                     <tr>
                                                                        <td colspan="2" style="font-size:12px">
                                                                           ...
                                                                           </span><span class="itemid">(item_id: <?php print $item->item_id;?>) <a class="text-warning" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$item->item_id)?>"> Edit Question</a></span>
                                                                  ...
                                                                  <?php if ($item->item_stem_ur!=""){?>
                                                                     <tr>
                                                                        <td colspan="2" style="text-align:right; font-weight:bold" >
                                                                           ...
                                                                           <span class="itemid">(item_id: <?php print $item->item_id;?>)<a class="text-warning" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$item->item_id)?>"> Edit Question</a></span>
                                                                  ...
                                                                  <?php 
                                                                     ...
                                                                     if($item->item_type == 'ERQ'){
                                                                        ...
                                                                        {?>
                                                                           ...
                                                                           <span style="padding-left:5px"><?php echo html_entity_decode($item->item_stem_en);?></span><span class="itemid">(item_id: <?php print $item->item_id;?>) <a class="text-warning" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$item->item_id)?>"> Edit Question</a></span>
                                                                        ...
                                                                        <tr><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right"> 
                                                                           ...
                                                                           <span style="padding-right:5px;"><?php echo html_entity_decode($item->item_stem_ur);?> </span><span class="itemid">(item_id: <?php print $item->item_id;?>) <a class="text-warning" title="Edit" target="_blank" href="<?php print base_url('admin/pilot_items/pilot_edit_combine/'.$item->item_id)?>"> Edit Question</a></span>
                                                                        ...
                                                                        <?php 
                                                                          if($item->item_rubric_image!='')
                                                                          {
                                                                             ...
                                                                             {?>
                                                                                <span style="font-size:12px; font-weight:bold">Item Rubric (English) :</span>
                                                                                <table width="100%" >
                                                                                 <?php if($item->item_rubric_image_position=='Top'){?>
                                                                                 <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                                                                                 <?php }?>
                                                                          ...
                                                                          <?php }
                                                                             ...
                                                                             elseif($item->item_rubric_urdu!=''&&$item->item_rubric_english=='')
                                                                             { ?>
                                                                             <div style="font-size:14px; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div>
                                                                             <table width="100%">
                                                                              <?php if($item->item_rubric_image_position=='Top'){?>
                                                                              <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                                                                              <?php }?>
                                                                          ...
                                                                          <?php 
                                                                             ...
                                                                             elseif($item->item_rubric_urdu!=''&&$item->item_rubric_english=='')
                                                                             { ?>
                                                                             <div style="font-size:14px; width:100%; text-align:right; padding-top:15px" class="urdufont-right">جواب :</div>
                                                                          ...
                                                                          <?php }
                                                                             ...
                                                                             else
                                                                             {
                                                                                ?>
                                                                                <table style="width:100%">
                                                                                 <tr><td style="width:50%; font-size:14px">Answer: <?php echo  html_entity_decode($item->item_rubric_english);?></td><td class="urdufont-right" style="text-align:right">جواب: <?php echo html_entity_decode($item->item_rubric_urdu);?></td></tr>
                                                                                </table>
                                                                             <?php 
                                                                             }
                                                                          }?>
