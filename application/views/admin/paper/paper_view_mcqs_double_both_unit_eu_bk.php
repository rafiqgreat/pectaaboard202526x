			...
			<div class="card-body">
                ...
                <table width="100%" class="papyertype">
                    <tr>
                        ...
                        <td width="33%" style="border: 1px solid #000;">Terms # <?php print_r($paper['qat_test_number']);?></td>
                        <?php }
						elseif($paper['qat_subcs_phase']==NULL && $paper['qat_cs_id']==NULL && $paper['qat_sub_id']!=NULL){?>
                ...
                <table width="100%" class="papyertype urdufont-right" style="font-size:30px !important">
                    <tr height="40px">
                        ...
                        <?php }
						elseif($paper['qat_subcs_phase']!=NULL && $paper['qat_cs_id']==NULL && $paper['qat_sub_id']!=NULL){?>
                        <td width="33%" style="border: 1px solid #000;"> ٹرم # <?php print_r($paper['qat_test_number']);?></td>
                        <?php }
						elseif($paper['qat_subcs_phase']==NULL && $paper['qat_cs_id']==NULL && $paper['qat_sub_id']!=NULL){?>
							...
							<?php			
								...
								foreach($paper_crqs_sec2 as $paper_mcq){
									...
									if($paper_mcq->item_type_en == 'Story' || $paper_mcq->item_type_en == 'Letter' || $paper_mcq->item_type_en == 'Paragraph' || $paper_mcq->item_type_en == 'Essay' || $paper_mcq->item_type_en == 'Dialogue' || $paper_mcq->item_type_en == 'Application'){
										...
										<?php }?>
										<?php if ($paper_mcq->item_stem_ur!=""){?>
										<tr><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">   <?php print ++$j;?> . &nbsp;									<span style="padding-left:5px:"><?php echo html_entity_decode($paper_mcq->item_stem_ur);?> </span>
										</td></tr>
										<?php }?>
										</table>
							<?php
