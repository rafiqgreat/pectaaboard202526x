  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body" style="border: 10px solid; padding: 10px;">
				  ...
				  <div class="col-lg-12 col-sm-12" >
                      <table cellspacing="5" cellpadding="5" border="0" style="width: 100%;">
						<tbody>
							<tr>
                                ...
                                <td class="cls24" align="center" style="text-align: center; font-weight: bold; font-size: 30px;">
                      ...
                      <table class="cls24" cellspacing="5" cellpadding="5" border="0" style="width: 100%">
						<tbody>
                            ...
                            <tr>
								<td class="cls24" align="center">Awards this certificate to</td>
							</tr>
                            <tr>
                                <td align="center" style="font-weight: bold;">
                                    <?php print $certificate['firstname'].' '.$certificate['lastname'];?>&nbsp;
                                    ( <?php 
                            ...
                            <tr>
								<td class="cls24" align="center">For having completed the</td>
							</tr>
							<tr>
                                    ...
                                    <table cellspacing="5" cellpadding="5" border="0" style="width: 100%; font-size: 16px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td valign="top" width="33%"><img style="height: 40px;" src="<?php echo base_url(); ?>/assets/certificatelogos/sig-3.png" /><hr><strong>Assessment Expert/Subject Coordinator</strong><br>Assessment Wing</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>								
