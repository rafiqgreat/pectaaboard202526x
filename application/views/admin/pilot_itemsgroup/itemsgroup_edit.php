      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('admin/pilot_itemsgroup'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Group List</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            <?php $this->load->view('admin/includes/_messages.php') ?>
            <?php echo form_open(base_url('admin/pilot_itemsgroup/edit/'.$group->group_id), 'class="form-horizontal" enctype="multipart/form-data"');  ?>  
			
			<div class="row">
              	<div class="col-lg-3 col-sm-12">  
					<label for="group_grade_id" class="control-label">Grade *</label>
					<select name="group_grade_id" class="form-control form-group" id="group_grade_id"  required readonly style="pointer-events: none;">
                ...
                <select name="group_subject_id" class="form-control form-group" id="group_subject_id"  required readonly style="pointer-events: none;">
			...
			<div class="row">              
             ...
             <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_1" class="form-control form-group" id="group_item_1" required onChange="checkUnique('group_item_1')">
							...
							foreach($groupitems as $groupitem)
                              {
                                  ...
                                  echo '<option value="'.$groupitem['item_id'].'" '.$selected.' >'.$groupitem['item_id'].' - '.$groupitem['item_id'].' - '.$groupitem['item_code'].'</option>';
                              }
						?>
                        </select>
                    </div>	
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_2" class="form-control form-group" id="group_item_2"  required onChange="checkUnique('group_item_2')">
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                                  ...
                                  echo '<option value="'.$groupitem['item_id'].'" '.$selected.' >'.$groupitem['item_id'].' - '.$groupitem['item_code'].'</option>';
                              }
						?>
                        </select>
                    </div>
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_3" class="form-control form-group" id="group_item_3" onChange="checkUnique('group_item_3')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_4" class="form-control form-group" id="group_item_4" onChange="checkUnique('group_item_4')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
             ...
             <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_5" class="form-control form-group" id="group_item_5" onChange="checkUnique('group_item_5')">
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_6" class="form-control form-group" id="group_item_6" onChange="checkUnique('group_item_6')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_7" class="form-control form-group" id="group_item_7" onChange="checkUnique('group_item_7')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_8" class="form-control form-group" id="group_item_8" onChange="checkUnique('group_item_8')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
             ...
             <div class="col-lg-12 col-sm-12">                         
                <div class="row">
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_9" class="form-control form-group" id="group_item_9" onChange="checkUnique('group_item_9')">
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
                    ...
                    <div class="col-lg-3 col-sm-12">
                        ...
                        <select name="group_item_10" class="form-control form-group" id="group_item_10" onChange="checkUnique('group_item_10')" >
                        <option value="">--Select Item/Question--</option>
                        <?php 
							foreach($groupitems as $groupitem)
                              {
             ...
             <div class="col-lg-12 col-sm-12">                         
              <div class="form-group">
                  ...
                  <?php if($this->session->userdata('role_id')==3){?><input type="submit" name="submit" value="Update Group" class="btn btn-info pull-right"><?php }?>
                  <?php if($this->session->userdata('role_id')==2){?><input type="submit" name="submit2" value="Update Group" class="btn btn-info pull-right"><?php }?>
  ...
  for (var i=0, l=elements.length; i < l; i++) {
    if (document.getElementById(elementID).value === elements[i].value && document.getElementById(elementID) != elements[i]) {
      console.log('not unique');
        alert('Group item already selected!');
