							...
							<tbody>
								...
								foreach($dfp_schools as $dfp_school)
								{
								  ...
								  // $dis_stats_mcq = $this->School_model->get_mcq_stats_for_admin($dfp_school['school_district_id']);
								  								// print "<pre>";print_r($dis_stats_mcq);die('');
								  if(!$dfp_school['5_mcqs']){
								...
								// 	$dis_stats_mcq = $dis_stats_mcq[0];  
								  // }	
								  // else{
									/*$dis_stats_mcq['5_mcqs'] = 0;
								    $dis_stats_mcq['6_mcqs'] = 0;
								    $dis_stats_mcq['7_mcqs'] = 0;
								    $dis_stats_mcq['8_mcqs'] = 0;
								    $dis_stats_mcq['9_mcqs'] = 0;
								    $dis_stats_mcq['10_mcqs']  = 0;*/ 
								  }
								  ...
								  // $dis_mcq_total_5 += $dfp_school['5_mcqs'];
								  // $dis_mcq_total_6 += $dfp_school['6_mcqs'];
								  // $dis_mcq_total_7 += $dfp_school['7_mcqs'];
								  // $dis_mcq_total_8 += $dfp_school['8_mcqs'];
								  // $dis_mcq_total_9 += $dfp_school['9_mcqs'];
								  // $dis_mcq_total_10 += $dfp_school['10_mcqs'];
								...
								<tr style="font-weight: bold;">
									...
									<td>
										<table class="border-none" style="width: 100%" >
											<tbody>
												<tr>
													<td width="50%"><?php echo number_format($totalpublic+$totalprivate);?></td>
													<!-- <td width="50%"><?php echo $totalprivate;?></td> -->
												</tr>
											</tbody>
										</table>
...
<!-- 												<tr>
 ...
 -->
 												<tr>
													<td width="16.6%"><?php print number_format($dis_total_5 + $dis_total_6 + $dis_total_7 + $dis_total_8 + $dis_total_9 + $dis_total_10);?></td>
												</tr>
											</tbody>
										</table>
									</td>
