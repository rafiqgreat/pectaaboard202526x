						...
						<table class="tabletd" style="width: 100%" border="2" cellpadding="0">
							...
							<tbody>
								...
								foreach($dfp_schools as $dfp_school)
								{
								  ...
								  {
										$tehsil_stats_mcq = array();
										$tehsil_stats_mcq['5_mcqs'] = 0;
									    $tehsil_stats_mcq['6_mcqs'] = 0;
									    $tehsil_stats_mcq['7_mcqs'] = 0;
									    $tehsil_stats_mcq['8_mcqs'] = 0;
									    $tehsil_stats_mcq['9_mcqs'] = 0;
									    $tehsil_stats_mcq['10_mcqs'] = 0;
								  }
								  
								  /*if($tehsil_stats_crq == 0)
								  {
									 $tehsil_stats_crq = array();
									 $tehsil_stats_crq['5_crqs'] = 0;
								     $tehsil_stats_crq['6_crqs'] = 0;
								     $tehsil_stats_crq['7_crqs'] = 0;
								     $tehsil_stats_crq['8_crqs'] = 0;
								     $tehsil_stats_crq['9_crqs'] = 0;
								     $tehsil_stats_crq['10_crqs'] = 0; 
								  }*/
									...
									<tr>
										...
										<td>
											<table class="border-none" style="width: 100%" >
												<tbody>
													<tr>
														<td width="14%"><?php print ($tehsil_stats_mcq['5_mcqs']);?></td>
														<td width="14%"><?php print ($tehsil_stats_mcq['6_mcqs']);?></td>
														<td width="14%"><?php print ($tehsil_stats_mcq['7_mcqs']);?></td>
														<td width="14%"><?php print ($tehsil_stats_mcq['8_mcqs']);?></td>
														<td width="14%"><?php print ($tehsil_stats_mcq['9_mcqs']);?></td>
														<td width="14%"><?php print ($tehsil_stats_mcq['10_mcqs']);?></td>
                                                        <td width="16%"><?php print ($tehsil_stats_mcq['5_mcqs']+$tehsil_stats_mcq['6_mcqs']+$tehsil_stats_mcq['7_mcqs']+$tehsil_stats_mcq['8_mcqs']+$tehsil_stats_mcq['9_mcqs']+$tehsil_stats_mcq['10_mcqs']);?></td>
													</tr>
												</tbody>
											</table>
										</td>
