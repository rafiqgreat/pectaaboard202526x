...
<?php echo form_open(base_url('admin/items/rev_ae_submit_for_approval_resubmitted/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
...
<a href=<?php echo base_url('admin/items/rev_ae_edit_resubmitted/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
