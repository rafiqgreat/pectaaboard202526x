        	...
        	<table width="100%" border="1" style="text-align:center">
			 ...
			 <?php if($item->item_rev_comment!=""){?>
              <tr>
                ...
                <td><?php if($item->item_rev_status==0){echo "Pending";}elseif($item->item_rev_status==1){echo "Under Review";}elseif($item->item_rev_status==2){echo "Accepted";}elseif($item->item_rev_status==3){echo "Submitted";}elseif($item->item_rev_status==4){echo "Re-Submitted";}?></td>
...
<input type="hidden" id="item_rev_ae_status" name="item_rev_ae_status" value="<?= $item->item_rev_ae_status; ?>" />
