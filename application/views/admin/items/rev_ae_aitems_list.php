...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Assesment Expert Reviewed/Accepted Items List</h3>
        </div>
    ...
    <div class="card">
    <div class="card-header">
            <?php echo form_open(base_url('admin/items/rev_ae_psy_ritems_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  ?>
              ...
              <div class ="col-10">
              	<div class ="row">
                    ...
                    <div class ="col-4">
                    	<div class ="col-12">
                    	<select name="item_rev_psy_status" class="form-control form-group" id="item_rev_psy_status"  style="width:100%">						
                          <option value="">-PSY Items Status-</option>
                          <option value="3" <?= (isset($item_rev_psy_status)&&($item_rev_psy_status!=0 && $item_rev_psy_status!=2))?'selected': '' ?>>-All-</option>
                          <option value="2" <?= (isset($item_rev_psy_status)&&$item_rev_psy_status == 2)?'selected': '' ?>>-PSY Reviewed Items-</option>
                          <option value="0" <?= (isset($item_rev_psy_status)&&$item_rev_psy_status == 0)?'selected': '' ?>>-PSY Pending Items-</option>
                        </select>
                    </div>
                    </div>
                </div>
            ...
            <?php echo form_open(base_url('admin/items/rev_ae_psy_ritems_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  ?>
              ...
              <div class ="col-10">
              	<div class ="row">
                    ...
                    <div class ="col-4">
                    	<select name="item_rev_psy_status" class="form-control form-group" id="item_rev_psy_status"  style="width:100%">						
                          <option value="">- Select PSY Reviewed Status(Yes/No)-</option>
        ...
        <table id="na_datatable" class="table table-bordered table-striped" width="100%">
          <thead>
            <tr>
              ...
              <th>Type</th>
              <th>Items Code</th>
              <th width="20%">Items (Eng)</th>
              <th width="20%" class="urdufont-right" style="float:right">آئٹم</th>
              <th>Grade</th>
              <th>Subject</th>
              <th>AE Status</th>
...
$param3 = (isset($item_rev_psy_status)&&$item_rev_psy_status!="")?$item_rev_psy_status:0;
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
	<?php if($param1==0 && $param2==0 && $param3==0){?>
    "ajax": "<?=base_url('admin/items/datatable_jsona_rev_ae');?>",
	<?php } else {?>
	"ajax": "<?=base_url('admin/items/datatable_json_rev_ae_psy_searched/'.$param1.'_'.$param2.'_'.$param3);?>",
	<?php } ?>
  //  "order": [[1,'desc']],
    "columnDefs": [
