    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Psychometrician Accepted Items List (Searched)</h3>
        </div>
        <?php
        ...
        <div class="btn-group margin-bottom-20"> 
            	<a href="<?=base_url('admin/items/create_flimzy_pdf?grade_id='.$grade_id.'&subject_id='.$subject_id.'&phase_id='.$phase_id);?>" class="btn btn-secondary" style="margin:05px">Export as PDF</a>
          </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/items/datatable_jsona_rev_psy_searched/'.$param1.'_'.$param2);?>",//datatable_json_revp_psy_searched
  //  "order": [[1,'desc']],     
    "columnDefs": [
    ...
    { "targets": 7, "name": "item_rev_ss_status", 'searchable':true, 'orderable':true},
