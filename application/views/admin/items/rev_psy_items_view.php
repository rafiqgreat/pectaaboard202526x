    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php }elseif($item->item_rev_psy_status=='1'){?>
          	<a href="<?= base_url('admin/items/rev_psy_eitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }?>
          </div>
        </div>
        <div class="card-body">   
...
<?php echo form_open(base_url('admin/items/rev_psy_submit_for_approval/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
<label for="item_rev_psy_comment" class="col-sm-6 control-label" style="margin-top:15px">Comments</label>
<textarea id="item_rev_psy_comment" name="item_rev_psy_comment" rows="4" cols="55" style="width:100%; margin-bottom:25px" required="required"></textarea>
<input type="submit" name="submit" id="submit" value="Review Item" class="btn btn-success pull-right" style="margin:10px 0px;">
<?php echo form_close( );?>
</div>
