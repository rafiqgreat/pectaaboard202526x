      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php $item = $items[0];
		   ...
		   if($item->item_rev_ae_status=='0'){ ?>
            <a href="<?= base_url('admin/items/rev_ae_pitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ae_status=='2'){?>
          	<a href="<?= base_url('admin/items/rev_ae_aitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ae_status=='3'){?>
          	<a href="<?= base_url('admin/items/rev_ae_revised_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ae_status=='4'){?>
          	<a href="<?= base_url('admin/items/rev_ae_resubmitted_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
        ...
        <div class="col-lg-12">
			...
			array_pop($logs);
				foreach($logs as $log){
				  ...
				  ?>
                  <tr>
                    <td><?php echo $i++;?></td><span style="color:#F00; font-size:16px;">
            ...
            <textarea id="item_rev_ae_comment" name="item_rev_ae_comment" rows="4" cols="55" style="width:100%; margin-bottom:15px" required="required"></textarea>
            <input type="submit" name="submit" id="submit" value="Accept Item" class="btn btn-success pull-right" style="margin:5px 0px;">
            <a href=<?php echo base_url('admin/items/rev_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px;"></a>
            ...
            <?php echo form_close( );?>
            <?php } ?>
            <a href="<?= base_url('admin/items/history_compare/'.$item->item_id); ?>" class="btn btn-success pull-right" style="margin:5px 0px;">History</a> &nbsp;  <a href=<?php echo base_url('admin/items/rev_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px;"></a>
        </div>
    </div>
</div>
