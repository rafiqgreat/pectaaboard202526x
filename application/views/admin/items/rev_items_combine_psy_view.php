      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php $item = $items[0];
		   ...
		   if($item->item_rev_psy_status=='0'){ ?>
            <a href="<?= base_url('admin/items/rev_psy_pitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_psy_status=='2'){?>
          	<a href="<?= base_url('admin/items/rev_psy_aitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }?>
          </div>
        </div>
        <div class="card-body">   
...
<div class="container" style="padding-top:25px">
  ...
  <table border="1px" bordercolor="#000000" width="100%" style="margin-top:25px; text-align:center; font-weight:bold;">
    ...
    <tr>
    	...
    	<td><?php if($item->item_type !== 'ERQ'){echo $item->item_option_correct;}?></td>
            ...
            else
            {
				...
				<?php if ($item->item_image_position=='Bottom') 
                {
                    if($item->item_image_en!="" && $item->item_image_ur!="") 
                    {
                        ?>
                         <tr>
                            <td style="float:left"><img src="<?= base_url().$item->item_image_en;?>" style="max-width:100%;"/></td>
		...
		elseif($item->item_type=='ERQ')
		{
			if($item->item_rubric_image!='')
			{
				  ...
				  {?>
                      ...
                      <table width="100%" >
                          <tr><td><span style="font-size:16px; font-weight:bold">Item Rubric (English) :</span></td></tr>
                        <?php if($item->item_rubric_image_position=='Top'){?>
                        <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                        <?php }?>
			...
			else
			{
				  ...
				  {?>
                      ...
                      <table width="100%" >
                          <tr><td><span style="font-size:16px; font-weight:bold">Item Rubric (English) :</span></td></tr>
                          <tr><td><?php echo  html_entity_decode($item->item_rubric_english);?></td></tr>
                   </table>
              <?php 
				  }
				  elseif($item->item_rubric_urdu!=''&&$item->item_rubric_english=='')
...
?>               
  ...
  <div class="row col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <?php if($item->item_rev_psy_status==0){?>
			<?php echo form_open(base_url('admin/items/rev_submit_for_approval_his_log/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
            <label for="item_rev_psy_comment" class="col-sm-6 control-label" style="margin-top:15px">Comments</label>
            <textarea id="item_rev_psy_comment" name="item_rev_psy_comment" rows="4" cols="55" style="width:100%; margin-bottom:15px" required="required"></textarea>
            <input type="submit" name="submit" id="submit" value="Review Item" class="btn btn-success pull-right" style="margin:5px 0px;">
            <?php echo form_close( );?>
            <?php } ?>
            <a href="<?= base_url('admin/items/history_compare/'.$item->item_id); ?>" class="btn btn-success pull-right" style="margin:5px 0px;">History</a>
        </div>
    </div>
</div>
            	...
            	<tr>
                	<td><div class="row col-12">
                      <div class="col-5 ">
                        ...
                        <div class="row col-12 borders" style="padding-bottom:8px">
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                           <div class="col-4"><?php if($item->item_en_mc1_1!=""){echo "1 - ".html_entity_decode($item->item_en_mc1_1);}?></div>
                            <?php if($item->item_pic_mc1_1!=""){?>
                                <div class="col-4 urdufont-right" style="text-align:right">1 - <?php echo  html_entity_decode($item->item_ur_mc1_1);?></div>
                                <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_1;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                           <div class="col-4"><?php if($item->item_en_mc1_2!=""){echo "2 - ".html_entity_decode($item->item_en_mc1_2);}?></div>
                             <?php if($item->item_pic_mc1_2!=""){?>
                                <div class="col-4 urdufont-right" style="text-align:right">2 - <?php echo  html_entity_decode($item->item_ur_mc1_2);?></div>
                                <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_2;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_3!=""){echo "3 - ".html_entity_decode($item->item_en_mc1_3);}?></div>
                            <?php if($item->item_pic_mc1_3!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "3 - ". html_entity_decode($item->item_ur_mc1_3);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_3;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_4!=""){echo "4 - ".html_entity_decode($item->item_en_mc1_4);}?></div>
                            <?php if($item->item_pic_mc1_4!=""){?>
                            <div class="col-4 urdufont-right"  style="text-align:right"><?php echo "4 - ".  html_entity_decode($item->item_ur_mc1_4);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_4;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                           <div class="col-4"><?php if($item->item_en_mc1_5!=""){echo "5 - ".html_entity_decode($item->item_en_mc1_5);}?></div>
                            <?php if($item->item_pic_mc1_5!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "5 - ".  html_entity_decode($item->item_ur_mc1_5);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_5;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_6!=""){echo "6 - ".html_entity_decode($item->item_en_mc1_6);}?></div>
                            <?php if($item->item_pic_mc1_6!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "6 - ". html_entity_decode($item->item_ur_mc1_6);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_6;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                             <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_7!=""){echo "7 - ".html_entity_decode($item->item_en_mc1_7);}?></div>
                            <?php if($item->item_pic_mc1_7!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "7 - ". html_entity_decode($item->item_ur_mc1_7);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_7;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                             <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_8!=""){echo "8 - ".html_entity_decode($item->item_en_mc1_8);}?></div>
                            <?php if($item->item_pic_mc1_8!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "8 - ". html_entity_decode($item->item_ur_mc1_8);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_8;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                             <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_9!=""){echo "9 - ".html_entity_decode($item->item_en_mc1_9);}?></div>
                            <?php if($item->item_pic_mc1_9!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "9 - ". html_entity_decode($item->item_ur_mc1_9);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_9;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                             <?php }else{?>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc1_10!=""){echo "10 - ".html_entity_decode($item->item_en_mc1_10);}?></div>
                            <?php if($item->item_pic_mc1_10!=""){?>
                            <div class="col-4 urdufont-right" style="text-align:right"><?php echo "10 - ". html_entity_decode($item->item_ur_mc1_10);?></div>
                            <div class="col-4"><img src="<?= base_url().$item->item_pic_mc1_10;?>" style="max-height:65px; max-width:65px; float:right"/></div>
                            <?php }else{?>
                      ...
                      <div class="col-5">
                        ...
                        <div class="row col-12 borders" style="padding-bottom:8px">
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_a!=""){echo "a - ".html_entity_decode($item->item_en_mc2_a);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_b!=""){echo "b - ".html_entity_decode($item->item_en_mc2_b);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_c!=""){echo "c - ".html_entity_decode($item->item_en_mc2_c);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_d!=""){echo "d - ".html_entity_decode($item->item_en_mc2_d);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_e!=""){echo "e - ".html_entity_decode($item->item_en_mc2_e);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_f!=""){echo "f - ".html_entity_decode($item->item_en_mc2_f);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_g!=""){echo "g - ".html_entity_decode($item->item_en_mc2_g);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_h!=""){echo "h - ".html_entity_decode($item->item_en_mc2_h);}?></div>
                          ...
                          <div class="container"><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                            <div class="col-4"><?php if($item->item_en_mc2_i!=""){echo "i - ".html_entity_decode($item->item_en_mc2_i);}?></div>
                      ...
                      <div class="col-2">
                        <div class="row" id="item_mc_ans_key">
                          <div class="col-6">
                            <label for="item_mc_ans_key" class="control-label">
                            <h3>Answer</h3>
                            </label>
                          </div>
                          <div class="col-6 urdufont-right" style="text-align:right">
                        ...
                        <div class="row borders" style="padding:0px 0px 0px 15px;">
                          <?php if($ans1!=""){?>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans1;?></div>
                          <?php } if($ans2!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans2;?></div>
                          <?php } if($ans3!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans3;?></div>
                          <?php } if($ans4!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans4;?></div>
                          <?php } if($ans5!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans5;?></div>
                          <?php } if($ans6!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans6;?></div>
                          <?php } if($ans7!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans7;?></div>
                          <?php } if($ans8!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans8;?></div>
                          <?php } if($ans9!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans9;?></div>
                          <?php } if($ans10!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px"><?php echo $ans10;?></div>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
