    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; AE Reviewed Items List with PSY Status(Searched)</h3>
        </div>
              	...
              	<div class ="row">
                    ...
                    <div class ="col-4">
                    	...
                    	<select name="item_rev_psy_status" class="form-control form-group" id="item_rev_psy_status"  style="width:100%">						
                          <option value="">-PSM Reviewed Items-</option>
                          <option value="3" <?= ($item_rev_psy_status!=2 && $item_rev_psy_status!=2)?'selected': '' ?>>-All-</option>
                          <option value="2" <?= ($item_rev_psy_status == 2)?'selected': '' ?>>-Yes-</option>
                          <option value="0" <?= ($item_rev_psy_status == 0)?'selected': '' ?>>-No-</option>
                        </select>
                    </div>
                    </div>
                </div>
...
<script>
  ...
  //  "order": [[1,'desc']],     
    "columnDefs": [
		...
		{ "targets": 9, "name": "item_rev_psy_status", 'searchable':true, 'orderable':true},
