        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_status==2){echo "Submitted";}elseif($item->item_rev_status==1){echo "Under Review";}elseif($item->item_rev_status==0){echo "Pending";}elseif($item->item_rev_status==3){echo "Submitted";}elseif($item->item_rev_status==4){echo "Re-submitted";}?></td>
