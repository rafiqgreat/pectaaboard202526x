		   ...
		   if(isset($item->item_id)&&$item->item_id!=0)
		   {
            ...
            else
            {
                ...
                ?>
                    ...
                    <span style="font-weight:bold; font-size:20px"> Question : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo html_entity_decode($item->item_stem_en);?> (Item Makrs : <?php echo html_entity_decode($item->item_total_marks);?>)</span>
                    ...
                    سوال :&nbsp;<?php echo html_entity_decode($item->item_stem_ur);?> ( آ یٹم نمبر : <?php echo html_entity_decode($item->item_total_marks);?>)
		...
		elseif($item->item_type=='ERQ')
		{
			if($item->item_rubric_image!='')
			{
              ...
              <?php }
                  ...
                  <table width="100%">
					  <tr><td colspan="3"><div style="font-size:24px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
                    <?php if($item->item_rubric_image_position=='Top'){?>
                    <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                    <?php }?>
                    <tr>
			...
			else
			{
              ...
              <?php 
                  ...
                  <table width="100%">
					  <tr><td style="text-align:right"><div style="font-size:24px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
                        ...
                        <div class="row col-12 borders" style="padding-bottom:8px">
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_a!="")
							{
								...
								elseif($item->item_en_mc2_a=="" && $item->item_ur_mc2_a=="")
								{?>
                                    <div class="col-12" style="float:left">a - <img src="<?php echo base_url().$item->item_pic_mc2_a;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_b!="")
							{
								...
								elseif($item->item_en_mc2_b=="" && $item->item_ur_mc2_b=="")
								{?>
                                    <div class="col-12" style="float:left">b - <img src="<?php echo base_url().$item->item_pic_mc2_b;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
                           <?php 
							if($item->item_pic_mc2_c!="")
							{
								...
								elseif($item->item_en_mc2_c=="" && $item->item_ur_mc2_c=="")
								{?>
                                    <div class="col-12" style="float:left">c - <img src="<?php echo base_url().$item->item_pic_mc2_c;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_d!="")
							{
								...
								elseif($item->item_en_mc2_d=="" && $item->item_ur_mc2_d=="")
								{?>
                                    <div class="col-12" style="float:left">d - <img src="<?php echo base_url().$item->item_pic_mc2_d;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_e!="")
							{
								...
								elseif($item->item_en_mc2_e=="" && $item->item_ur_mc2_e=="")
								{?>
                                    <div class="col-12" style="float:left">e - <img src="<?php echo base_url().$item->item_pic_mc2_e;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_f!="")
							{
								...
								elseif($item->item_en_mc2_f=="" && $item->item_ur_mc2_f=="")
								{?>
                                    <div class="col-12" style="float:left">f - <img src="<?php echo base_url().$item->item_pic_mc2_f;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_g!="")
							{
								...
								elseif($item->item_en_mc2_g=="" && $item->item_ur_mc2_g=="")
								{?>
                                    <div class="col-12" style="float:left">g - <img src="<?php echo base_url().$item->item_pic_mc2_g;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_h!="")
							{
								...
								elseif($item->item_en_mc2_h=="" && $item->item_ur_mc2_h=="")
								{?>
                                    <div class="col-12">h - <img src="<?php echo base_url().$item->item_pic_mc2_h;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_i!="")
							{
								...
								elseif($item->item_en_mc2_i=="" && $item->item_ur_mc2_i=="")
								{?>
                                    <div class="col-12" style="float:left">i - <img src="<?php echo base_url().$item->item_pic_mc2_i;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <?php 
							if($item->item_pic_mc2_j!="")
							{
								...
								elseif($item->item_en_mc2_j=="" && $item->item_ur_mc2_j=="")
								{?>
                                    <div class="col-12">j - <img src="<?php echo base_url().$item->item_pic_mc2_j;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
