      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
			...
			<?php $item_rev_ae_status = (isset($item['item_rev_ae_status'])&&$item['item_rev_ae_status']!="")?$item['item_rev_ae_status']:0; ?>
             
            <input type="hidden" id="item_registration" name="item_registration" value="LOGGED-USER" />
            <input type="hidden" id="item_rev_ae_status" name="item_rev_ae_status" value="<?php echo $item_rev_ae_status;?>" />
			...
			<div class="row">
              	<div class="col-lg-2 col-sm-12">  
					...
					<select name="item_grade_id" class="form-control form-group" id="item_grade_id"  required readonly style="pointer-events: none;">
