      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php $item = $items[0];
		   ...
		   if($item->item_status_psy=='0'){ ?>
            <a href="<?= base_url('admin/items/psy_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_status_psy=='1'){?>
          	<a href="<?= base_url('admin/items/psy_items_rev'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }?>
          </div>
        </div>
        <div class="card-body">   
        ...
        <div class="col-lg-12">
            <table width="100%" border="1" style="text-align:center">
              ...
              <?php $i=1; 
				...
				$ae_approvedctr = 0;
			  foreach($logs as $log){
				if($log->log_messagetype=="created")
				{  
              ...
              <tr>
                ...
                <td><?php echo "Item Created by IW";?></td>
                <td><?php echo "New Item Created";?></td>
                <td><?php echo "";?></td>
...
<!------------------------------------------------------------------------------------------------------------------------------>              
			  <?php
			  foreach($logs as $log){
				if($log->log_messagetype=="updated")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_itemwriter_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
                  ...
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $log->username;?></td>
                    <td><?php echo $log->log_title.' by IW';?></td>
                    <td><?php echo $new_string;?></td>
                    <td><?php echo $log->log_comment;?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($log->log_date));?></td>
                    <td>-----------</td>
              ...
              <?php $updatedctr++;}
			   ...
			   if($updatedctr==0 && $item->item_updatedby!=0 && $item->item_updatedby==$item->item_submittedby){?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item Updated by IW";?></td>
                    <td><?php echo "Item Updated";?></td>
                    <td><?php echo "";?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_updated));?></td>
                    <td>-----------</td>
                  </tr>
              <?php } ?>
<!------------------------------------------------------------------------------------------------------------------------------>
<?php
			  foreach($logs as $log){
				if($log->log_messagetype=="submitted")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
				  ?>
                  <tr>
                    ...
                    <td><?php echo $log->log_comment;?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($log->log_date));?></td>
                    <td><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
                    <a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View History" class="btn btn-info pull-right" style="margin-top:10px;"></a></td>
                  </tr>
              <?php $submittedctr++;}
			  }
			   if($submittedctr==0 && $item->item_status==2){?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item submitted by IW";?></td>
                    <td><?php echo "Item submitted";?></td>
                    <td><?php echo "";?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_submitted));?></td>
                    <td><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
                    <a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View History" class="btn btn-info pull-right" style="margin-top:10px;"></a></td>
                  </tr>
              <?php } ?>
...
<?php
			  foreach($logs as $log){
				if($log->log_messagetype=="ss_updated")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
                  ...
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $log->username;?></td>
                    <td><?php echo $log->log_title.' by SS';?></td>
                    <td><?php echo $new_string;?></td>
                    <td><?php echo $log->log_comment;?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($log->log_date));?></td>
                    <td><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
                    <a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View History" class="btn btn-info pull-right" style="margin-top:10px;"></a></td>
                  </tr>
              <?php $ss_updatedctr++;}
			  }
			   if($ss_updatedctr==0 && $item->item_updatedby!=0 && $item->item_updatedby==$item->item_approvedby){
				   ?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item updated by SS";?></td>
                    <td><?php echo "Item updated";?></td>
                    <td><?php echo "";?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_updated));?></td>
                    <td><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
...
<?php
			  foreach($logs as $log){
				if($log->log_messagetype=="ss_accept_w_c" || $log->log_messagetype=="ss_accept_wo_c")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
              ...
              <?php $ss_acceptctr++;}
			   ...
			   if($ss_acceptctr==0 && $item->item_approvedby!=0){?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item approved by SS";?></td>
...
<?php
			  foreach($logs as $log){
				if($log->log_messagetype=="ae_approved")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
              ...
              <?php $ae_approvedctr++;}
			   ...
			   if($ae_approvedctr==0 && $item->item_reviewedby!=0){?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item reviewed by AE";?></td>
                    <td><?php echo "Item reviewed";?></td>
                    <td><?php echo "";?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_reviewedby));?></td>
                    <td><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
                    <a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View History" class="btn btn-info pull-right" style="margin-top:10px;"></a></td>
                  </tr>
              <?php } ?>
...
<?php
			  foreach($logs as $log){
				if($log->log_messagetype=="psy_reviewed")
				{ $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", $log->username, $log_sms);
				  $new_string = str_replace("{log_itemid}", $log->log_itemid, $new_string);
				  $new_string = str_replace("{log_date}", $log->log_date, $new_string);
              ...
              <?php $ae_approvedctr++;}
			   ...
			   if($ae_approvedctr==0 && $item->item_commentby_psy!=0){?>
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $item->username;?></td>
                    <td><?php echo "Item reviewed by PSM";?></td>
                    <td><?php echo "Item reviewed";?></td>
                    <td><?php echo "";?></td>
                    <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_date_psy));?></td>
                    <td><?php /*?><?php /*?><a href="<?= base_url('admin/items/get_item_history/'.$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a>
                    <a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View History" class="btn btn-info pull-right" style="margin-top:10px;"></a></td>
                  </tr>
              <?php } ?>
<!------------------------------------------------------------------------------------------------------------------------------>
              <!------------------Submission of item ends AE------------------------>
            </table>
            <?php }*/?>
            <?php if(!empty($logs)){?><div class="col-lg-12" style="padding-left:25px; padding-top:25px"> </div>
        <div class="col-lg-12">
            <table width="100%" border="1" style="text-align:center">
              <tr style="font-weight:bold">
                ...
                <td width="12%">Date</td>
                <?php /*?><td width="10%">History</td><?php */?>
              </tr>
            <?php $i=1;
				foreach($logs as $log){
            ...
            <label for="item_comment_psy" class="col-sm-6 control-label" style="margin-top:15px">Comments</label>
            <textarea id="item_comment_psy" name="item_comment_psy" rows="4" cols="55" style="width:100%; margin-bottom:15px" required="required"></textarea>
            <input type="submit" name="submit" id="submit" value="Review Item" class="btn btn-success pull-right" style="margin:5px 0px;">
            <?php echo form_close( );?>
            <?php } ?>
            <a href="<?= base_url('admin/items/history_compare/'.$item->item_id); ?>" class="btn btn-success pull-right" style="margin:10px 10px;">History</a>s
        </div>
    </div>
</div>
