        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_ss_status==0){echo "Pending";}elseif($item->item_rev_ss_status==1){echo "Under Review";}elseif($item->item_rev_ss_status==2){echo "Accepted";}elseif($item->item_rev_ss_status==3){echo "Revised";}?></td>
