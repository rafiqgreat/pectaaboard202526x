  ...
  <section class="content">
    <div class="card card-default color-palette-bo">
      ...
      <?php $this->load->view('admin/includes/_messages.php') ?>
        <?php echo form_open(base_url('admin/items/edit_combine/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" onsubmit="return check_MC_values()"');  ?>
      <div class="card-body"> 
        <!-- For Messages -->
        ...
        <div class="row">
            ...
            <div class="col-10">
                <select name="item_type" class="form-control form-group" id="item_type"  required="required" readonly style="pointer-events: none;">
                    ...
                    <?php /*?><option value="FIB" <?php if($item['item_type']=="FIB"){?> selected="selected" <?php }?>>Fill in Blanks</option>
                    <option value="TF" <?php if($item['item_type']=="TF"){?> selected="selected" <?php }?>>True/Flase</option>
                    <option value="MC" <?php if($item['item_type']=="MC"){?> selected="selected" <?php }?>>Match Column</option><?php */?>
                </select>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-12">
            ...
            <select  name="item_batch" class="form-control" id="item_batch" readonly>
              	<option value="1" <?= ($item['item_batch'] == "1")?'selected': '' ?>>Section-1 (MCQ</option>
                <option value="2" <?= ($item['item_batch'] == "2")?'selected': '' ?>>Section-2 (Short Question)</option>
                <option value="3" <?= ($item['item_batch'] == "3")?'selected': '' ?>>Section-3 (Long Question)</option>
            </select>
          </div>
        </div>
        	<div class="row">
...
var MC_content = '<div class="row">'+
                        ...
                        '<div class="row col-12 borders" style="padding-bottom:8px">'+
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_1'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_1-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            ...
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_2" class="control-label" style="padding-top:5px">Option-2</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_2'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_2-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_3" class="control-label" style="padding-top:5px" >Option-3</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_3'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_3-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_4" class="control-label" style="padding-top:5px" >Option-4</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_4'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_4-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                               '<div class="col-4">'+
                                    '<label for="item_en_mc1_5" class="control-label" style="padding-top:5px" >Option-5</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_5'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_5-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_6" class="control-label" style="padding-top:5px" >Option-6</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_6'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_6-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_7" class="control-label" style="padding-top:5px" >Option-7</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_7'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_7-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_8" class="control-label" style="padding-top:5px" >Option-8</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_8'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_8-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:5px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_9" class="control-label" style="padding-top:5px" >Option-9</label>'+
                            ...
                            '<div class="row" style="margin-bottom:5px">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc1_10" class="control-label" style="padding-top:5px" >Option-10</label>'+
                                ...
                                '<div class="col-4">'+
									...
									'<?php } else {?>'+
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_10'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc1_10-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                                    '<?php }?>'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
                    ...
                    '<div class="col-5">'+
                        ...
                        '<div class="row col-12 borders" style="padding-bottom:5px">'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_a" class="control-label" style="padding-top:5px">Option-a</label>'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_a'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_a-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:3px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_b" class="control-label" style="padding-top:5px">Option-b</label>'+
                                ...
                                '<div class="col-4">'+
                                   ...
                                   '<?php if ($item['item_pic_mc2_b']==""){?>'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_b'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_b-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                               ' </div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:3px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_c" class="control-label" style="padding-top:5px">Option-c</label>'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_c'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_c-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:3px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_d" class="control-label" style="padding-top:5px">Option-d</label>'+
                            ...
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_e" class="control-label" style="padding-top:5px">Option-e</label>'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_e'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_e-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:3px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                   '<label for="item_en_mc2_f" class="control-label" style="padding-top:5px">Option-f</label>'+
                            ...
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_g" class="control-label" style="padding-top:5px">Option-g</label>'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_g'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_g-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                                '</div>'+
                            '</div>'+
                            '<div class="container" ><table width="100%"><tr><td style="border-bottom: 2px solid #CCC; padding-top:3px"></td></tr></table></div>'+
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_h" class="control-label" style="padding-top:5px">Option-h</label>'+
                            ...
                            '<div class="row">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_i" class="control-label" style="padding-top:5px">Option-i</label>'+
                            ...
                            '<div class="row" style="margin-bottom:5px">'+
                                '<div class="col-4">'+
                                    '<label for="item_en_mc2_j" class="control-label" style="padding-top:5px">Option-j</label>'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_j'];?>" style="max-height:55px; max-width:55px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/items/delete_image_combine/item_pic_mc2_j-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
									'<?php }?>'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
                            ...
                            '<div class="row borders" style="padding:10px 0px 0px 10px; margin-top:-10px">'+
                                '<div class="row col-12">'+
                                    ...
                                    '<select name="item_mc_ans_key_1" class="form-control form-group" id="item_mc_ans_key_1" >'+
									  ...
									  '<option value="a" <?= ($ans1 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans1 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans1 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans1 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans1 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans1 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans1 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans1 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans1 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans1 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
								...
								'<div class="row col-12">'+
                                    ...
                                    '<select name="item_mc_ans_key_2" class="form-control form-group" id="item_mc_ans_key_2" >'+
									  '<option value="">-Selected Answer-</option>'+
                                      '<option value="a" <?= ($ans2 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans2 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans2 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans2 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans2 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans2 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans2 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans2 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans2 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans2 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_3" class="form-control form-group" id="item_mc_ans_key_3" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans3 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans3 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans3 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans3 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans3 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans3 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans3 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans3 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans3 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans3 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_4" class="form-control form-group" id="item_mc_ans_key_4" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans4 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans4 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans4 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans4 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans4 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans4 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans4 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans4 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans4 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans4 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_5" class="form-control form-group" id="item_mc_ans_key_5" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans5 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans5 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans5 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans5 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans5 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans5 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans5 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans5 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans5 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans5 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_6" class="form-control form-group" id="item_mc_ans_key_6" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans6 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans6 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans6 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans6 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans6 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans6 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans6 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans6 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans6 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans6 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_7" class="form-control form-group" id="item_mc_ans_key_7" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans7 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans7 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans7 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans7 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans7 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans7 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans7 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans7 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans7 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans7 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_8" class="form-control form-group" id="item_mc_ans_key_8" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans8 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans8 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans8 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans8 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans8 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans8 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans8 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans8 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans8 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans8 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 10px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_9" class="form-control form-group" id="item_mc_ans_key_9" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans9 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans9 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans9 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans9 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans9 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans9 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans9 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans9 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans9 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans9 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                                '<div class="container" style="margin:-12px 0px 8px 0px"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>'+
                                <!------------------------------------------------------>
                                '<div class="row col-12">'+
									...
									'<select name="item_mc_ans_key_10" class="form-control form-group" id="item_mc_ans_key_10" >'+
                                      '<option value="">-Selected Answer-</option>'+
									  '<option value="a" <?= ($ans10 == "a")?'selected="selected"': ''; ?>>Option-a</option>'+
                                      '<option value="b" <?= ($ans10 == "b")?'selected="selected"': ''; ?>>Option-b</option>'+
                                      '<option value="c" <?= ($ans10 == "c")?'selected="selected"': ''; ?>>Option-c</option>'+
                                      '<option value="d" <?= ($ans10 == "d")?'selected="selected"': ''; ?>>Option-d</option>'+
                                      '<option value="e" <?= ($ans10 == "e")?'selected="selected"': ''; ?>>Option-e</option>'+
                                      '<option value="f" <?= ($ans10 == "f")?'selected="selected"': ''; ?>>Option-f</option>'+
                                      '<option value="g" <?= ($ans10 == "g")?'selected="selected"': ''; ?>>Option-g</option>'+
                                      '<option value="h" <?= ($ans10 == "h")?'selected="selected"': ''; ?>>Option-h</option>'+
                                      '<option value="i" <?= ($ans10 == "i")?'selected="selected"': ''; ?>>Option-i</option>'+
                                      '<option value="j" <?= ($ans10 == "j")?'selected="selected"': ''; ?>>Option-j</option>'+
                                    '</select>'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
...
function check_MC_valuesxz(x1,xa) 
{
	...
	{
		//alert("Value Missing in Columns! first 2 ["+col1+col2+col3+"]");
		return false;
	}
...
function check_MC_valuesx(x1,xa) 
{
	...
	if ( ($( '#item_en_mc1_'+x1 ).val() != '' || $( '#item_ur_mc1_'+x1 ).val() != '' || $( '#item_pic_mc1_'+x1 ).val() != '' ) )
	{
		//alert($( '#item_en_mc1_'+x1 ).val());
		//alert($( '#item_ur_mc1_'+x1 ).val());
		//alert($( '#item_pic_mc1_'+x1 ).val());
		col1x = 1;		
	}
	if($( '#item_en_mc2_'+xa ).val() != '' || $( '#item_ur_mc2_'+xa ).val() != '' || $( '#item_pic_mc2_'+xa ).val() != '')
	{
		//alert($( '#item_en_mc2_'+xa ).val());
		//alert($( '#item_ur_mc2_'+xa ).val());
		//alert($( '#item_pic_mc2_'+xa ).val());
		
		col2x = 1;
	}
	if ( $( '#item_mc_ans_key_'+x1 ).val() != '')
	{
		//alert($( '#item_mc_ans_key_'+x1 ).val());
		col3x = 1;
	}
	if((col1x == 0 && col2x == 0 && col3x == 0) || (col1x == 1 && col2x == 1 && col3x == 1))
	{
		//alert('ok');
		//alert("OK Columns! ["+col1x+col2x+col3x+"]"+x1+"=="+xa);
		return true;
	}
	else
	{
		//alert("Value Missing in Columns! ["+col1x+col2x+col3x+"]"+x1+"=="+xa);
		return false;
	}
	//return true;
}//rnf check_mc_values
