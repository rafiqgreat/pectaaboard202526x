		...
		elseif($item->item_type=='ERQ')
		{
			...
			else
			{
              ...
              <?php 
                  ...
                  <table width="100%">
					  <tr><td style="text-align:right"><span class="urdufont-right"><div style="font-size:24px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
...
?>               
  ...
  <div class="row col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <label for="item_comment_ss" class="col-sm-6 control-label" style="margin-top:15px">Comments</label>
            <textarea id="item_comment_ss" name="item_comment_ss" rows="4" cols="55" style="width:100%; margin-bottom:15px" required="required"></textarea>
            ...
            <?php echo form_close( );?>
            <?php } ?>
            <?php if ($item->item_status_ss==1 && $item->item_status==4 && $item->item_status_ae==2){?>
        	...
        	<?php }?> 
        	<?php if($item->item_discard_status==0 && $item->item_status_ss==0){?>
			<?php echo form_open(base_url('admin/items/ss_submit_for_discard/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" style="padding-top:25px"');  ?>  
                <div style="padding-top:15px; margin-left:5px">
                    <label for="item_discard_comment" class="col-sm-6 control-label">Discard Comments (Note : If you discard this item, you cannot reuse it)</label>
                    <textarea id="item_discard_comment" name="item_discard_comment" rows="2" cols="55" style="width:100%" required="required"></textarea>
                    <input type="submit" name="discard_ss" id="discard_ss" value="Discard Item" class="btn btn-danger pull-right" style="margin:5px">
                </div>
            <?php echo form_close( );}  ?> 
            <a href="<?= base_url('admin/items/history_compare/'.$item->item_id); ?>" class="btn btn-success pull-right" style="margin:5px 10px;">History</a>
        </div>
    </div>
</div>
