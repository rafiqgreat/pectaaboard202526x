        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_status==0){echo "Pending";}elseif($item->item_rev_status==1){echo "Under Review";}elseif($item->item_rev_status==2){echo "Accepted";}elseif($item->item_rev_status==3){echo "Submitted";}elseif($item->item_rev_status==4){echo "Resubmitted";}?></td>
...
<?php echo form_open(base_url('admin/items/rev_ss_submit_for_approval_resubmitted/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
...
<a href=<?php echo base_url('admin/items/rev_ss_edit_resubmitted/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
<input type="submit" name="reject" id="reject" value="Revise Item" class="btn btn-danger pull-right" style="margin:10px 0px; width:110px">
<?php echo form_close( );?>
</div>
