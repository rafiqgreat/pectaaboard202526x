        ...
        <div class="card-header">
          ...
          <?php $item = $items[0];
			...
			$psyinfo = (isset($psyinfo[0]))?$psyinfo[0]:"";
		  	...
		  	<a href="<?= base_url('admin/items/rev_ir_revised_items');?>" class="btn btn-success"><i class="fa fa-list"></i>Items List</a>
		  	<?php }?>
          </div>
        </div>
        <div class="card-body">   
        ...
        <div class="row col-12">
        	<div class="col-12" style="padding-left:40px; padding-top:10px">
                ...
                <div class="col-lg-12 col-sm-12" style="font-weight:bold">
                	<?php 
						$distName = '';
						$dist = $this->Items_model->get_iw_distname($item->item_submittedby);
						if($dist)
							$distName = ' ('.$dist['district_name_en'].')';
						?>
                    <table width="100%" class="border-bottom"><tr><td width="35%">Item Writer Name : </td><td><?php echo $item->firstname.' '.$item->lastname.'('.$item->username.')'.$distName;?></td></tr></table>
                </div>
                <div class="col-lg-12 col-sm-12" style="font-weight:bold">
			 ...
			 if($item->item_fib_key_ur==''&&$item->item_fib_key_eng!='')
              ...
              <?php }
                  else
                  {
                      ...
                      <table style="width:100%">
                        <tr>
                            <td style="width:50%; font-size:18px" class="urdufont-right">
...
?>               
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <?php /*if($item->item_rev_status==0 && $this->session->userdata('role_id') == 6){?>
			<div style="padding:15px 0px; float:right"><a href="<?= base_url('admin/items/rev_submit_for_approval_his_log/'.$item->item_id); ?>" class="btn btn-success"> Submit For Approval</a></div>
            <?php } ?>
            <?php if (($item->item_rev_status==3 || $item->item_rev_status==1) && $this->session->userdata('role_id') == 6){?>
            <a href=<?php echo base_url('admin/items/rev_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:15px"></a>
            <?php }*/?>
            ...
            <div class="col-md-12"><input type="submit" name="submit" id="submit" value="Accept Item" class="btn btn-success pull-right" style="margin:10px 0px;"></div>
