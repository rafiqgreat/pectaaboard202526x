    ...
    <div class="row col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <?php if($item->item_status_ss==0){?>
			 ...
			 <?php echo form_open(base_url('admin/items/ss_submit_for_approval/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
                ...
                <div style="padding-top:15px; margin-left:5px">
                    ...
                    <input type="submit" name="submit_awc" id="submit_awc" value="Approve With Change" class="btn btn-success pull-right" style="margin:5px">

                    <input type="submit" name="submit_awoc" id="submit_awoc" value="Approve Without Change" class="btn btn-success pull-right" style="margin:5px">
			...
			<?php /*?><div>
                ...
                <label for="item_comment_ss" class="control-label">Comments </label>

                <textarea id="item_comment_ss" name="item_comment_ss"  class="form-control form-group" ></textarea>
