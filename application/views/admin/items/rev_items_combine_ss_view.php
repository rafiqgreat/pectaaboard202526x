      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php $item = $items[0];
		   ...
		   if($item->item_rev_ss_status=='0'){ ?>
            <a href="<?= base_url('admin/items/rev_ss_pitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ss_status=='3'){?>
          	<a href="<?= base_url('admin/items/rev_ss_revised_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ss_status=='2'){?>
          	<a href="<?= base_url('admin/items/rev_ss_aitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }elseif($item->item_rev_ss_status=='4'){?>
          	<a href="<?= base_url('admin/items/rev_ss_resubmitted_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
		...
		elseif($item->item_type=='ERQ')
		{
			if($item->item_rubric_image!='')
			{
              ...
              <?php }
                  ...
                  <table width="100%">
                      <tr colspan="3"><td><div style="font-size:24px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
                    <?php if($item->item_rubric_image_position=='Top'){?>
                    <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                    <?php }?>
                    <tr>
			...
			else
			{
              ...
              <?php 
                  ...
                  <table width="100%">
                      <tr><td><div style="font-size:24px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
                      <tr><td style="text-align:right"><span class="urdufont-right"><?php echo html_entity_decode($item->item_rubric_urdu);?></span></td></tr></table>
              <?php }
				  else
				  {
					  ?>
...
?>               
  ...
  <div class="row col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <?php if($item->item_rev_ss_status==0){?>
            ...
            <textarea id="item_rev_ss_comment" name="item_rev_ss_comment" rows="4" cols="55" style="width:100%; margin-bottom:15px" required="required"></textarea>
            <?php if($item->item_rev_status==4)
			{?><input type="submit" name="submit_rev" id="submit_rev" value="Accept Revised Item" class="btn btn-success pull-right" style="margin:5px 5px;"><?php }
			else
			{?><input type="submit" name="submit" id="submit" value="Accept Item" class="btn btn-success pull-right" style="margin:5px 5px;"><?php }?>
            ...
            <?php echo form_close( );?>
            <?php } ?>
            <?php if (($item->item_rev_ss_status==0 && $item->item_rev_status==2) || ($item->item_rev_ss_status==0 && $item->item_rev_status==4)){?>
            <a href=<?php echo base_url('admin/items/rev_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px 5px"></a>
        <?php }?> 
			<?php if (($item->item_rev_status==2 || $item->item_rev_status==4) && $item->item_rev_ss_status==3 && $item->item_rev_ae_status==3){?>
                <a href=<?php echo base_url('admin/items/rev_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Revised Item" class="btn btn-info pull-right" style="margin:5px 5px"></a>
            <?php }?>
