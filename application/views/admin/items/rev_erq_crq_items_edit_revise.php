      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/rev_edit_erq_crq_revise/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
			...
			<div class="row">
              	<div class="col-lg-3 col-sm-12">                         
                    ...
                    <div class="col-12">
                      <input type="date" name="item_date_received" class="form-control" id="item_date_received" placeholder="" readonly="readonly" required="required" value="<?php $item['item_date_received']; ?>" >
                    </div>
                </div>
				<div class="col-lg-3 col-sm-12">                         
