        ...
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
           <?php 
			...
			?>
            <a href="<?= base_url('admin/items/ss_discarded_items'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
...
?>
                    ...
                    <tr><td colspan="2" style="font-weight:bold; font-size:20px; width:100%">Question :
                    ...
                    <tr>
                    	<td colspan="2" style="text-align:right; font-weight:bold; width:100%" class="urdufont-right">   
...
?>               
   ...
   <?php /*?> <div class="row"  style="width:100%; margin-left:5px">
        ...
        <textarea id="" name="" rows="1" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_comment_ss; ?></textarea>
        </div>
        ...
        <div style="padding:10px 0px 10px 4px;">
                ...
                <textarea id="" name="" rows="1" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_comment_ae; ?></textarea>
            </div>
        <?php }?>
        <?php if($item->item_comment_psy !=""){?>
            <div style="padding:10px 0px 10px 4px;">
                ...
                <textarea id="" name="" rows="1" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_comment_psy; ?></textarea>
            </div>
         <?php }?>
          <?php if($item->item_discard_status ==1){?>
            <div style="padding:10px 0px 10px 4px;">
                <label for="" class="col-sm-6 control-label">SS <?php if(!empty($ssinfo)){echo '('.$ssinfo['firstname'].' '.$ssinfo['lastname'].')';}?> Discard Comments <?php if($item->item_discard_status ==1){ echo '(Discarded)'; } ?> on <?php echo date("d-M-Y (h:i a)",strtotime($item->item_discard));?></label>
                <textarea id="" name="" rows="1" cols="55" style="width:100%" required="required" readonly="readonly"><?php echo $item->item_discard_comment; ?></textarea>
            </div>
         <?php }?>
         <?php /* if($item->item_discard_status==0){?>
		 <?php echo form_open(base_url('admin/items/ss_submit_for_discard/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
            <div style="padding-top:15px; margin-left:5px">
                <label for="item_discard_status" class="col-sm-6 control-label">Subject Specialist Comments</label>
                <textarea id="item_discard_status" name="item_discard_status" rows="4" cols="55" style="width:100%" required="required"><?php echo $item->item_discard_status; ?></textarea>
                <input type="submit" name="discard_ss" id="discard_ss" value="Discard Item" class="btn btn-danger pull-right" style="margin:5px">
            </div>
         <?php echo form_close( );} */ ?> 
</div>
