...
<?php echo form_open(base_url('admin/items/rev_submit_for_approval_revise/'.$item->item_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
...
<a href=<?php echo base_url('admin/items/rev_edit_erq_crq_revise/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
<?php echo form_close( );?>
</div>
