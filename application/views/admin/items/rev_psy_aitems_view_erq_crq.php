        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_ae_status==2){echo "Submitted";}elseif($item->item_rev_ae_status==1){echo "Under Review";}elseif($item->item_rev_ae_status==0){echo "Pending";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_rev_ae_date_acc));?></td>
              </tr>
              <?php }?>
              <?php if($item->item_rev_psy_comment!=""){?>
              <tr>
                <td><?php echo (isset($rev_psy[0]['username'])&&$rev_psy[0]['username']!="")?$rev_psy[0]['username']:"";?>(PSM)</td>
