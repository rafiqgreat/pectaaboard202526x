    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          ...
          <div class="btn-group margin-bottom-20"> 
            <a href="<?= base_url() ?>admin/items/export_items_csv/ritems" class="btn btn-secondary">Export as CSV</a>
          </div>
           <a href="<?= base_url('admin/items/add_combine'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Item</a> 
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    ...
    <?php /*?>{ "targets": 1, "name": "item_type", 'searchable':true, 'orderable':true},<?php */?>
