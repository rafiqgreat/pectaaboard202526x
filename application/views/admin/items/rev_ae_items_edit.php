        ...
        <div class="card-body">   
           <!-- For Messages -->
			...
			<div class="row">             
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <?php if($this->session->userdata('role_id')==4 && $item['item_rev_ae_status']==2){?>
                  <label for="item_rev_ae_comment_log" class="col-sm-12 control-label" style="margin-top:15px">Comments</label>
				  <textarea id="item_rev_ae_comment_log" name="item_rev_ae_comment_log" rows="4" cols="55" style="width:100%; margin-bottom:25px" required="required"></textarea>
				  <?php }?>
