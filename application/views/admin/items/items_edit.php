           ...
           <!-- For Messages -->
			...
			<div class="row">
              	<div class="col-lg-3 col-sm-12">                         
                    ...
                    <div class="col-12">
                      <input type="text" name="item_date_received" class="form-control" id="item_date_received" placeholder="" equired="required" value="<?php echo $item['item_date_received']; ?>" readonly >
                    </div>
                </div>
				<div class="col-lg-3 col-sm-12">                         
			...
			<div class="row">
                ...
                <select  name="item_batch" class="form-control" id="item_batch" readonly  required="required">
