      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/rev_ss_edit_erq_crq_resubmitted/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
