      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/items/rev_edit_revise/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
			<?php $item_rev_status=(isset($item['item_rev_status'])&&$item['item_rev_status']!="")?$item['item_rev_status']:0;?>
            <input type="hidden" id="item_registration" name="item_registration" value="LOGGED-USER" />
            <input type="hidden" id="item_rev_status" name="item_rev_status" value="<?php echo $item['item_rev_status']; ?>" />
			<div class="row">
