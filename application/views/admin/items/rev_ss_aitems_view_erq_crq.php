    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <?php }elseif($item->item_rev_ss_status=='1'){?>
          	<a href="<?= base_url('admin/items/rev_ss_eitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a>
          <?php }?>
          </div>
        </div>
        <div class="card-body">   
        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center">
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_ss_status==2){echo "Submitted";}elseif($item->item_rev_ss_status==1){echo "Under Review";}elseif($item->item_rev_ss_status==0){echo "Pending";}elseif($item->item_rev_ss_status==3){echo "Rejected";}elseif($item->item_rev_ss_status==4){echo "Re-submitted";}?></td>
