...
<div class="" style="padding-top:25px">
	   ...
	   <?php
		   if(isset($item->item_id)&&$item->item_id!=0)
		   {
            ...
            if ($item->item_image_position=='Full_Page') 
            {
                ...
                <div class="row">
                    <div class="row" style="font-weight:bold; font-size:16px">Question : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
            ...
            else
            {
                ...
                ?>
                    ...
                    <span style="font-weight:bold; font-size:16px"> Question : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo html_entity_decode($item->item_stem_en);?></span>
  ...
  <tr>
    <td style="font-size:16px">(a) <span><?php echo html_entity_decode($item->item_option_a_en);?></span></td>
  ...
  <tr>
    <td><table border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td style="font-size:16px">(b) <span><?php echo html_entity_decode($item->item_option_b_en);?></span></td>
  ...
  <tr>
    <td><table border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td style="font-size:16px">(c) <span><?php echo html_entity_decode($item->item_option_c_en);?></span></td>
  ...
  <tr>
    <td><table border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td style="font-size:16px">(d) <span><?php echo html_entity_decode($item->item_option_d_en);?></span></td>
		...
		elseif($item->item_type=='ERQ')
		{
			if($item->item_rubric_image!='')
			{
              ...
              <?php }
                  ...
                  <table width="100%">
					  <tr><td colspan="3"><div style="font-size:20px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
                    <?php if($item->item_rubric_image_position=='Top'){?>
                    <tr><td colspan="3" style="text-align:center"><img src="<?= base_url().$item->item_rubric_image;?>" style="max-width:100%;"/></td></tr>
                    <?php }?>
                    <tr>
			...
			else
			{
              ...
              <?php 
                  ...
                  <table width="100%">
					  <tr><td style="text-align:right"><div style="font-size:20px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">آیٹم روبرک (اردو) :</div></td></tr>
					  <tr><td style="text-align:right"><span class="urdufont-right"><?php echo html_entity_decode($item->item_rubric_urdu);?></span></td></tr>
				   </table>
              <?php }
				  else
				  {
		...
		elseif($item->item_type=='FIB')
		{
			 if($item->item_fib_key_ur==''&&$item->item_fib_key_eng!='')
			  {?>
                  ...
                  { ?>
                  <div style="font-size:20px; font-weight:bold; width:100%; text-align:right; padding-top:15px" class="urdufont-right">جواب (اردو) :</div>
                	...
                	<td><div class="row">
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc1_1!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_1;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_1;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_1!="" && $item->item_ur_mc1_1=="")
								{?>
								...
								elseif($item->item_en_mc1_1=="" && $item->item_ur_mc1_1=="")
								{?>
                                    <div class="col-12" style="float:left">1 - <img src="<?php echo base_url().$item->item_pic_mc1_1;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                           ...
                           <?php 
							if($item->item_pic_mc1_2!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_2;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_2;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_2!="" && $item->item_ur_mc1_2=="")
								{?>
								...
								elseif($item->item_en_mc1_2=="" && $item->item_ur_mc1_2=="")
								{?>
                                    <div class="col-12" style="float:left">2 - <img src="<?php echo base_url().$item->item_pic_mc1_2;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc1_3!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_3;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_3;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_3!="" && $item->item_ur_mc1_3=="")
								{?>
								...
								elseif($item->item_en_mc1_3=="" && $item->item_ur_mc1_3=="")
								{?>
                                    <div class="col-12" style="float:left">3 - <img src="<?php echo base_url().$item->item_pic_mc1_3;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <?php 
							if($item->item_pic_mc1_4!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_4;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_4;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_4!="" && $item->item_ur_mc1_4=="")
								{?>
								...
								elseif($item->item_en_mc1_4=="" && $item->item_ur_mc1_4=="")
								{?>
                                    <div class="col-12" style="float:left">4 - <img src="<?php echo base_url().$item->item_pic_mc1_4;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                           ...
                           <?php 
							if($item->item_pic_mc1_5!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_5;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_5;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_5!="" && $item->item_ur_mc1_5=="")
								{?>
								...
								elseif($item->item_en_mc1_5=="" && $item->item_ur_mc1_5=="")
								{?>
                                    <div class="col-6" style="float:left">5 - <img src="<?php echo base_url().$item->item_pic_mc1_5;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc1_6!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_6!="" && $item->item_ur_mc1_6=="")
								{?>
								...
								elseif($item->item_en_mc1_6=="" && $item->item_ur_mc1_6=="")
								{?>
                                    <div class="col-12" style="float:left">6 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                           ...
                           <?php 
							if($item->item_pic_mc1_7!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_7;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_7;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_7!="" && $item->item_ur_mc1_7=="")
								{?>
								...
								elseif($item->item_en_mc1_7=="" && $item->item_ur_mc1_7=="")
								{?>
                                    <div class="col-12" style="float:left">7 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc1_8!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_8;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_8;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_8!="" && $item->item_ur_mc1_8=="")
								{?>
								...
								elseif($item->item_en_mc1_8=="" && $item->item_ur_mc1_8=="")
								{?>
                                    <div class="col-12" style="float:left">8 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                           ...
                           <?php 
							if($item->item_pic_mc1_9!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_9;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_9;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_9!="" && $item->item_ur_mc1_9=="")
								{?>
								...
								elseif($item->item_en_mc1_9=="" && $item->item_ur_mc1_9=="")
								{?>
                                    <div class="col-6" style="float:left">9 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc1_10!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc1_10;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc1_10;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc1_10!="" && $item->item_ur_mc1_10=="")
								{?>
								...
								elseif($item->item_en_mc1_10=="" && $item->item_ur_mc1_10=="")
								{?>
                                    <div class="col-6" style="float:left">10 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_a!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_a;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_a;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_a!="" && $item->item_ur_mc2_a=="")
								{?>
								...
								elseif($item->item_en_mc2_a=="" && $item->item_ur_mc2_a=="")
								{?>
                                    <div class="col-12" style="float:left">2 - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_b!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_b;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_b;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_b!="" && $item->item_ur_mc2_b=="")
								{?>
								...
								elseif($item->item_en_mc2_b=="" && $item->item_ur_mc2_b=="")
								{?>
                                    <div class="col-12" style="float:left">b - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                           ...
                           <?php 
							if($item->item_pic_mc2_c!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_c;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_c;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_c!="" && $item->item_ur_mc2_c=="")
								{?>
								...
								elseif($item->item_en_mc2_c=="" && $item->item_ur_mc2_c=="")
								{?>
                                    <div class="col-12" style="float:left">c - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_d!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_d;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_d;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_d!="" && $item->item_ur_mc2_d=="")
								{?>
								...
								elseif($item->item_en_mc2_d=="" && $item->item_ur_mc2_d=="")
								{?>
                                    <div class="col-12" style="float:left">d - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_e!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_e;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_e;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_e!="" && $item->item_ur_mc2_e=="")
								{?>
								...
								elseif($item->item_en_mc2_e=="" && $item->item_ur_mc2_e=="")
								{?>
                                    <div class="col-12" style="float:left">e - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_f!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_f;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_f;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_f!="" && $item->item_ur_mc2_f=="")
								{?>
								...
								elseif($item->item_en_mc2_f=="" && $item->item_ur_mc2_f=="")
								{?>
                                    <div class="col-12" style="float:left">f - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_g!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_g;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_g;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_g!="" && $item->item_ur_mc2_g=="")
								{?>
								...
								elseif($item->item_en_mc2_g=="" && $item->item_ur_mc2_g=="")
								{?>
                                    <div class="col-12" style="float:left">g - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_h!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_h;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_h;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_h!="" && $item->item_ur_mc2_h=="")
								{?>
								...
								elseif($item->item_en_mc2_h=="" && $item->item_ur_mc2_h=="")
								{?>
                                    <div class="col-12">h - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <div class="row col-12" style="margin-top:10px; line-height:38px">
							...
							if($item->item_pic_mc2_i!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_i;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_i;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_i!="" && $item->item_ur_mc2_i=="")
								{?>
								...
								elseif($item->item_en_mc2_i=="" && $item->item_ur_mc2_i=="")
								{?>
                                    <div class="col-12" style="float:left">i - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                          ...
                          <?php 
							if($item->item_pic_mc2_j!="")
							{
								...
								{?>
                                    ...
                                    <div class="col-4"><img src="<?php echo base_url().$item->item_pic_mc2_j;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								...
								{?>
                                    ...
                                    <div class="col-6"><img src="<?php echo base_url().$item->item_pic_mc2_j;?>" style="max-height:55px; max-width:55px; float:right"/></div><?php 
								}
								elseif($item->item_en_mc2_j!="" && $item->item_ur_mc2_j=="")
								{?>
								...
								elseif($item->item_en_mc2_j=="" && $item->item_ur_mc2_j=="")
								{?>
                                    <div class="col-12">j - <img src="<?php echo base_url().$item->item_pic_mc1_6;?>" style="max-height:55px; max-width:55px"/></div><?php 
								}
							}
							else
							{
                      ...
                      <div class="col-2">
                        ...
                        <div class="row borders" style="padding:0px 0px 0px 15px; margin-top:-10px">
                          <?php if($ans1!=""){?>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">1 - <?php echo $ans1;?></div>
                          <?php } if($ans2!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">2 - <?php echo $ans2;?></div>
                          <?php } if($ans3!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">3 - <?php echo $ans3;?></div>
                          <?php } if($ans4!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">4 - <?php echo $ans4;?></div>
                          <?php } if($ans5!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">5 - <?php echo $ans5;?></div>
                          <?php } if($ans6!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">6 - <?php echo $ans6;?></div>
                          <?php } if($ans7!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">7 - <?php echo $ans7;?></div>
                          <?php } if($ans8!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">8 - <?php echo $ans8;?></div>
                          <?php } if($ans9!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">9 - <?php echo $ans9;?></div>
                          <?php } if($ans10!=""){?>
                          <div class="row container"><table width="96%"><tr><td style="border-bottom: 2px solid #CCC;"></td></tr></table></div>
                          <!------------------------------------------------------>
                          <div class="row col-12" style="padding:8px 0px 5px 15px; line-height:39px">10 - <?php echo $ans10;?></div>
                          <?php } ?>
                        </div>
                      </div>
                    </div>
...
?>               
    ...
    <div class="row">
        ...
        <?php if(!empty($result1['logs'])){?><div class="col-lg-12" style="padding-left:25px; padding-top:25px"> </div>
        <div class="col-lg-12">
            <table width="100%" border="1" style="text-align:center; font-size: 12px;">
              <tr style="font-weight:bold">
                <td width="5%">Sr.</td>
                <td width="10%">Name</td>
                ...
                <td width="20%">Date</td>
                <!--<td width="08%">History</td>-->
              </tr>
            <?php $i=1;
				//	array_pop($logs);
				foreach($result1['logs'] as $log){
				  //$hisid = (isset($log->log_itemhis_id)&&$log->log_itemhis_id!=0)?$log->log_itemhis_id:0;
				  $log_sms = $log->log_message;
				  $new_string = str_replace("{log_admin_id}", '<span style=" font-weight:bold">'.$log->username.'</span>', $log_sms);
				  $new_string = str_replace("{log_itemwriter_id}", '<span style="font-weight:bold">'.$log->username.'</span>', $new_string);
				  $new_string = str_replace("{log_itemid}", '<span style=" font-weight:bold">'.'ID: '.$log->log_itemid.'</span>', $new_string);
				  $new_string = str_replace("{log_date}", '<span style=" font-weight:bold">'.$log->log_date.'</span>', $new_string);
				  /*
				  $log_sms = $log->log_message;
            ...
            <?php if(($item->item_status==1 || $item->item_status==3) && $this->session->userdata('role_id') == 3){?>
...
?>               
    ...
    <div class="row">
        ...
        <?php if(!empty($result2['logs'])){?><div class="col-lg-12" style="padding-left:25px; padding-top:25px"> </div>
        <div class="col-lg-12">
            <table width="100%" border="1" style="text-align:center; font-size: 12px;">
              <tr style="font-weight:bold">
                <td width="5%">Sr.</td>
