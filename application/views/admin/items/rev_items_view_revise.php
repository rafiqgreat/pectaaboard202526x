...
<a href=<?php echo base_url('admin/items/rev_edit_revise/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
<?php echo form_close( );?>
</div>
