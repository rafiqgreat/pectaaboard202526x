              	...
              	<div class ="row">
                    ...
                    <div class ="col-3">
                    	<select name="item_type" class="form-control form-group" id="item_type"  style="width:100%">						
                          ...
                          <option value="TF" <?php if($item_type=="TF"){?> selected="selected"<?php }?>>TF</option>
                          <option value="FIB" <?php if($item_type=="FIB"){?> selected="selected"<?php }?>>FIB</option>
                          <option value="MC" <?php if($item_type=="MC"){?> selected="selected"<?php }?>>MC</option>  
                         </select>
                    </div>
                </div>
              </div>
...
?>
  ...
  var table = $('#na_datatable').DataTable( {
    ...
    <?php /*?>{ "targets": 1, "name": "item_batch", 'searchable':false, 'orderable':true},<?php */?>
