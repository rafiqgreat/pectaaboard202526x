...
<label for="item_rev_ae_comment" class="col-sm-12 control-label" style="margin-top:15px">Comments</label>
...
<a href=<?php echo base_url('admin/items/rev_ae_edit_erq_crq_resubmitted/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:10px;"></a>
