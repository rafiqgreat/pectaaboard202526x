        ...
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
           <?php 
            ...
            //die();
            ?>
          	<?php /*?><a href="<?= base_url('admin/items/rev_aitems'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Items List</a><?php */?>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
  ...
  <div class="row">
  	<div class="col-8">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12" style="font-weight:bold"> Item Writer Name : ___________<u><?php echo (isset($iwinfo)&&!empty($iwinfo))?$iwinfo[0]['firstname'].' '.$iwinfo[0]['lastname'].' ('.$iwinfo[0]['username'].')':"";?></u>__________</div>
...
?>               
    ...
    <?php /*?><div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php if($item->item_status_psy==1){echo "Reviewed";}elseif($item->item_status_psy==2){echo "Rejected";} ?></td>
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_ss_status==2){echo "Accepted";}elseif($item->item_rev_ss_status==1){echo "Under Review";}elseif($item->item_rev_ss_status==0){echo "Pending";}elseif($item->item_rev_ss_status==3){echo "Rejected";}elseif($item->item_rev_ss_status==4){echo "Re-Submitted";}?></td>
              ...
              <tr>
                ...
                <td><?php if($item->item_rev_ae_status==2){echo "Accepted";}elseif($item->item_rev_ae_status==1){echo "Under Review";}elseif($item->item_rev_ae_status==0){echo "Pending";}elseif($item->item_rev_ae_status==3){echo "Rejected";}elseif($item->item_rev_ae_status==4){echo "Re-Submitted";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($item->item_rev_ae_date_acc));?></td>
              </tr>
              <?php }?>
              <?php if($item->item_rev_psy_comment!=""){?>
              <tr>
                <td><?php echo (isset($rev_psy[0]['username'])&&$rev_psy[0]['username']!="")?$rev_psy[0]['username']:"";?>(PSY)</td>
                <td><?php echo $item->item_rev_psy_comment; ?></td>
                <td><?php if($item->item_rev_psy_status==2){echo "Reviewed";}elseif($item->item_rev_psy_status==1){echo "Under Review";}elseif($item->item_rev_psy_status==0){echo "Pending";}?></td>
...
<div><?php /* if($item->item_rev_ae_status==2){?><a href=<?php echo base_url('admin/items/rev_ae_edit/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin-top:10px; margin-left:10px"></a><?php }  */ ?>
<a href=<?php echo base_url('admin/pilot_items/pilot_edit_combine/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin:5px;"></a><a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View Items Logs" class="btn btn-info pull-right" style="margin-top:10px;"></a>
</div>
</div>
        ...
        <table width="100%" border="1" cellspacing="3" cellpadding="3">
          <tr style="font-size:16px; font-weight:bold">
            ...
            {  ?>
				<tr>
				<td><?php echo ++$i;?></td>
				<td width="25%"><?php echo date("d-M-Y (h:i a)",strtotime($row->log_date));?></td>
