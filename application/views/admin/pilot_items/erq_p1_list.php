...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; ERQs List</h3>
        </div>
    ...
    <div class="card">
    <div class="card-header">
            <?php echo form_open(base_url('admin/pilot_items/pilot_ss_items_erq_search'), 'class="form-horizontal" method="post"');  //pilot_ss_items_search?>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
	...
	"ajax": "<?=base_url('admin/pilot_items/datatable_json_erq_p1_search/'.$param1.'_'.$param2.'_'.$param3.'_'.$param4);?>",
	<?php }
	else
	{?>	"ajax": "<?=base_url('admin/pilot_items/datatable_json_erq_p1')?>", <?php }?>
	
   // "ajax": "< ?=base_url('admin/pilot_items/datatable_json_erq_p1')?>",
   // "order": [[1,'desc']],
