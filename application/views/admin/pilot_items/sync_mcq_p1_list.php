...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; MCQs/CRQs List</h3>
        </div>
    ...
    <?php /*?><div class="card-header">
            <?php echo form_open(base_url('admin/pilot_items/pilot_ss_items_search'), 'class="form-horizontal" method="post" onSubmit="return checkFields();" ');  //pilot_ss_items_search?>
        ...
        <table id="na_datatable" class="table table-bordered table-striped" width="100%">
          <thead>
            <tr>
              ...
              <th>Subject Code</th>
              <th>Subject Name</th>
              <th>Reviewed Items(MCQs)</th>
              <th>Reviewed Items(ERQs)</th>
              <th>Pilot Items(MCQs)</th>
              <th>Pilot Items(ERQs)</th>
              <th>Action</th>
            </tr>
          </thead>
        </table>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
	...
	{?>	"ajax": "<?=base_url('admin/pilot_items/datatable_json_sync_mcq_p1')?>", <?php }?>
  ...
  //  "order": [[1,'desc']],
    "columnDefs": [
    	...
    	{ "targets": 4, "name": "reviewed_mcqs", 'searchable':false, 'orderable':false},
    	{ "targets": 5, "name": "reviewed_erqs", 'searchable':false, 'orderable':false},
		{ "targets": 6, "name": "pilot_mcqs", 'searchable':false, 'orderable':false},
		{ "targets": 7, "name": "pilot_erqs", 'searchable':false, 'orderable':false},
