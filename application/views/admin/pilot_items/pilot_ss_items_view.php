...
<div style="padding-top:50px"><?php /* if($item->item_rev_ae_status==2){?><a href=<?php echo base_url('admin/items/rev_ae_edit/'.$item->item_id); ?>><input type="button" name="edit" id="edit" value="Edit Item" class="btn btn-info pull-right" style="margin-top:10px; margin-left:10px"></a><?php }  */ ?>
