    ...
    <div class="card card-default color-palette-bo">
      ...
      <div class="card-body">
        ...
        <div class="container" style="padding-top:25px">
              ...
              <div class="row col-12">
                <div class="col-12" style="padding-left:40px; padding-top:10px">
                  <div class="col-12" style="font-weight:bold;">
                    <table width="100%" class="border-bottom">
                      <tr>
                        ...
                        <td><?php echo date("d-M-Y (h:i a)", strtotime($item->item_date_received)); ?></td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-lg-12 col-sm-12" style="font-weight:bold">
                    <table width="100%" class="border-bottom">
                      <tr>
                        <td width="35%">Item Writer Name : </td>
                        <td><?php echo $iwinfo[0]['firstname'] . ' ' . $iwinfo[0]['lastname'] . '(' . $iwinfo[0]['username'] . ')'; ?></td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-lg-12 col-sm-12" style="font-weight:bold">
                    <table width="100%" class="border-bottom">
                      <tr>
                        <td width="35%">Registration No. : </td>
                        <td>PEC-<?php echo $item->item_submittedby; ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
              ...
              <div class="col-12" style="alignment-adjust:central">
                <table border="1px" bordercolor="#000000" width="100%" style="float:right; font-weight:bold; font-size:14px;" cellpadding="7px">
                  ...
                  <tr>
                    ...
                    <td style="text-align:center"><?php if ($item->item_type == 'MCQ') { ?><a href="<?= base_url('admin/pilot_items/pilot_item_stats/' . $item->item_id); ?>" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><i class="fa fa-bar-chart-o"></i> Stats</a><?php } else {
                                                                                                                                                                                                                                                                                                                  echo 'Only for MCQs';
                                                                                                                                                                                                                                                                                                                } ?></td>
                  </tr>
                </table>
          ...
          <div class="row" style="font-size:14px;">
            <table border="1px" bordercolor="#000000" width="100%" style="margin-top:25px; text-align:center; font-weight:bold;">
              ...
              <tr>
                <td colspan="3"><?php if ($item->item_curriculum == '1') {
                                  echo '2006(ALP)';
                                } elseif ($item->item_curriculum == '2') {
                                  echo 'National Curriculum (2006)';
                                } else {
                                  echo 'Single National Curriculum(SNC) 2020';
                                } ?></td>
        ...
        <td>Ey</td><?php */ ?>
              ...
              <tr>
                <td colspan="4">
                  <table width="100%">
                    <tr>
                      <td style="border-right: 1px solid black; width:16%"><?php if ($item->item_cognitive_bloom == 'Knowledge') {
                                                                              echo 'Yes';
                                                                            } else {
                                                                              echo '---';
                                                                            } ?></td>
                      <td style="border-right: 1px solid black; width:16%"><?php if ($item->item_cognitive_bloom == 'Comprehension') {
                                                                              echo 'Yes';
                                                                            } else {
                                                                              echo '---';
                                                                            } ?></td>
                      <td style="border-right: 1px solid black; width:18%"><?php if ($item->item_cognitive_bloom == 'Application') {
                                                                              echo 'Yes';
                                                                            } else {
                                                                              echo '---';
                                                                            } ?></td>
                      <td style="border-right: 1px solid black; width:17%"><?php if ($item->item_cognitive_bloom == 'Analysis') {
                                                                              echo 'Yes';
                                                                            } else {
                                                                              echo '---';
                                                                            } ?></td>
                      <td style="border-right: 1px solid black; width:17%"><?php if ($item->item_cognitive_bloom == 'Synthesis') {
                                                                              echo 'Yes';
                                                                            } else {
                                                                              echo '---';
                                                                            } ?></td>
                      <td style="width:16%"><?php if ($item->item_cognitive_bloom == 'Evaluation') {
                                              echo 'Yes';
                                            } else {
                                              echo '---';
                                            } ?></td>
        ...
        <td><?php if ($item->item_cognitive_bloom == 'Evaluation') {echo 'Yes';}else{echo '---';}?></td><?php */ ?>
                <td colspan="2"><?php if ($item->item_relation == 'Direct Quote') {
                                  echo 'Yes';
                                } else {
                                  echo '---';
                                } ?></td>
                <td colspan="2"><?php if ($item->item_relation == 'Amended') {
                                  echo 'Yes';
                                } else {
                                  echo '---';
                                } ?></td>
              ...
              <table width="100%" style="margin-top:10px;">
                ...
                if ($item->item_image_position == 'Full_Page') {
                  ...
                  <?php if ($item->item_stem_en != "") { ?>
                    <tr>
                      <td colspan="2">
                        <?php if ($item->item_image_position == 'Left' && $item->item_image_en != "") { ?> <img src="<?= base_url() . $item->item_image_en; ?>" style="max-height:400px; float:left" /> <?php } ?>
                        <span style="font-weight:bold; font-size:20px"> Question : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo html_entity_decode($item->item_stem_en); ?></span>
                        <?php if ($item->item_image_position == 'Right' && $item->item_image_en != "") { ?> <img src="<?= base_url() . $item->item_image_en; ?>" style="max-height:400px; float:right" /> <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
                  ...
                  <?php if ($item->item_stem_ur != "") { ?>
                    <tr>
                      <td colspan="2" class="urdufont-right" style="text-align:right">
                        <?php if ($item->item_image_position == 'Left' && $item->item_image_ur != "") { ?> <img src="<?= base_url() . $item->item_image_ur; ?>" style="max-height:400px; float:left" /> <?php } ?>
                        سوال :&nbsp;<?php echo html_entity_decode($item->item_stem_ur); ?>
                        <?php if ($item->item_image_position == 'Right' && $item->item_image_ur != "") { ?> <img src="<?= base_url() . $item->item_image_ur; ?>" style="max-height:400px; float:right" /> <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
                ...
                if ($item->item_type == 'MCQ') {
                              ...
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td style="padding-left:50px">
                                    <div class="urdufont-right"><?php echo html_entity_decode($item->item_option_a_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td style="padding-left:50px">
                                    <div class="urdufont-right"><?php echo html_entity_decode($item->item_option_b_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td style="padding-left:50px">
                                    <div class="urdufont-right"><?php echo html_entity_decode($item->item_option_c_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td style="padding-left:50px">
                                    <div class="urdufont-right" style="text-align:right"><?php echo html_entity_decode($item->item_option_d_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td>
                                    <div class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($item->item_option_a_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td>
                                    <div class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($item->item_option_b_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td>
                                    <div class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($item->item_option_c_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                            <td>
                              <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  ...
                                  <td>
                                    <div class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($item->item_option_d_ur); ?></div>
                                  </td>
                                </tr>
                              </table>
                            </td>
                  ...
                  if ($item->item_rubric_image != '') {
                    if ($item->item_rubric_urdu != '' && $item->item_rubric_english != '') { ?>
                      <table style="width: 100%">
                        <?php if ($item->item_rubric_image_position == 'Top') { ?>
                          <tr>
                            <td colspan="3" style="text-align:center"><img src="<?= base_url() . $item->item_rubric_image; ?>" style="max-width:100%;" /></td>
                          </tr>
                        <?php } ?>
                        <tr>
                          <td style="width:50%">
                    ...
                    <?php } elseif ($item->item_rubric_urdu == '' && $item->item_rubric_english != '') { ?>
                    ...
                    <?php } else { ?>
                      <table width="100%">
                        <tr>
                          <td style="text-align:center"><img src="<?= base_url() . $item->item_rubric_image; ?>" style="max-width:100%;" /></td>
                        </tr>
                      </table>
                    <?php }
                  } else {
                  ...
                  if ($this->session->userdata('role_id') == 2) {
                    if ($item->item_type == 'ERQ' && $item->item_awards_file != '') { ?>
                  ...
                  if ($item->item_fib_key_ur == '' && $item->item_fib_key_eng != '') { ?>
                    <table style="margin:20px 0px 0px 50px">
                      <tr>
                        <td style="font-size:16px; font-weight:bold;">Key (English) :</td>
                        <td><?php echo  html_entity_decode($item->item_fib_key_eng); ?></td>
                      </tr>
                    </table>
                  <?php
                    ...
                    <table width="100%">
                      <tr>
                        <td style="text-align:right"><span class="urdufont-right"><?php echo html_entity_decode($item->item_fib_key_ur); ?></span></td>
                      </tr>
                    </table>
                  <?php } else {
                  ?>
                  ...
                  <table width="30%" style="margin:10px 50px 10px 50px">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="col-6 urdufont-right"><?php echo  html_entity_decode($item->item_tf_ur_1); ?></div>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-left:25px">b. <?php echo  html_entity_decode($item->item_tf_eng_2); ?></td>
                      <td>
                        <div class="col-6 urdufont-right"><?php echo  html_entity_decode($item->item_tf_ur_2); ?></div>
                      </td>
                    </tr>
                          ...
                          <div class="col-5 ">
                            ...
                            <?php }?><?php */ ?>
                              ...
                              <div class="container">
                                <table width="100%">
                                  <tr>
                                    <td style="border-bottom: 2px solid #CCC; padding-top:5px"></td>
                                  </tr>
                                </table>
                              </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <?php if (!empty($logs)) { ?><div class="col-lg-12" style="padding-left:25px; padding-top:25px"> </div>
                ...
                echo 'No log history found';
              } ?>

                <?php if ($item->item_status == 1 && $this->session->userdata('role_id') == 3) { ?>
                  <?php /*?><div style="padding:15px 0px; float:right"><a href="<?= base_url('admin/items/submit_for_approval_his_log/' . $item->item_id); ?>" class="btn btn-success"> Submit For Approval</a></div><?php */?>
                <?php } ?>
                ...
                <?php */} ?>
                <!-- <a href="< ?= base_url('admin/items/history_compare/' . $item->item_id); ?>" class="btn btn-success pull-right" style="margin:10px 00px;">History</a> -->
                </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div id="area-chart" style="height: 350px;" class="full-width-chart">
                  <table border="1" cellspacing="0" cellpadding="0" class="table table-hover">
                    <tbody>
                      <tr>
                        <th width="64" valign="top" style="padding:5px; text-align:center;">
                          <p>Option</p>
                        </th>
                        <th width="59" valign="top" style="padding:5px; text-align:center;">
                          <p>N</p>
                        </th>
                        <th width="59" valign="top" style="padding:5px; text-align:center;">
                          <p>0-25%</p>
                    ...
                    <tr>
                      <td width="64" valign="top" style="padding:5px; text-align:center;">
                        <p>A</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p>----</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_1g_1p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_1g_2p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_1g_3p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_1g_4p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p>Maroon</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php if ($item->item_option_correct == 'a') {
                              print '**KEY**';
                            } ?></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_2g_1p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_2g_2p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_2g_3p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_2g_4p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p>Green</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php if ($item->item_option_correct == 'b') {
                              print '**KEY**';
                            } ?></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_3g_1p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_3g_2p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_3g_3p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_3g_4p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p>Blue</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php if ($item->item_option_correct == 'c') {
                              print '**KEY**';
                            } ?></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_4g_1p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_4g_2p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_4g_3p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php echo $item->item_4g_4p; ?></p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p>Olive</p>
                      </td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;">
                        <p><?php if ($item->item_option_correct == 'd') {
                              print '**KEY**';
                            } ?></p>
                      </td>
                    </tr>
...
<script>
  ...
  <?php if (
    $item->item_1g_1p != 0 || $item->item_1g_2p != 0 ||  $item->item_1g_3p != 0 || $item->item_1g_4p != 0 ||
