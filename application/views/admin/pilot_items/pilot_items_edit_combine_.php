  ...
  <section class="content">
    ...
    <div class="card card-default color-palette-bo">
      ...
      <?php $this->load->view('admin/includes/_messages.php') ?>
        ...
        <?php echo form_open(base_url('admin/pilot_items/pilot_edit_combine/'.$item['item_id']), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>
...
<?php /*?>var TF_content = 
            ...
            '<div class="row">'+
              ...
              '<div class="col-lg-6 col-sm-12" >'+
                ...
                '<label for="item_tf_eng_1" class="control-label" style="padding-top:10px">Anwer (Option-1)</label>'+
            ...
            '<div class="row">'+
              ...
              '<div class="col-lg-6 col-sm-12" >'+
                ...
                '<label for="item_tf_eng_2" class="control-label" style="padding-top:10px">Anwer (Option-2)</label>'+
...
var ERQ_content = 
            ...
            '<div class="form-group row" style="padding-top:10px">'+
			  ...
			  '<div class="col-lg-3 col-sm-12">'+
			  	...
			  	'<label for="item_awards_file" class="control-label">Upload Stats File</label>'+

                '<input type="file" name="item_awards_file" class="form-control" id="item_awards_file" placeholder="">'+
...
<?php /*?>var FIB_content = 
			...
			'<div class="row">'+
              ...
              '<div class="col-lg-6 col-sm-12" >'+
                ...
                '<label for="item_fib_key_eng" class="control-label" style="padding-top:10px">Anwer </label>'+
                        ...
                        '<div class="row col-12 borders" style="padding-bottom:8px">'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_1'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_1-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_2'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_2-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_3'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_3-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_4'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_4-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                               ...
                               '<div class="col-4">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_5'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_5-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<br /><img src="<?php echo base_url().$item['item_pic_mc1_7'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_7-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc1_8'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_8-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc1_9'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_9-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row" style="margin-bottom:5px">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc1_10'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc1_10-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                        ...
                        '<div class="row col-12 borders" style="padding-bottom:8px">'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_a'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_a-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_c'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_c-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_d'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_d-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                   ...
                                   ' <?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_e'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_e-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_f'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_f-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_g'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_g-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_h'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_h-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_i'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_i-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
                            ...
                            '<div class="row" style="margin-bottom:5px">'+
                                ...
                                '<div class="col-4">'+
                                    ...
                                    '<?php } else {?><br /><img src="<?php echo base_url().$item['item_pic_mc2_j'];?>" style="max-height:68px; max-width:68px;"/><a class="delete btn btn-sm btn-danger" style="padding-left:10px; float:right" href="<?php echo base_url("admin/pilot_items/delete_image_combine/item_pic_mc2_j-". $item['item_id']); ?>" title="Delete" onclick="return confirm(\'Do you want to delete ?\')"><i class="fa fa-trash-o"></i></a>'+
