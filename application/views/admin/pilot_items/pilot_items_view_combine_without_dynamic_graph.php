      ...
      <div class="col-12" style="alignment-adjust:central">
        <table border="1px" bordercolor="#000000" width="100%" style="float:right; font-weight:bold; font-size:14px;" cellpadding="7px" >
          ...
          <tr>
            ...
            <td style="text-align:center"><a href="<?= base_url('admin/pilot_items/pilot_item_stats/'. $item->item_id); ?>" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><i class="fa fa-bar-chart-o"></i> Stats</a></td>
          </tr>
        </table>
      </div>
    </div>
...
?>               
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
				...
				foreach($logs as $log){
                  ...
                  <tr>
					...
					if($log->log_itemhis_id!=0)
					{
						...
						{?><a href="<?= base_url('admin/items/get_rev_item_history_compare/'.$log->log_itemhis_id); ?>" class="btn btn-success" target="_blank"> History</a><?php }
						else
						{?><a href="<?= base_url('admin/items/get_item_history_compare/'.$log->log_itemhis_id."-".$item->item_id); ?>" class="btn btn-success" target="_blank"> History</a><?php }	?>
                    <?php 
					} 
					else 
			...
			<a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View Graph & Stats" class="btn btn-info pull-right" style="margin-top:10px;"></a>
            <?php } ?>
                ...
                <div id="area-chart" style="height: 350px;" class="full-width-chart">
                  <table border="1" cellspacing="0" cellpadding="0" class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>89</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.339</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.227</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.164</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.141</p></td>
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p>0.429</p></td>
                    ...
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>50</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.177</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.200</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.134</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.113</p></td>
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p>0.100</p></td>
                    ...
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>59</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.274</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.307</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.104</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.099</p></td>
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p>0.071</p></td>
                    ...
                    <tr>
                      ...
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>147</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.210</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.267</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.597</p></td>
                      <td width="59" valign="top" style="padding:5px; text-align:center;"><p>0.648</p></td>
                      <td width="64" valign="top" style="padding:5px; text-align:center;"><p>0.400</p></td>
