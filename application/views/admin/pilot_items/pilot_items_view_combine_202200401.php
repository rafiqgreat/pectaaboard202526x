...
?>               
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <?php if($item->item_type=='MCQ'){?><a href="" data-toggle="modal" data-target="#headingModal" data-id="<?php echo $item->item_id; ?>"><input type="button" name="edit" id="edit" value="View Graph & Stats" class="btn btn-info pull-right" style="margin-top:10px;"></a><?php }?>
            <?php } ?>
