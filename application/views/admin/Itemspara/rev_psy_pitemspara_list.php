    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Items Paragraph List (Psychometrician)</h3>
        </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/itemspara/datatable_json_rev_psy_pitempara'.((isset($para_subject_id)&&$para_subject_id!="")?'/'.$para_subject_id:''));?>",
  //  "order": [[1,'desc']],
    "columnDefs": [
