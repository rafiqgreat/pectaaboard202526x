           ...
           <!-- For Messages -->
            ...
            <div class="col-lg-12 col-sm-12">                         
             ...
             <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">                         
                    <label for="para_statistics" class="control-label" style="margin-top:25px">You can get para statistics from following links :</label>
                    <br /><a href="https://readable.com/" target="_blank"> 1. https://readable.com/</a>
                    <br /><a href="https://readabilityformulas.com/free-readability-formula-tests.php" target="_blank"> 2. https://readabilityformulas.com/</a>
                    <!--<br /><a href="javascript:copytext();" class="btn btn-success" style="margin:25px 0px 0px 0px"><i class="fa fa-list"></i>  Click here to auto fetech</a>-->
                </div>
              </div>      
      ...
      for (var i=0, l=elements.length; i < l; i++) {
        if (document.getElementById(elementID).value === elements[i].value && document.getElementById(elementID) != elements[i]) {
          console.log('not unique');
            alert('Paragrah item already selected!');
...
function copytext()
{
    var valu = CKEDITOR.instances['para_text_en'].getData()
	CKEDITOR.instances['para_statistics'].setData(valu)
}
