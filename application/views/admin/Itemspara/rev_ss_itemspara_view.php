    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			echo '<hr />';
			print_r($para_item_22);
			echo '<hr />';
			print_r($para_item_23);
			echo '<hr />';
			print_r($para_item_24);
			echo '<hr />';
			print_r($para_item_25);
			echo '<hr />';
			print_r($para_item_26);
			echo '<hr />';
			print_r($para_item_27);
			echo '<hr />';
			die();*/
			$total_items = 0;
    	...
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				if($status_pi_21 == 2 && $status_pi_22 == 2)
				{
                    ...
                    <textarea id="para_rev_ss_comment" name="para_rev_ss_comment" rows="4" cols="55" style="width:100%" required="required"></textarea>
            ...
            <a href=<?php echo base_url('admin/itemspara/rev_delete/'.$itemspara->para_id); ?>><input type="button" name="delete" id="delet" value="Delete" class="btn btn-danger pull-right" style="margin:5px; width:80px"></a>
        </div>
     <?php echo form_close( );?>
        </div>
      </div>
