    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$status_pi_21 = (isset($status_pi_21)&&!empty($status_pi_21))?$status_pi_21[0]->item_rev_psy_status:0;
			$status_pi_22 = (isset($status_pi_22)&&!empty($status_pi_22))?$status_pi_22[0]->item_rev_psy_status:0;
			$status_pi_23 = (isset($status_pi_23)&&!empty($status_pi_23))?$status_pi_23[0]->item_rev_psy_status:0;
			$status_pi_24 = (isset($status_pi_24)&&!empty($status_pi_24))?$status_pi_24[0]->item_rev_psy_status:0;
			$status_pi_25 = (isset($status_pi_25)&&!empty($status_pi_25))?$status_pi_25[0]->item_rev_psy_status:0;
			$status_pi_26 = (isset($status_pi_26)&&!empty($status_pi_26))?$status_pi_26[0]->item_rev_psy_status:0;
			$status_pi_27 = (isset($status_pi_27)&&!empty($status_pi_27))?$status_pi_27[0]->item_rev_psy_status:0;
			$status_pi_28 = (isset($status_pi_28)&&!empty($status_pi_28))?$status_pi_28[0]->item_rev_psy_status:0;
			$status_pi_29 = (isset($status_pi_29)&&!empty($status_pi_29))?$status_pi_29[0]->item_rev_psy_status:0;
			$status_pi_30 = (isset($status_pi_30)&&!empty($status_pi_30))?$status_pi_30[0]->item_rev_psy_status:0;
...
?>
                    <tr>
                        ...
                        <?php if ($para_item_21->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_21->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?></td>
                    </tr>
                    <tr>
...
?>
                    <tr>
                        ...
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==5){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        </td>
                    </tr>
                    <tr>
...
?>               
        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php if($itemspara->para_status_ae==1){echo "Rejected";}elseif($itemspara->para_status_ae==2){echo "Accepted";}?></td>
             ...
             <?php if($itemspara->para_rev_comment!=""){?>
              ...
              <tr>
                ...
                <td><?php if($itemspara->para_rev_ae_status==2){echo "Accepted";}elseif($itemspara->para_rev_ae_status==1){echo "Under Review";}elseif($itemspara->para_rev_ae_status==0){echo "Pending";}?></td>
    ...
    <?php /*echo form_open(base_url('admin/itemspara/rev_psy_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
            <label for="para_rev_psy_comment" class="col-sm-6 control-label">Psychometrician Comments</label>
            <textarea id="para_rev_psy_comment" name="para_rev_psy_comment" rows="4" cols="55" style="width:100%" ></textarea>
            <input type="submit" name="submit" id="submit" value="Review" class="btn btn-success pull-right" style="margin:5px; width:80px">
        </div>
     <?php echo form_close( );*/?>
     ...
     <?php  echo form_open(base_url('admin/itemspara/rev_psy_submit_for_approval/'.$itemspara->para_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				{
					?>
                    <label for="para_rev_psy_comment" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="para_rev_psy_comment" name="para_rev_psy_comment" rows="4" cols="55" style="width:100%" required="required" ></textarea>
                    <input type="submit" name="submit" id="submit" value="Review" class="btn btn-success pull-right" style="margin:5px; width:80px">
                    <?php
				}
				break;
