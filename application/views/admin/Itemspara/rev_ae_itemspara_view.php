...
?>
                    <tr>
                        ...
                        <?php if ($para_item_21->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_21->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_21->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_22->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_22->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_22->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_23->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_23->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_23->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_24->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_24->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_24->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_25->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_25->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_25->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_26->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_26->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_26->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_27->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_27->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_27->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_28->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_28->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_28->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_29->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_29->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_29->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
                    <tr>
                        ...
                        <?php if($this->session->userdata('role_id')==3){?>
						<?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php }?>
                        <?php if($this->session->userdata('role_id')==2){?>
                        <?php if ($para_item_30->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
                        <?php if ($para_item_30->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$para_item_30->item_id); ?> target="_blank">View Item</a><?php }?>
    	...
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				if($status_pi_21 == 2 && $status_pi_22 == 2)
				{
                    ...
                    <textarea id="para_rev_ae_comment" name="para_rev_ae_comment" rows="4" cols="55" style="width:100%" required="required"></textarea>
