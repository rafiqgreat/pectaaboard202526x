      ...
      <div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                <td><?php echo (isset($psy[0]['username'])&&$psy[0]['username'])?$psy[0]['username']:"";?>(PSM)</td>
     ...
     <?php echo form_open(base_url('admin/itemsgroup/rev_ss_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
			...
			switch($total_items)
			{
				...
				{
					?>
                    <label for="group_rev_ss_comment" class="col-sm-6 control-label">SS Comments</label>
                    <textarea id="group_rev_ss_comment" name="group_rev_ss_comment" rows="4" cols="55" style="width:100%" required="required"></textarea>
            ...
            <a href=<?php echo base_url('admin/itemsgroup/rev_delete/'.$groupinfo->group_id); ?>><input type="button" name="delete" id="delet" value="Delete" class="btn btn-danger pull-right" style="margin:5px; width:80px"></a> 
        </div>
     <?php echo form_close( );?>
        </div>
      </div>
