      ...
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			?>
                ...
                <?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?></td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_aview_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
      ...
      <div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <?php }?>
              <?php if($groupinfo->group_rev_psy_comment!=""){?>
              <tr>
                <td><?php echo (isset($rev_psy[0]['username'])&&$rev_psy[0]['username']!="")?$rev_psy[0]['username']:"";?>(AE)</td>
                <td><?php echo $groupinfo->group_rev_psy_comment; ?></td>
                <td><?php if($groupinfo->group_rev_psy_status==2){echo "Submitted";}elseif($groupinfo->group_rev_psy_status==1){echo "Under Review";}elseif($groupinfo->group_rev_psy_status==0){echo "Pending";}?></td>
                <td><?php echo date("d-M-Y (h:i a)",strtotime($groupinfo->group_rev_psy_date_acc));?></td>
              </tr>
              <?php }?>
            </table>
        </div>
