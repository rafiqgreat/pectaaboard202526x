    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Items Group List (Psychometrician)</h3>
        </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/itemsgroup/datatable_jsonrev_psy_pgrouplist'.((isset($para_subject_id)&&$para_subject_id!="")?'/'.$para_subject_id:''));?>",
  //  "order": [[1,'desc']],
    "columnDefs": [
