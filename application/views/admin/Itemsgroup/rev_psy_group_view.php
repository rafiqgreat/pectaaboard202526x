    ...
    <section class="content">
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			$status_gi_1 = (isset($status_gi_1)&&!empty($status_gi_1))?$status_gi_1[0]->item_rev_psy_status:0;
			$status_gi_2 = (isset($status_gi_2)&&!empty($status_gi_2))?$status_gi_2[0]->item_rev_psy_status:0;
			$status_gi_3 = (isset($status_gi_3)&&!empty($status_gi_3))?$status_gi_3[0]->item_rev_psy_status:0;
			$status_gi_4 = (isset($status_gi_4)&&!empty($status_gi_4))?$status_gi_4[0]->item_rev_psy_status:0;
			$status_gi_5 = (isset($status_gi_5)&&!empty($status_gi_5))?$status_gi_5[0]->item_rev_psy_status:0;
			$status_gi_6 = (isset($status_gi_6)&&!empty($status_gi_6))?$status_gi_6[0]->item_rev_psy_status:0;
			$status_gi_7 = (isset($status_gi_7)&&!empty($status_gi_7))?$status_gi_7[0]->item_rev_psy_status:0;
			$status_gi_8 = (isset($status_gi_8)&&!empty($status_gi_8))?$status_gi_8[0]->item_rev_psy_status:0;
			$status_gi_9 = (isset($status_gi_9)&&!empty($status_gi_9))?$status_gi_9[0]->item_rev_psy_status:0;
			$status_gi_10 = (isset($status_gi_10)&&!empty($status_gi_10))?$status_gi_10[0]->item_rev_psy_status:0;
			
			
			//echo $status_gi_1.'<hr />'.$status_gi_2.'<hr />'.$status_gi_3.'<hr />'.$status_gi_4.'<hr />'.$status_gi_5.'<hr />'.$status_gi_6.'<hr />'.$status_gi_7.'<hr />'.$status_gi_8.'<hr />'.$status_gi_9.'<hr />'.$status_gi_10;
			//die();
			...
			?>
                ...
                <?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php }?>
                <?php if($this->session->userdata('role_id')==5){?>
                <?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/rev_psy_view_erq_crq/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                </td></tr>
                <?php }?>
...
<?php } ?>
        ...
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <tr>
                ...
                <td><?php echo $groupinfo->group_rev_ae_comment; ?></td>
    ...
    <?php /* echo form_open(base_url('admin/itemsgroup/rev_psy_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
    		<label for="group_rev_psy_comment" class="col-sm-6 control-label">Psychometrician Comments</label>
            <textarea id="group_rev_psy_comment" name="group_rev_psy_comment" rows="4" cols="55" style="width:100%" ></textarea>
     ...
     <?php  echo form_open(base_url('admin/itemsgroup/rev_psy_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
        ...
        <?php 
			switch($total_items)
			{
				...
				{
					?>
                    <label for="group_rev_psy_status" class="col-sm-6 control-label">Reviewer Comments</label>
                    <textarea id="group_rev_psy_status" name="group_rev_psy_status" rows="4" cols="55" style="width:100%" required="required"></textarea>
