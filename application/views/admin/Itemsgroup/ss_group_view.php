      ...
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			if ($groupinfo->group_item_1 != "" && $group_item_1 != []){
				if($group_item_1->item_status_ss == 0 || $group_item_1->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_2 != "" && $group_item_2 != []){
				if($group_item_2->item_status_ss == 0 || $group_item_2->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_3 != "" && $group_item_3 != []){
				if($group_item_3->item_status_ss == 0 || $group_item_3->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_4 != "" && $group_item_4 != []){
				if($group_item_4->item_status_ss == 0 || $group_item_4->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_5 != "" && $group_item_5 != []){
				if($group_item_5->item_status_ss == 0 || $group_item_5->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_6 != "" && $group_item_6 != []){
				if($group_item_6->item_status_ss == 0 || $group_item_6->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_7 != "" && $group_item_7 != []){
				if($group_item_7->item_status_ss == 0 || $group_item_7->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_8 != "" && $group_item_8 != []){
				if($group_item_8->item_status_ss == 0 || $group_item_8->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_9 != "" && $group_item_9 != []){
				if($group_item_9->item_status_ss == 0 || $group_item_9->item_status_ss == 1)
					$checkstatus = 1;
			}
			if ($groupinfo->group_item_10 != "" && $group_item_10 != []){
				if($group_item_10->item_status_ss == 0 || $group_item_10->item_status_ss == 1)
					$checkstatus = 1;
			}
			...
			?>
				...
				<?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_1->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_2->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_3->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_4->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_5->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_6->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_7->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_8->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_9->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                ...
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/ss_view_combine/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php }?>
                <?php if($this->session->userdata('role_id')==4){?>
                <?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
                <?php if ($group_item_10->item_type=='ERQ'){?><a href=<?php echo base_url('admin/items/view_combine/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
     ...
     <?php echo form_open(base_url('admin/itemsgroup/ss_submit_for_approval/'.$groupinfo->group_id), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
    	<div style="padding-top:15px; margin-left:5px">
			...
			<?php if($checkstatus == 1){?>
				<div style="color:red; float: right; margin-top: 12px;"><strong>First accept items then accept group.</strong></div>
			<?php }else{?>
            	<input type="submit" name="submit_awoc" id="submit_awoc" value="Accept Group" class="btn btn-success pull-right" style="margin:5px">
			<?php }?>
            <input type="submit" name="reject_ss" id="reject_ss" value="Reject Group" class="btn btn-danger pull-right" style="margin:5px">
            <a href=<?php echo base_url('admin/itemsgroup/edit/'.$groupinfo->group_id); ?>><input type="button" name="edit" id="edit" value="Edit Group" class="btn btn-info pull-right" style="margin:5px"></a>
        </div>
