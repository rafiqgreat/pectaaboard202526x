      ...
      <div class="card card-default color-palette-bo">
	   ...
	   <?php 
			...
			?>
				...
				<?php if ($group_item_1->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_1->item_id); ?> target="_blank">View Item</a><?php }?>
  ...
  <tr>
    ...
    <td><span class="urdufont-right" style="padding-left:20px"><?php echo html_entity_decode($group_item_1->item_option_d_ur);?></span></td>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_2->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_2->item_id); ?> target="_blank">View Item</a><?php }?>
...
?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_3->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_3->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_4->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_4->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_5->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_5->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_6->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_6->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_7->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_7->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_8->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_8->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_9->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_9->item_id); ?> target="_blank">View Item</a><?php }?>
...
<?php } ?>
			...
			?>
                ...
                <?php if($this->session->userdata('role_id')==3){?>
				<?php if ($group_item_10->item_type=='MCQ'){?><a href=<?php echo base_url('admin/items/rev_view_combine/'.$group_item_10->item_id); ?> target="_blank">View Item</a><?php }?>
      ...
      <div class="row" style="padding-top:20px">
        <div class="col-lg-12">
        	<table width="100%" border="1" style="text-align:center; margin-left:05px">
              ...
              <?php if($groupinfo->group_comment_ss!=""){?>
              <tr>
              ...
              <?php }?>
              <?php if($groupinfo->group_commentby_psy!=""){?>
              <tr>
                ...
                <td><?php echo date("d-M-Y",strtotime($groupinfo->group_reviewed));?></td>
              </tr>
              <?php }?>
