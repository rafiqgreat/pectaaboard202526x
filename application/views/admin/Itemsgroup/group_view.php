...
?>
            ...
            <div style="padding:15px 0px; float:right">
				...
				<div style="color:red;"><strong>First submit the items for approval.</strong></div>
				<?php }else{?>
				<a href="<?= base_url('admin/Itemsgroup/submitgroup_for_approval/'.$groupinfo->group_id); ?>" class="btn btn-success"> Submit For Approval</a>
				<?php }?>
			</div>
            <?php }?>
        </div>
