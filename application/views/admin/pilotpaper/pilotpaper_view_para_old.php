						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_21->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_21->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_21->item_type=='ERQ'){?>
							  <?php if($para_item_21->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_21->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_21->item_stem_en);?></td>
						  </tr>
						  <tr>
							<?php if($para_item_21->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_21->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold"> 
							  ...
							  <?php if($para_item_22->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_22->item_id); ?> target="_blank">Question No. <?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_22->item_type=='ERQ'){?>
							  <?php if($para_item_22->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_22->item_id); ?> target="_blank">Question No. <?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_22->item_stem_en);?></td>
						  </tr>
						  <tr>
							<?php if($para_item_22->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_22->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_23->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_23->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_23->item_type=='ERQ'){?>
							  <?php if($para_item_23->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_23->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_23->item_stem_en);?></td>
						  </tr>
						  <tr>
							<?php if($para_item_23->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_23->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_24->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_24->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_24->item_type=='ERQ'){?>
							  <?php if($para_item_24->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_24->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_24->item_stem_en);?>
							  </td>
						  </tr>
						  <tr>
							<?php if($para_item_24->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_24->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_25->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_25->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_25->item_type=='ERQ'){?>
							  <?php if($para_item_25->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_25->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_25->item_stem_en);?>
							  </td>
						  </tr>
						  <tr>
							<?php if($para_item_25->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_25->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_26->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_26->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_26->item_type=='ERQ'){?>
							<?php if($para_item_26->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_26->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_26->item_stem_en);?>
							 </td>
						  </tr>
						  <tr>
							<?php if($para_item_26->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_26->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_27->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_27->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_27->item_type=='ERQ'){?>
							  <?php if($para_item_27->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_27->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_27->item_stem_en);?>
							  </td>
						  </tr>
						  <tr>
							<?php if($para_item_27->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_27->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_28->item_stem_en){?> <a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_28->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_28->item_type=='ERQ'){?>
							  <?php if($para_item_28->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_28->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_28->item_stem_en);?>
							 </td>
						  </tr>
						  <tr>
							<?php if($para_item_28->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_28->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_29->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_29->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_29->item_type=='ERQ'){?>
							  <?php if($para_item_29->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_29->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_29->item_stem_en);?>
							  </td>
						  </tr>
						  <tr>
							<?php if($para_item_29->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_29->item_stem_ur);?></td><?php }?>
						  </tr>
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_30->item_stem_en){?> <a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$para_item_30->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php if ($para_item_30->item_type=='ERQ'){?>
							  <?php if($para_item_30->item_stem_en){?><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$para_item_30->item_id); ?> target="_blank">Question No.<?php echo ++$q_ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_30->item_stem_en);?>
							 </td>
						  </tr>
						  <tr>
							<?php if($para_item_30->item_stem_ur){?><td colspan="2" style="text-align:right; font-weight:bold" class="urdufont-right">سوال نمبر <?php echo ++$q_ctr;?> : <?php echo html_entity_decode($para_item_30->item_stem_ur);?></td><?php }?>
						  </tr>
