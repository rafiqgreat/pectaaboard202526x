		...
		<div class="card card-default color-palette-bo">
			...
			<div style="padding:0px; margin:0px auto"> 
				<div style="width: 471px; border: 3px solid #000; font-size: 20px; font-family: Times New Roman;">
					...
					<?php
                    /******************************************/
                    $file_name = 'Control_Files_MCQs_P2/'.$paper_mcqs[0]->subject_code.'_G'.($paper_mcqs[0]->item_grade_id-2).'_V'.$crp_v_arry[1].'_P2_ID'.$paper_mcqs[0]->subject_id.'.txt';
					...
					/*****************************************************/
						if(!empty($paper_mcqs)){
							...
							foreach($paper_mcqs as $paper_mcq){
                                ...
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($paper_mcq->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
								$i++;
					...
					if(!empty($paper_paras)){
						...
						foreach($paper_paras as $paper_para){                         
							...
							if(isset($paper_para->para_item_21) && $paper_para->para_item_21 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_21->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_22) && $paper_para->para_item_22 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_22->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_23) && $paper_para->para_item_23 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_23->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_24) && $paper_para->para_item_24 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_24->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_25) && $paper_para->para_item_25 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_25->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_26) && $paper_para->para_item_26 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_26->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_27) && $paper_para->para_item_27 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_27->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_28) && $paper_para->para_item_28 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_28->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_29) && $paper_para->para_item_29 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_29->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
							...
							if(isset($paper_para->para_item_30) && $paper_para->para_item_30 != 0)
							{
                                ...
                                $nctrx = str_pad($nctr, 2, '0', STR_PAD_LEFT);
                                $nctr++;
                                $contents.= "Item".$nctrx."\t".strtoupper($para_item_30->item_option_correct)."\t4\t".strtoupper($paper_mcqs[0]->subject_code)." V".$crp_v_arry[1]."\tY\tM".PHP_EOL;
                                /***************/
									}
								}
