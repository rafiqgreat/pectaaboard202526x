		...
		<div class="card card-default color-palette-bo">
			<div class="card-body">
				...
				?>
					...
					<?php /*?><div class="row form-group" style="border-bottom: #000 solid 1px; font-size: 20px;">
								...
								<tbody>
									<tr>
										...
										<td width="50%" align="center">
											...
											<div style="border: 2px solid #000000; font-size: 18px; font-weight: bold; min-width: 200px; display: inline-block;padding: 5px;"><?php print $paper_erqs[0]->subject_name_en;?></div>
										</td>
									</tr>
								</tbody>
							</table>
								...
								foreach($paper_erqs as $paper_erq){
									...
									if($paper_erq->item_type == 'ERQ'){
										...
										<tr><td colspan="2" style="font-weight:bold; font-size:14px">
                                          ...
                                          <a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$paper_erq->item_id); ?> target="_blank">Question No.<?php print $i;?> </a>
                                          <?php }?>
                                          <?php }?>:
										...
										<span style="padding-left:50px"><?php echo html_entity_decode($paper_erq->item_stem_en);?></span>
                                        ...
                                        <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4){?>
                                          ...
                                          <?php }?>
                                          <?php if ($paper_erq->item_type=='ERQ'){?>
                                          <a href=<?php echo base_url('admin/pilot_items/pilot_ss_view_erq_crq/'.$paper_erq->item_id); ?> target="_blank">سوال نمبر <?php print $i;?>:&nbsp; </a>
                                          <?php }?>
                                          <?php }?>:
			...
			//die();?>
                    ...
                    <?php
							/*if(!empty($paper_paras_erqs)){
								$i = 0;
								foreach($paper_paras_erqs_erqs as $paper_paras_erqs_erq){
									$i++;
					?>
                    	<table style="width:100%">
            <div class="row">
				...
				<div class="col-lg-6 col-sm-12">                         
                    ...
                    <div style="font-weight:bold"><?php echo $paper_paras_erq->para_title_ur; ?></div>
                </div>
                <?php }?>
             </div>
			<?php 
