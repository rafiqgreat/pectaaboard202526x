	...
	<section class="content">
		<div class="card card-default color-palette-bo">
			<div class="card-body">
				...
				<div class="container" style="margin-top:25px; padding-right: 25px; clear:both;">
					<div class="row">
						<div style="width: 100%">
							<?php
							if(!empty($paper_mcqs)){
...
?>
					...
					{?> <img src="<?= base_url().$paper_mcq->item_image_en;?>" style="max-height:400px;"/>
								...
								<tr>
                                    ...
                                    <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1){?>
											<?php if ($paper_mcq->item_type=='MCQ'){?>
                                            <div class="urdufont-right"><a style="font-size: 24px;" href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$paper_mcq->item_id); ?> target="_blank">سوال نمبر <?php print $i;?>:&nbsp;</a>
                                            <?php }?>
                                            <?php }?>
					...
					{?> <img src="<?= base_url().$paper_mcq->item_image_ur;?>" style="max-height:400px;"/>
										<?php }?>
										<span style="padding-left:50px; font-size: 24px;">
	...
	if($paper_mcqs[0]->subject_id == 65||$paper_mcqs[0]->subject_id == 66||$paper_mcqs[0]->subject_id == 67)
	{
				...
				?>
								...
								{
									$subjects = [5,9,13,19,26,32,40,48,65,66,67];
									?>
								<tr>
									<td colspan="2">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	else
	{
				...
				?>
								...
								<?php 
									...
									/*if($paper_mcq->item_type == 'ERQ'){
										...
										?>
										<?php if ($paper_mcq->item_stem_en!=""){?>
										<tr><td colspan="2" style="font-weight:bold; font-size:18px">Question No.<?php print $i;?> :
										<?php if($paper_mcq->item_image_position=='Left' && $paper_mcq->item_image_en!="")
                ...
                <div class="container printpadding" style="margin-top:10px;padding-bottom:10px; clear:both; height: 100%; padding-right: 25px;">
                	<?php
					$ctr = $i;
							...
							if(!empty($paper_paras)){
								...
								foreach($paper_paras as $paper_para){
									$i++;
					?>
                <div class="row col-12 content-block">  
					
            <div class="row col-12" >
              	<?php if(isset($paper_para->para_title_en) && $paper_para->para_title_en!=""){?>
                <div class="col-lg-12 col-sm-12">                         
                  <div style="font-weight:bold">Instructions</div>
                  <div style="font-weight:bold"><?php echo $paper_para->para_title_en; ?></div>
                </div>
                <?php }?>
                <?php if(isset($paper_para->para_title_ur) && $paper_para->para_title_ur!=""){?>
			...
			if($paper_para->para_text_en!='') 
			{
				...
				<tr>
                        ...
                        <a href=<?php echo base_url('admin/Pilot_Itemspara/pilot_itemms_para_edit/'.$paper_para->para_id.'_'.$paper_mcqs[0]->subject_id.'_'.$crp_v_arry[1].'_'.$phase); ?> target="_blank" style="color:#09F" class="update btn btn-sm btn-light"><i class="fa fa-pencil-square-o"></i></a></td>
						<?php }?>
             ...
             <?php 
				...
				if($paper_para->para_text_ur!='') {?>
                    ...
                    <?php if($paper_para->para_img_position=='Bottom' && $paper_para->para_image!='') {?><tr><td style="text-align:center"><img src="<?= base_url().$paper_para->para_image;?>" style="max-height:400px;"/></td></tr><?php }?>
                    <?php }?>
            </table>
				<div class="row" >	
						...
						?>
						  <tr>
							<td colspan="2" style="font-weight:bold">
							  ...
							  <?php if($para_item_21->item_stem_en!=""){?><a href=<?php echo base_url('admin/pilot_items/pilot_view_combine/'.$para_item_21->item_id); ?> target="_blank">Question No.<?php print ++$ctr;?> :</a><?php }?>
							  <?php }?>
							  <?php }?><?php echo html_entity_decode($para_item_21->item_stem_en);?>
                              </td>
						  </tr>
						  <tr>
							<?php if($para_item_21->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_21->item_type=='MCQ' || $para_item_21->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_21->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_22->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_22->item_type=='MCQ' || $para_item_22->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_22->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_23)&&$paper_para->para_item_23!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_23->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_23->item_type=='MCQ' || $para_item_23->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_23->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_24)&&$paper_para->para_item_24!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_24->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_24->item_type=='MCQ' || $para_item_24->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_24->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_25)&&$paper_para->para_item_25!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_25->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_25->item_type=='MCQ' || $para_item_25->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_25->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_26)&&$paper_para->para_item_26!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_26->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_26->item_type=='MCQ' || $para_item_26->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_26->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_27)&&$paper_para->para_item_27!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_27->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_27->item_type=='MCQ' || $para_item_27->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_27->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_28)&&$paper_para->para_item_28!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_28->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_28->item_type=='MCQ' || $para_item_28->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_28->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_29)&&$paper_para->para_item_29!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_29->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_29->item_type=='MCQ' || $para_item_29->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_29->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
					...
					if(isset($paper_para->para_item_30)&&$paper_para->para_item_30!=0)
					{
						...
						?>
						  ...
						  <tr>
							<?php if($para_item_30->item_stem_ur!=""){?>
                              <td colspan="2" style="text-align:right; font-weight:bold; font-size: 24px;" class="urdufont-right">
                                  <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4 || $this->session->userdata('role_id')== 1 && ($para_item_30->item_type=='MCQ' || $para_item_30->item_type=='ERQ'))
                                {?>
                              ...
                              <?php }else{?>
                                  ...
                                  سوال نمبر <?php print ++$ctr;}?> : <?php echo html_entity_decode($para_item_30->item_stem_ur);?>
                              </td>
                              <?php }?>
						  </tr>
