...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
	  ...
	  <div class="card">
		<div class="d-inline-block row" >
          <h3 class="card-title">&nbsp;&nbsp;&nbsp;&nbsp;	<strong>Pilot Paper Phase-I - MCQs Paper (Objective)</strong></h3>
        </div>
      <div class="card-body">
		<table id="na_datatable" class="table table-bordered table-striped" width="100%" style="border:double; color:#000">
          <thead>
            <tr>
              <th>Grade</th>
              <th>Subjects</th>
              <th>Ph-1 Indivisual MCQs</th>
              <th>Ph-1 MCQs Paras</th>
              <!--<th>Ph-1 MCQs Para Ids</th> -->             
              <th>Ph-1 MCQs in Paras</th>  
			  <th>Ph-1 Versions</th>
              <th>Ph-1 MCQs Papers in Each Versions</th>             
              <th>Ph-1 Total MCQs </th>
            
            </tr>
          </thead>
            <tbody>
            <?php	
              //print '<pre>';  print_r($paper1);die('12');
	  ...
	  <div class="card" >
		<div class="d-inline-block row" >
          <h3 class="card-title">&nbsp;&nbsp;&nbsp;&nbsp;	<strong>Pilot Paper Phase-I - ERQs Paper (Subjective)</strong></h3>
        </div>
      <div class="card-body">
		<table id="na_datatable" class="table table-bordered table-striped" width="100%" style="border:double; color:#000">
          <thead>
            <tr>
              <th>Grade</th>
              <th>Subjects</th>
              <th>Phase 1 Indivisual ERQs</th>
              <th>Phase 1 Groups </th>
              <th>Phase 1 Paragraphs</th>              
              <th>Phase 1 Total CRQs</th>  
			  <th>Phase 1 ERQs Papers </th>
            </tr>
          </thead>
            <tbody>
            <?php			
			...
			foreach ($paper1erq as $row){
				...
				{
					if($row['c_group_count']>0) { /* echo '<a href="'.base_url('admin/pilotpaper/group_erqs_view/'.$row['subject_id']).'">CRQs/ERQs Groups ('.$row['c_group_count'].')</a>'; */ 
				...
				if($row['c_ind_crq_count']>0) { /* echo '<a href="'.base_url('admin/pilotpaper/indiv_erqs_view/'.$row['subject_id']).'"> ERQs Paper('.$row['c_ind_crq_count'].')</a>'; */
