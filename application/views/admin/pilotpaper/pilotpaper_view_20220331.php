...
<table style="width:100%">					
...

			{
				...
				<tr>
                        ...
                        <?php echo html_entity_decode($paper_para->para_text_en);?><?php /*?><a href=<?php echo base_url('admin/Pilot_Itemspara/edit_para_text/'.$paper_para->para_id); ?> target="_blank" style="color:#09F">Edit Paragraph Text</a><?php */?></td>
