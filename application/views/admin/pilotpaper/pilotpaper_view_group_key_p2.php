...
<div class="content-wrapper">
  ...
  <div style="width: 471px; border: 3px solid #000; font-size: 20px; font-family: Times New Roman;">
    <?php 
		...
		$file_name = 'Control_Files_Group_CRQs_P2/'.$paper_groups[0]->subject_name_en.'_G'.($paper_groups[0]->group_grade_id-2).'_P2_ID'.$paper_groups[0]->group_subject_id.'.txt';
		$file_name2 = 'Control_Files_Group_CRQs_IDs_P2/'.$paper_groups[0]->subject_name_en.'_G'.($paper_groups[0]->group_grade_id-2).'_P2_ID'.$paper_groups[0]->group_subject_id.'.txt';
		$contents = "";
		$contents2 = "";
		$nctr = 1;
		$nctrx = '';
