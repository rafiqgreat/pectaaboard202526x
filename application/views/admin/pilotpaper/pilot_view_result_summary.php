		...
		<div class="card card-default color-palette-bo">
			<div class="card-header">
				<div class="d-inline-block">
					<h3 class="card-title"> <i class="fa fa-plus"></i> Pilot MCQs Result Summary</h3>
				</div>
			</div>
			<div class="card-body">
				<!-- For Messages -->
				<?php $this->load->view('admin/includes/_messages.php') ?>
				<?php echo form_open(base_url('admin/pilotpaper/pilot_result_summary'), 'class="form-horizontal"');  ?>
				...
				if ( isset( $_REQUEST[ 'get_result' ] ) && $item_grade_id != 0) {
					...
					<div class="row">
						<div class="col-lg-12 col-sm-12">
							<h1 style="text-align: center;">Analysis MCQs Summary of Piloting Grade <?php print $item_grade_id-2;?></h1>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-sm-12">
							<h1 style="text-align: center;">MCQs Piloting Grade <?php print $item_grade_id-2;?></h1>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-sm-12">
