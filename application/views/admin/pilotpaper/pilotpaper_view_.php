...
?>
								...
								<tr>
                                    ...
                                    <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4){?>
                                            ...
                                            <a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$paper_mcq->item_id); ?> target="_blank">Question No.<?php print $i;?> :</a>
                                            <?php }?>
                                            <?php }?>
					...
					{?> <img src="<?= base_url().$paper_mcq->item_image_en;?>" style="max-height:400px;"/>
								...
								<tr>
                                    ...
                                    <?php if($this->session->userdata('role_id')==2 || $this->session->userdata('role_id')==4){?>
											<?php if ($paper_mcq->item_type=='MCQ'){?>
                                            <div class="urdufont-right"><a href=<?php echo base_url('admin/pilot_items/pilot_ss_view/'.$paper_mcq->item_id); ?> target="_blank">سوال نمبر <?php print $i;?>:&nbsp;</a>
                                            <?php }?>
                                            <?php }?>
             ...
             <?php 
				...
				if($paper_para->para_text_ur!='') {?>
                    ...
                    <table width="100%" style="margin-top:50px">
                        ...
                        <tr><td style="padding-top:2px; padding-left:10px">Grade-<?php print $paper_mcqs[0]->item_grade_id-2;?>, <?php print $paper_mcqs[0]->subject_name_en;?>, CRP-I</td></tr>
                    </table>
                </div>
				<!-- /.box-body -->
			</div>
