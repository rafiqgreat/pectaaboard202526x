		...
		<div class="card card-default color-palette-bo">
			<div class="card-header">
				<div class="d-inline-block">
					<h3 class="card-title"> <i class="fa fa-edit"></i>&nbsp; View Item Writer Profile</h3>
				</div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						...
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_fathername'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="ci_iw_gender" class="col-sm-12 control-label">Gender</label>
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_gender'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
				...
				<div class="row" style="padding-top:15px">
					...
					<div class="col-lg-3 col-sm-12">
						...
						<?php if ($profileinfo['ci_iw_cniccopy'] != ""){ ?><p class="profilepara"><a href="<?php echo base_url().$profileinfo['ci_iw_cniccopy'];?>" target="_blank"><img src="<?php echo base_url().$profileinfo['ci_iw_cniccopy'];?>" style="max-height:100px; max-width:100px;"/> </a></p>
						<?php }else{?><p class="profilepara">No Image</p><?php }?>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="ci_iw_picture" class="col-sm-12 control-label">Picture</label>
						<?php if ($profileinfo['ci_iw_picture'] != ""){ ?><p class="profilepara"><a href="<?php echo base_url().$profileinfo['ci_iw_picture'];?>" target="_blank"><img src="<?php echo base_url().$profileinfo['ci_iw_picture'];?>" style="max-height:100px; max-width:100px;"/> </a></p>
						<?php }else{?><p class="profilepara">No Image</p><?php }?>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						...
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_address'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
					</div>
				...
				<div class="row">
					...
					<label for="qualification" class="col-sm-12 control-label">Qualification</label>
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_qualification'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="latestdegree" class="col-sm-12 control-label">Latest Degree</label>
						<?php if ($profileinfo['ci_iw_latestdegree'] != ""){ ?><p class="profilepara"><a href="<?php echo base_url().$profileinfo['ci_iw_latestdegree'];?>" target="_blank"><img src="<?php echo base_url().$profileinfo['ci_iw_latestdegree'];?>" style="max-height:100px; max-width:100px;"/> </a></p>
						<?php }else{?><p class="profilepara">No Image</p><?php }?>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="experienceschool" class="col-sm-12 control-label">Experience School (No. of years)</label>
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_experienceschool'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="experienceletter" class="col-sm-12 control-label">Experience Letter</label>
						<?php if ($profileinfo['ci_iw_experienceletter'] != ""){ ?><p class="profilepara"><a href="<?php echo base_url().$profileinfo['ci_iw_experienceletter'];?>" target="_blank"><img src="<?php echo base_url().$profileinfo['ci_iw_experienceletter'];?>" style="max-height:100px; max-width:100px;"/> </a></p>
						<?php }else{?><p class="profilepara">No Image</p><?php }?>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						...
						<p class="profilepara">
							<?php print $profileinfo['ci_iw_iban'];?>
						</p>
					</div>
					<div class="col-lg-3 col-sm-12">
					</div>
