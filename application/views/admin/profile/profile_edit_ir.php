			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						...
						<input type="text" name="address" class="form-control form-group" id="address" value="<?= $profileinfo['ci_ir_address']; ?>" placeholder="" required="required">
					</div>
				...
				<div class="row">
					...
					<label for="qualification" class="col-sm-12 control-label">Qualification</label>
						<select name="qualification" class="form-control form-group" id="qualification" placeholder="" required="required">
							...
							{
								$selectedText = '';
								if ( $qualification[ 'q_degree_name' ] == $profileinfo[ 'ci_ir_qualification' ] )
									$selectedText = ' selected="selected" ';
					...
					<div class="col-lg-3 col-sm-12">
						...
						<?php if ($profileinfo['ci_ir_latestdegree'] != ""){?><img src="<?php echo base_url().$profileinfo['ci_ir_latestdegree'];?>" style="max-height:100px; max-width:100px;"/>
						<?php }?>
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="experienceschool" class="col-sm-12 control-label">Experience School (No. of years)</label>
						<input type="number" name="experienceschool" class="form-control form-group" id="experienceschool" value="<?= $profileinfo['ci_ir_experienceschool']; ?>" placeholder="" required="required">
					</div>
					<div class="col-lg-3 col-sm-12">
						...
						<?php if ($profileinfo['ci_ir_experienceletter'] != ""){?><img src="<?php echo base_url().$profileinfo['ci_ir_experienceletter'];?>" style="max-height:100px; max-width:100px;"/>
						<?php }?>
					</div>
				</div>
				<div class="row">
					...
					<label for="bankname" class="col-sm-12 control-label">Bank Name</label>
						<select name="bankname" class="form-control form-group" id="bankname" placeholder="" required="required">
							...
							{
								$selectedText = '';
								if ( $bank[ 'b_bank_name' ] == $profileinfo[ 'ci_ir_bankname' ] )
									$selectedText = ' selected="selected" ';
					...
					<div class="col-lg-3 col-sm-12">
						...
						<input type="text" name="branchcode" class="form-control form-group" id="branchcode" value="<?= $profileinfo['ci_ir_branchcode']; ?>" placeholder="" required="required">
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="accounttitle" class="col-sm-12 control-label">Account Title</label>
						<input type="text" name="accounttitle" class="form-control form-group" id="accounttitle" value="<?= $profileinfo['ci_ir_accounttitle']; ?>" placeholder="" required="required">
					</div>
					<div class="col-lg-3 col-sm-12">
						<label for="accountnumber" class="col-sm-12 control-label">Account Number</label>
						<input type="text" name="accountnumber" class="form-control form-group" id="accountnumber" value="<?= $profileinfo['ci_ir_accountnumber']; ?>" placeholder="" required="required">
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 col-sm-12">
						<label for="iban" class="col-sm-12 control-label">IBAN</label>
						<input type="text" name="iban" class="form-control form-group" id="iban" value="<?= $profileinfo['ci_ir_iban']; ?>" placeholder="">
					</div>
					<div class="col-lg-3 col-sm-12">
