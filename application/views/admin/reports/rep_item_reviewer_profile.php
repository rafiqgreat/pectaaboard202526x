      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/reports/rep_item_reviewer_profile'), 'class="form-horizontal" enctype="multipart/form-data" ');  ?>  
            ...
            <div class="btn-group margin-bottom-20"> 
                <a href="<?= base_url() ?>admin/reports/item_reviewer_export/PDF/<?=$district_id."/".$tehsil_id."/".$subject."/".$department?>" class="btn btn-secondary">Export as PDF</a>
                <a href="<?= base_url() ?>admin/reports/item_reviewer_export/CSV/<?=$district_id."/".$tehsil_id."/".$subject."/".$department?>" class="btn btn-secondary">Export as CSV</a>
              </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/reports/itemreviewer_jason/'.$dist.'_'.$tehsil.'_'.$subject.'_'.$dept);?>",
  //  "order": [[1,'desc']],
      "columnDefs": [
          
        { "targets": 0, "name": "ci_ir_id", 'searchable':false, 'orderable':true},
        { "targets": 1, "name": "ir_name", 'searchable':true, 'orderable':true},
        { "targets": 2, "name": "ci_ir_picture", 'searchable':false, 'orderable':false},
        { "targets": 3, "name": "username", 'searchable':true, 'orderable':true},
        { "targets": 4, "name": "ci_ir_mobile", 'searchable':true, 'orderable':true},
        { "targets": 5, "name": "ci_ir_dob", 'searchable':true, 'orderable':true},
        { "targets": 6, "name": "ci_ir_cnic", 'searchable':false, 'orderable':true},
        { "targets": 7, "name": "ci_ir_subject", 'searchable':false, 'orderable':true},
        { "targets": 8, "name": "district_name_en", 'searchable':false, 'orderable':true},
        { "targets": 9, "name": "ci_ir_tehsil", 'searchable':false, 'orderable':true},
        
        { "targets": 10, "name": "ci_ir_id", 'searchable':false, 'orderable':false}
    ]
  });
