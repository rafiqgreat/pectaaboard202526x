            ...
            <table width="100%" border="1" cellpadding="5">
              <tr>
                ...
                <th>Plagiarism</th>
              	...
              	<?php
				$nt = 0;
				$comp_with = $com_records;
				foreach($com_records as $val)
				{ 
					$compare = $this->Reports_model->get_item_plagiarism($com_records[$nt]);
					for($i=0; $i<=100; $i++)
					{
						if($i == 100) continue;
						$compare2 = $this->Reports_model->get_item_plagiarism($comp_with[$i]);
						...
						?>	
							<tr>
                                <td>Grades---</td>
								<td>Subjects------</td>
								<td><?php echo $compare[0]->item_id . ' &nbsp;&nbsp; [compare with] &nbsp;&nbsp; ' .$compare2[0]->item_id. ' &nbsp;&nbsp; =>  Result  => &nbsp;&nbsp; '.$stem_per; ?>
                                	<?php /* echo '<a href="'.base_url('admin/reports/item_plag_compare/'.$compare[0]->item_id.'_'.$compare2[0]->item_id).'" target="_blank" style="margin-left:25px">( View Detail )</a>'; */?>
                                </td>
                            </tr>
