            ...
            <table class="table table-striped">
                <tbody>
                    <?php
						...
						if($row['admin_role_id']==6){
                        ?>
                        	<tr>
                                <td><a href="<?=base_url().$row['ci_ir_picture']?>" download > <img src="<?=base_url().$row['ci_ir_picture']?>" alt="Picture" width="150" height="150"></a></td>
                                <td><a href="<?=base_url().$row['ci_ir_cniccopy']?>" download > <img src="<?=base_url().$row['ci_ir_cniccopy']?>" alt="Picture" width="250" height="150"></a></td>
                            </tr>
                         	<tr>
                        ...
                        <?php
						} else if($row['admin_role_id']==3){
							?>
							<tr>
                                <td><a href="<?=base_url().$row['ci_iw_picture']?>" download > <img src="<?=base_url().$row['ci_iw_picture']?>" alt="Picture" width="150" height="150"></a></td>
                                <td><a href="<?=base_url().$row['ci_iw_cniccopy']?>" download > <img src="<?=base_url().$row['ci_iw_cniccopy']?>" alt="Picture" width="250" height="150"></a></td>
                            </tr>
                         	<tr>
                                <td class="font-weight-bold">Name : </td>
                                <td><?=$row['firstname'].' '.$row['lastname']?></td>
                         	...
                         	<tr>
                                <td class="font-weight-bold">Father Name : </td>
                                <td><?=$row['ci_iw_fathername']?></td>
                            </tr>
                         	<tr>
                                <td class="font-weight-bold">Cell No : </td>
                                <td><?=$row['ci_iw_mobile']?></td>
                            </tr>
                         	<tr>
                                <td class="font-weight-bold">CNIC : </td>
