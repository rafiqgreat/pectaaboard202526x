...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><a href=<?php echo base_url('admin/reports/reports_admin/'); ?>><input type="button" name="reports" id="reports" value="Reports" class="btn btn-info pull-right" style="margin:10px; width:100px"></a></h3>
        </div><br />
        <div class="d-inline-block">
          <h3 class="card-title"><a href=<?php echo base_url('admin/reports/reports_comments/'); ?>><input type="button" name="comments" id="comments" value="Comments" class="btn btn-info pull-right" style="margin:10px; width:100px"></a></h3>
        </div>
      </div>
    </div>
    <div class="card">
