      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/reports/plagiarism_duplicate_grade'), 'class="form-horizontal"');  ?>  
            <div class="row">
                    ...
                    <select name="item_subject_id" class="form-control form-group" id="item_subject_id"  required>
                      <option value="">--Select Subjects--</option>
                        ...
                        if(isset($subjects)){
                            ...
                            {
                                echo '<option value="'.$subject['subjectids'].'"'.set_select('item_subject_id',$subject['subjectids']).'>'.$subject['subject_name_en'].'</option>';
                            }
                        }
                      ?>
                    </select>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/reports/plagiarism_json_duplicate_grade/'.$grade.'_'.$subject.'_'.$dup_level);?>",
      "columnDefs": [
